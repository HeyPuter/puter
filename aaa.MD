...
- **Make sure access control is airtight.** If your change touches auth, permissions, or data access, triple-check it. We do not want to leak user or system data, nor give access to write to the wrong actors
