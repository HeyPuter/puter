...
export class Parser {
  ...
  parse(lexer) {
    ...
    const pr =
      unadaptedResult instanceof ParseResult ? unadaptedResult : new ParseResult(unadaptedResult);
...
export class ParseResult {
  ...
  constructor(value, opt_status) {
    ...
    this.status =
      opt_status ?? (value === undefined ? ParseResult.UNRECOGNIZED : ParseResult.VALUE);
    this.value = value;
  }
}
