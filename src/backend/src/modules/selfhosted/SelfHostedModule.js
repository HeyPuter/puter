...
class SelfHostedModule extends AdvancedBase {
  async install(context) {
    ...
    services.registerService("setup", SetupService);

    const ComplainAboutVersionsService = require("./ComplainAboutVersionsService");
    services.registerService(
      "complain-about-versions",
      ComplainAboutVersionsService
    );
        ...
        commands: [
          {
            ...
            env: {
              ...
              PUTER_API_ORIGIN: ({ global_config: config }) =>
                config.api_base_url,
            },
          },
          {
          ...
          },
          {
            ...
            env: {
              PUTER_JS_URL: ({ global_config: config }) =>
                config.origin + "/sdk/puter.dev.js",
            },
          },
          {
    ...
    services.registerService("__serve-gui-js", ServeSingleFileService, {
      path: path_.resolve(__dirname, RELATIVE_PATH, "src/gui/dist/gui.dev.js"),
      route: "/putility.js/v1",
    });
  }
}
