            ...
            methods: {
                generate: {
                    ...
                    parameters: {
                        ...
                        prompt_upsampling: { type: 'flag', optional: true },
                        safety_tolerance: { type: 'number', optional: true },
                        output_format: { type: 'string', optional: true },
                        raw: { type: 'flag', optional: true },
                        guidance: { type: 'number', optional: true },
                        image_prompt: { type: 'string', optional: true },
                        image_prompt_strength: { type: 'number', optional: true },
                        webhook_url: { type: 'string', optional: true },
                        webhook_secret: { type: 'string', optional: true },
                        expand_top: { type: 'number', optional: true },
                        expand_bottom: { type: 'number', optional: true },
                        expand_left: { type: 'number', optional: true },
                        expand_right: { type: 'number', optional: true },
                        bfl_params: { type: 'json', optional: true },
