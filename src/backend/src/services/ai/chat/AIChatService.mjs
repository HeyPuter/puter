...
import { DB_WRITE } from '../../../database/consts';
import { TypedValue } from '../../../drivers/meta/Runtime';
import { Context } from '../../../../util/context';
import { AsModeration } from '../moderation/AsModeration';
import FunctionCalling from '../utils/FunctionCalling';
import Messages from '../utils/Messages';
import Streaming from '../utils/Streaming';
import { v4 as uuidv4 } from 'uuid';
import { createid as cuid2 } from '@paralleldrive/cuid2';
import { kv } from '../../../kvjs.mjs';
...
export class AIChatService extends BaseService {
    ...
    /** @type {Record<string, import('./providers/ChatProvider'.IChatProvider)} */
    #providers = {};
    simple_model_list = [];
    detail_model_list = [];
    detail_model_map = {};
    ...
    */
     ...
     *
     * @param {string} name
     * @param {import('./providers/ChatProvider').IChatProvider} chatProvider
     */
    registerProvider (name, chatProvider) {
        this.#providers[name] = chatProvider;
    }
    ...
    */
    ...
    get_fallback_model ({ model, tried }) {
        ...
        let potentialFallbacks = kv.get(`${this.kvkey}:fallbacks:${model}`);
        ...
        if ( ! potentialFallbacks ) {
            ...
            kv.set(`${this.kvkey}:fallbacks:${model}`, potentialMatches);
