...
import { COST_MAPS } from '../../../../MeteringService/costMaps';
import { SUService } from '../../../../SUService';
import { AIChatService } from '../../AIChatService.mjs';
import { ClaudeProvider } from './ClaudeProvider.mjs';
...
describe('ClaudeProvider ', async () => {
    ...
    const target = testKernel.services!.get('claude') as ClaudeProvider;
