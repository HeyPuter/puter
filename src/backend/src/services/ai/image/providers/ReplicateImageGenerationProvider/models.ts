...
export type ReplicateImageModel = IImageModel & {
    ...
    resolutionInputKey?: string; // our output_megapixels
    resolutionSuffix?: string;
};

// Costs are in USD cents.
// Megapixel models: output_mp = cost per output megapixel, input_mp = cost per input megapixel (img2img).
//   Some also have a flat per-run base cost.
...
export const REPLICATE_IMAGE_GENERATION_MODELS: ReplicateImageModel[] = [
    // --- Black Forest Labs FLUX.2 ---
    {
        ...
        costs: {
            run: 1.5, // $0.015 flat per run
            input_mp: 1.5, // $0.015 per input megapixel
            output_mp: 1.5, // $0.015 per output megapixel
        },
    ...
    },
    {
        ...
        index_cost_key: 'output_mp',
        costs: {
            input_mp: 1.4, // $0.014 per MP (go_fast=false)
            output_mp: 1.4,
        },
        costs_go_fast: {
            input_mp: 1.2, // $0.012 per MP (go_fast=true)
            output_mp: 1.2,
        },
        billingScheme: 'megapixel',
        imageInputKey: 'input_images',
    ...
    // --- Leonardo AI ---
    {
        ...
        index_cost_key: 'output',
        costs: {
            output: 1.65, // ~11 units * $0.0015/unit = $0.0165
        },
        billingScheme: 'per-image',
    },
    {
        ...
        index_cost_key: 'output',
        costs: {
            output: 3.75, // ~25 units * $0.0015/unit = $0.0375
        },
        billingScheme: 'per-image',
    },
];
