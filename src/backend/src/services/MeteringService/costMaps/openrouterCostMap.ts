export const OPENROUTER_COST_MAP = {
    ...
    'openrouter:openai/gpt-5.1-chat-latest:prompt': 125,
    'openrouter:openai/gpt-5.1-chat-latest:completion': 1000,
    'openrouter:openai/gpt-5.1-chat-latest:input_cache_read': 12,
