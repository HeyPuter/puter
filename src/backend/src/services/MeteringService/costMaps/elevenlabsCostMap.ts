...
export const ELEVENLABS_COST_MAP = {
    'elevenlabs:eleven_multilingual_v2:character': 0,
    'elevenlabs:eleven_turbo_v2_5:character': 0,
    'elevenlabs:eleven_flash_v2_5:character': 0,
    'elevenlabs:eleven_v3:character': 0,
};
