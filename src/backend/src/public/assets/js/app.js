$(document).ready(function () {
  if (page === 'login') $('#email_or_username').focus();
  else if (page === 'password-recovery') $('#email_or_username').focus();
  else if (page === 'set-new-password') $('#password').focus();
});
...
$('.signup-btn').on('click', function (e) {
  ...
  if (urlquery.has('tok')) tok = urlquery.get('tok');
