...
!function (e, t) {
    ...
    'use strict';var t = [], r = Object.getPrototypeOf, s = t.slice, g = t.flat ? function (e) {
        ...
        push: u,
        sort: t.sort,
        splice: t.splice }, S.extend = S.fn.extend = function () {
        ...
        guid: 1,
        support: y }), 'function' == typeof Symbol && (S.fn[Symbol.iterator] = t[Symbol.iterator]), S.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), function (e, t) {
        ...
        var e, d, b, o, i, h, f, g, w, u, l, T, C, a, E, v, s, c, y, S = `sizzle${ 1 * new Date}`, p = n.document, k = 0, r = 0, m = ue(), x = ue(), A = ue(), N = ue(), j = function (e, t) {
            ...
            }) } }).pseudos.nth = b.pseudos.eq, { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 } )b.pseudos[e] = de(e);for ( e in { submit: !0, reset: !0 } )b.pseudos[e] = he(e);function me () {
        } function xe (e) {
    ...
    toggle: function (e) {
        ...
        addProp: function (t, e) {
            Object.defineProperty(S.Event.prototype, t, { enumerable: !0,
                configurable: !0,
                get: m(e) ? function () {
    ...
    }, S.Event.prototype = { constructor: S.Event,
        ...
        S.event.special[e] = { delegateType: i,
            bindType: i,
            handle: function (e) {
    ...
    html: function (e) {
        return $(this, function (e) {
            var t = this[0] || {}, n = 0, r = this.length;if ( void 0 === e && 1 === t.nodeType ) return t.innerHTML;if ( 'string' == typeof e && !ke.test(e) && !ge[(de.exec(e) || ['', ''])[1].toLowerCase()] ) {
    ...
    replaceWith: function () {
        ...
        S.fn[e] = function (e) {
            ...
            var r, i, o = {};for ( i in t )o[i] = e.style[i], e.style[i] = t[i];for ( i in r = n.call(e), t )e.style[i] = o[i];return r;
        ...
        } var n, r, i, o, a, s, u = E.createElement('div'), l = E.createElement('div');l.style && (l.style.backgroundClip = 'content-box', l.cloneNode(!0).style.backgroundClip = '', y.clearCloneStyle = 'content-box' === l.style.backgroundClip, S.extend(y, { boxSizingReliable: function () {
            return e(), r;
        },
    ...
    } }), ((S.Tween = Ke).prototype = { constructor: Ke,
    ...
    _default: 'swing' }, S.fx = Ke.prototype.init, S.fx.step = {};var Ze, et, tt, nt, rt = /^(?:toggle|show|hide)$/, it = /queueHooks$/;function ot () {
        ...
        var n, r = 0, i = { height: e };for ( t = t ? 1 : 0;r < 4;r += 2 - t )i[`margin${n = ne[r]}`] = i[`padding${n}`] = e;return t && (i.opacity = i.width = e), i;
    } function ut (e, t, n) {
    ...
    finish: function (a) {
        ...
        var e, t = 0, n = S.timers;for ( Ze = Date.now();t < n.length;t++ )(e = n[t])() || n[t] !== e || n.splice(t--, 1);n.length || S.fx.stop(), Ze = void 0;
    ...
    serializeArray: function () {
        ...
        return function (e, t) {
            'string' != typeof e && (t = e, e = '*');var n, r = 0, i = e.toLowerCase().match(P) || [];if ( m(t) ) while ( n = i[r++] )'+' === n[0] ? (n = n.slice(1) || '*', (o[n] = o[n] || []).unshift(t)) : (o[n] = o[n] || []).push(t);
        };
    } function Wt (t, i, o, a) {
        ...
        var n, r, i = S.ajaxSettings.flatOptions || {};for ( n in t ) void 0 !== t[n] && ((i[n] ? e : r || (r = {}))[n] = t[n]);return r && S.extend(!0, e, r), e;
    }Mt.href = bt.href, S.extend({ active: 0,
        lastModified: {},
        etag: {},
        ...
        ajaxTransport: It(Pt),
        ajax: function (e, t) {
            'object' == typeof e && (t = e, e = void 0), t = t || {};var c, f, p, n, d, r, h, g, i, o, v = S.ajaxSetup({}, t), y = v.context || v, m = v.context && (y.nodeType || y.jquery) ? S(y) : S.event, x = S.Deferred(), b = S.Callbacks('once memory'), w = v.statusCode || {}, a = {}, s = {}, u = 'canceled', T = { readyState: 0,
                ...
                var i, o, a, s, u, l = t;h || (h = !0, d && C.clearTimeout(d), c = void 0, p = r || '', T.readyState = 0 < e ? 4 : 0, i = 200 <= e && e < 300 || 304 === e, n && (s = function (e, t, n) {
                    var r, i, o, a, s = e.contents, u = e.dataTypes;while ( '*' === u[0] )u.shift(), void 0 === r && (r = e.mimeType || t.getResponseHeader('Content-Type'));if (r) {
                        for ( i in s ) {
                            if ( s[i] && s[i].test(r) ) {
                                u.unshift(i);break;
                            }
                    ...
                    var i, o, a, s, u, l = {}, c = e.dataTypes.slice();if ( c[1] ) for ( a in e.converters )l[a.toLowerCase()] = e.converters[a];o = c.shift();while (o) {
    ...
    });var _t, zt = [], Ut = /(=)\?(?=&|$)|\?\?/;S.ajaxSetup({ jsonp: 'callback',
    ...
    position: function () {
        if ( this[0] ) {
            var e, t, n, r = this[0], i = { top: 0, left: 0 };if ( 'fixed' === S.css(r, 'position') )t = r.getBoundingClientRect();else {
