...
class UUIDFPE {
  ...
  encrypt(uuidStr) {
    ...
    const cipher = crypto.createCipheriv(this.constructor.ALGORITHM, this.key, null);
  ...
  decrypt(encryptedUuidStr) {
    ...
    const decipher = crypto.createDecipheriv(this.constructor.ALGORITHM, this.key, null);
