...
class Extension extends AdvancedBase {
  ...
  get db() {
    ...
    if (!db) {
      throw new Error('extension tried to access database before it was ' + 'initialized');
    }
    return db;
  }
  ...
  get services() {
    ...
    if (!services) {
      throw new Error('extension tried to access "services" before it was ' + 'initialized');
    }
    return services;
  }
  ...
  get log_context() {
    ...
    if (!log_context) {
      throw new Error('extension tried to access "log_context" before it was ' + 'initialized');
    }
    return log_context;
  }
