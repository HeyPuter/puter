...
const makeRes = (): MockRes => {
    const res: MockRes = {
        ...
        // Drivers declaring a concurrency cap release their slot on a
        // response lifecycle event; nothing here drives those events, so
        // recording the registration is enough.
        once() {
            return this;
        },
    };
