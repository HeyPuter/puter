...
--
-- Idempotent: the column add uses _puter_add_col (from mig_1) so the
-- directory replays safely.

CALL _puter_add_col('user', 'requires_card_verification', '`requires_card_verification` tinyint(1) NOT NULL DEFAULT ''0''');
