...
const RECOMMENDED_APP_NAMES = [
    ...
    'music-player', 'recorder', 'memos', 'word-processor',
    'spreadsheet', 'presentation', 'pdf-editor',
    'basketball-tap', 'blockup', 'pretty-tiles',
    'galaxy-troops', 'blend-fruits', 'traffic-tap-puzzle',
];
