...
import { OpenAIStreamAdapter } from '../openai/OpenAIStreamAdapter.js';
import { OpenAIToolsAdapter } from '../openai/OpenAIToolsAdapter.js';

import models from '../models/deepseek.json' with { type: 'json' };

export class DeepSeekInvocation {
...
export class DeepSeekStreamInvocation extends DeepSeekInvocation {
    /**
     * 
     * @param {Object} params
...
export class DeepSeekSyncInvocation extends DeepSeekInvocation {
    /**
     * 
     * @param {Object} params
     * @param {import('@anthropic-ai/sdk').Anthropic} params.client
...
export class DeepSeekAPIType {
    async stream (client, completionWriter, options) {
        ...
        return new DeepSeekStreamInvocation({
            client,
            sdk_params,
            model_details,
            usageWriter,
    ...
    async create (client, options) {
        ...
        return new DeepSeekSyncInvocation({
            client,
            sdk_params,
            model_details,
        });
