  ...
  return new Promise((resolve, reject) => {
    ...
    progress_check_interval = setInterval(function () {
      ...
      if (item_download_progress.total)
        item_progress =
          (item_download_progress.cloud_uploaded + item_download_progress.downloaded) /
          item_download_progress.total;

      // Entire batch progress
      let batch_progress = (
        ((batch_download_progress[0].cloud_uploaded + batch_download_progress[0].downloaded) /
          batch_download_progress[0].total) *
        100
      ).toFixed(0);
