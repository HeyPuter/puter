...
async function UIWindowRefer(options) {
  ...
  $(el_window)
    .find('.window-body .share-copy-link-on-social')
    .on('click', function (e) {
      const social_links = socialLink({
        url: url,
        title: i18n('refer_friends_social_media_c2a'),
        description: i18n('refer_friends_social_media_c2a'),
      });
  ...
  $(el_window)
    .find('.window-body .copy-downloadable-link')
