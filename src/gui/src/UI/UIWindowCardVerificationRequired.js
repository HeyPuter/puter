...
function UIWindowCardVerificationRequired (options) {
    return new Promise(async (resolve) => {
        ...
        h += '<h3 style="text-align:center; font-weight: 500; font-size: 20px;">Verify Your Card</h3>';
        ...
        h += '<div class="card-step card-step-unavailable" style="display:none;">';
        h += '<p style="text-align:center; padding: 0 20px;">Card verification is temporarily unavailable. Please try again in a few minutes.</p>';
