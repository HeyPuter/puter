...
async function UIWindowQR(options) {
  ...
  h += `<h1 style="text-align: center; font-size: 16px; padding: 10px; font-weight: 400; margin: -10px 10px 20px 10px; -webkit-font-smoothing: antialiased; color: #5f626d;">${i18n(
    options.message_i18n_key || 'scan_qr_generic'
  )}</h1>`;
  h += `</div>`;
