...
function UIWindowPhoneVerificationRequired(options) {
    return new Promise(async (resolve) => {
        ...
        h +=
            '<p class="phone-subtitle">We\'ll text you a verification code to confirm it\'s really you.</p>';
        ...
        h +=
            '<label class="phone-field-label" for="phone-verif-input">Phone number</label>';
        h +=
            '<input id="phone-verif-input" class="phone-input" type="tel" autocomplete="tel" placeholder="+1 (555) 123-4567" />';
        ...
        h +=
            '<p class="phone-subtitle">Enter the 6-digit code sent to <strong style="font-weight: 600; color:#3e5362;" class="phone-target"></strong></p>';
        h += '<div class="error"></div>';
        ...
        h +=
            '<a class="phone-resend-code">Re-send code</a> &nbsp;&bull;&nbsp; <a class="phone-change-number">Change number</a>';
        if (options.logout_in_footer) {
            h += ' &nbsp;&bull;&nbsp; ';
        ...
        $(el_window)
            .find('.phone-resend-code')
            .on('click', function () {
                sendCode();
            });
        $(el_window)
            .find('.phone-change-number')
            .on('click', function () {
                clearError();
        ...
        const numberCodeForm = el_window.querySelector(
