    ...
    const el_window = await UIWindow({
      ...
      onAppend: function (this_window) {
        ...
        window.dispatchEvent(
          new CustomEvent('settings-window-opened', { detail: { window: this_window } })
        );
      },
...
$(document).on('click', function (e) {
  ...
  if (
    !$(e.target).closest('.settings-sidebar').length &&
    !$(e.target).closest('.sidebar-toggle-button').length &&
    !$(e.target).hasClass('sidebar-toggle-button') &&
