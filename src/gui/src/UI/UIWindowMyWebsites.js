...
function addCustomStyles() {
    ...
    const styles = `
        ...
        .action-btn.primary:hover:not(:disabled):not(.disabled) { background: #0056b3; border-color: #0056b3; }
        .action-btn.secondary { background: #6c757d; color: white; border-color: #6c757d; }
        .action-btn.secondary:hover:not(:disabled):not(.disabled) { background: #545b62; border-color: #545b62; }
        .action-btn.warning { background: #ffc107; color: #212529; border-color: #ffc107; }
        .action-btn.warning:hover:not(:disabled):not(.disabled) { background: #e0a800; border-color: #e0a800; }
        .action-btn.danger { background: #dc3545; color: white; border-color: #dc3545; }
        .action-btn.danger:hover:not(:disabled):not(.disabled) { background: #c82333; border-color: #c82333; }
        .action-btn:disabled, .action-btn.disabled, .control-btn:disabled { cursor: not-allowed; opacity: 0.6 !important; background: #6c757d !important; color: #ffffff !important; border-color: #6c757d !important; }
        .action-btn:disabled:hover, .action-btn.disabled:hover, .control-btn:disabled:hover { transform: none; background: #6c757d !important; }
