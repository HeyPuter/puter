...
(!(function () {
  ...
  ((t.prototype = {
    ...
    (e.prototype = {
      ...
      setupTypeInfo: function (t, e) {
        for (
          var r = (this.errorCorrectLevel << 3) | e, o = g.getBCHTypeInfo(r), i = 0;
          i < 15;
          i++
        ) {
          var n = !t && 1 == ((o >> i) & 1);
      ...
      mapData: function (t, e) {
        for (
          var r = -1, o = this.moduleCount - 1, i = 7, n = 0, a = this.moduleCount - 1;
          a > 0;
          a -= 2
        )
          for (6 == a && a--; ; ) {
    ...
    (e.createData = function (t, r, o) {
      ...
      for (n.getLengthInBits() + 4 <= 8 * h && n.put(0, 4); n.getLengthInBits() % 8 != 0; )
        n.putBit(!1);
      for (; !(n.getLengthInBits() >= 8 * h || (n.put(e.PAD0, 8), n.getLengthInBits() >= 8 * h)); )
        n.put(e.PAD1, 8);
      return e.createBytes(n, i);
    }),
    (e.createBytes = function (t, e) {
      for (
        var r = 0, o = 0, i = 0, n = new Array(e.length), a = new Array(e.length), s = 0;
        s < e.length;
        s++
      ) {
        var h = e[s].dataCount,
  ...
  for (c = 8; c < 256; c++)
    d.EXP_TABLE[c] =
      d.EXP_TABLE[c - 4] ^ d.EXP_TABLE[c - 5] ^ d.EXP_TABLE[c - 6] ^ d.EXP_TABLE[c - 8];
  ...
  ((p.prototype = {
    ...
    mod: function (t) {
      ...
      for (
        var e = d.glog(this.get(0)) - d.glog(t.get(0)), r = new Array(this.getLength()), o = 0;
        o < this.getLength();
        o++
      )
        r[o] = this.get(o);
      ...
      return (
        (t.prototype.draw = function (t) {
          ...
          (n.setAttributeNS(
            ...
            n.appendChild(
              i('rect', { fill: e.colorDark, width: '1', height: '1', id: 'template' })
            ));
          for (var a = 0; a < o; a++)
            for (var s = 0; s < o; s++)
              if (t.isDark(a, s)) {
