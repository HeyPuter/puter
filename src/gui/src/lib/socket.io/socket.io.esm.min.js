    ...
    try {
      ...
      (null === (t = this.opts.cookieJar) || void 0 === t || t.addCookies(s),
        ...
        (s.onreadystatechange = () => {
          var t;
          (3 === s.readyState &&
            (null === (t = this.opts.cookieJar) || void 0 === t || t.parseCookies(s)),
            4 === s.readyState &&
...
const G = 'function' == typeof ArrayBuffer,
  ...
  et =
    'function' == typeof Blob ||
    ('undefined' != typeof Blob && '[object BlobConstructor]' === tt.call(Blob)),
  st =
    'function' == typeof File ||
    ('undefined' != typeof File && '[object FileConstructor]' === tt.call(File));
function nt(t) {
  return (
...
function ht(t, e) {
  ...
  if (Array.isArray(t)) for (let s = 0; s < t.length; s++) t[s] = ht(t[s], e);
    ...
    for (const s in t) Object.prototype.hasOwnProperty.call(t, s) && (t[s] = ht(t[s], e));
  return t;
}
const ct = [
    'connect',
