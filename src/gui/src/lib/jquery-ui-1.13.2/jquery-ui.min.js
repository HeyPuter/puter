...
!(function (t) {
        ...
        left: function (t, e) {
          ...
          a < 0
            ? ((n = t.left + r + l + h + e.collisionWidth - n - s) < 0 || n < k(a)) &&
              (t.left += r + l + h)
            : 0 < o &&
              (0 < (s = t.left - e.collisionPosition.marginLeft + r + l + h - i) || k(s) < o) &&
              (t.left += r + l + h);
        },
        top: function (t, e) {
          var i = e.within,
          ...
          a < 0
            ? ((n = t.top + r + l + h + e.collisionHeight - n - s) < 0 || n < k(a)) &&
              (t.top += r + l + h)
            : 0 < o &&
              (0 < (s = t.top - e.collisionPosition.marginTop + r + l + h - i) || k(s) < o) &&
              (t.top += r + l + h);
        },
      },
      flipfit: {
  ...
  (V.ui.position,
    ...
    V.fn.extend({
      disableSelection:
        ((W = 'onselectstart' in document.createElement('div') ? 'selectstart' : 'mousedown'),
        function () {
  ...
  var W,
    ...
    Y = { byte: { floor: !0, max: 255 }, percent: { max: 1 }, degrees: { mod: 360, floor: !0 } },
    B = (p.support = {}),
    t = u('<p>')[0],
    g = u.each;
  function m(t) {
      ...
      g(t, function (t, o) {
        ((u.cssHooks[o] = {
          ...
          (u.fx.step[o] = function (t) {
            (t.colorInit || ((t.start = p(t.elem, o)), (t.end = p(t.end)), (t.colorInit = !0)),
      ...
      show:
        ...
        function (t) {
          return M(t)
            ...
            : (((t = P.apply(this, arguments)).mode = 'show'), this.effect.call(this, t));
        }),
      hide:
        ((J = V.fn.hide),
        function (t) {
          return M(t)
            ...
            : (((t = P.apply(this, arguments)).mode = 'hide'), this.effect.call(this, t));
        }),
      toggle:
        ((Q = V.fn.toggle),
        function (t) {
          return M(t) || 'boolean' == typeof t
            ? Q.apply(this, arguments)
            : (((t = P.apply(this, arguments)).mode = 'toggle'), this.effect.call(this, t));
        }),
      cssUnit: function (t) {
        var i = this.css(t),
          s = [];
                  ...
                  ((e.now = Math.round(t)),
                    'height' !== e.prop
                      ...
                      : 'content' !== o.options.heightStyle &&
                        ((e.now = Math.round(n - i.outerHeight() - a)), (a = 0)));
                },
              }))
    ...
    V.widget('ui.button', {
      ...
      _setOption: function (t, e) {
        ('icon' === t &&
          ...
          this._super(t, e),
          'disabled' === t &&
            (this._toggleClass(null, 'ui-state-disabled', e), (this.element[0].disabled = e)) &&
              ...
              ? this.length || 'instance' !== i
                ? this.each(function () {
                    var t,
                      ...
                      e = V.data(
                        this,
                        'ui-' + ('checkbox' !== e && 'radio' !== e ? 'button' : 'checkboxradio')
                      );
                    return 'instance' === i
                      ? ((n = e), !1)
                      : e
        ...
        !s ||
          ...
          (this._datepickerShowing &&
            ...
            V.effects && (V.effects.effect[t] || V.effects[t])
              ...
              : s.dpDiv['slideDown' === t ? 'slideUp' : 'fadeIn' === t ? 'fadeOut' : 'hide'](
                  t ? i : null,
                  e
                ),
            t || e(),
      ...
      parseDate: function (e, n, t) {
        ...
        if (
          (-1 === u
            ...
            : u < 100 &&
              (u +=
                new Date().getFullYear() - (new Date().getFullYear() % 100) + (u <= a ? 0 : -100)),
          -1 < f)
        )
          for (d = 1, p = f; ; ) {
        ...
        if ((O < 0 && ((O += 12), N--), A))
          for (
            e = this._daylightSavingAdjust(
              new Date(A.getFullYear(), A.getMonth() - P[0] * P[1] + 1, A.getDate())
            ),
              e = z && e < z ? z : e;
          ...
          for (d = '', this.maxRows = 4, p = 0; p < P[1]; p++) {
            ...
            for (
              m +=
                ...
                this._generateMonthYearHeader(t, O, N, z, A, 0 < u || 0 < p, F, L) +
              ...
              for (
                ...
                ((w = a ? a.apply(t.input ? t.input[0] : null, [y]) : [!0, '']),
                  ...
                  (q +=
                    ...
                    ((y.getTime() === f.getTime() && O === t.selectedMonth && t._keyEvent) ||
      ...
      _mouseDown: function (t) {
        ...
        if (!z)
          return (
            ...
            (s =
              !('string' != typeof (e = this).options.cancel || !t.target.nodeName) &&
      ...
      resize: function (t) {
        ...
        (a[0] !== document && /static/.test(a.css('position')) && (o = s),
          n.left < (e._helper ? s.left : 0) &&
            ((e.size.width =
              e.size.width + (e._helper ? e.position.left - s.left : e.position.left - o.left)),
          ...
          (n = Math.abs(
            e.sizeDiff.width + (e._helper ? e.offset.left - o.left : e.offset.left - s.left)
          )),
          (a = Math.abs(
            e.sizeDiff.height + (e._helper ? e.offset.top - o.top : e.offset.top - s.top)
          )),
        ...
        (n.options.refreshPositions && V.ui.ddmanager.prepareOffsets(n, o),
          V.each(V.ui.ddmanager.droppables[n.options.scope] || [], function () {
            ...
            this.options.disabled ||
              ...
              !this.visible ||
              ((s =
                !(s = V.ui.intersect(n, this, this.options.tolerance, o)) && this.isover
                  ? 'isout'
                  : s && !this.isover
                    ? 'isover'
                    : null) &&
