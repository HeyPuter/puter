...
const th = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'สร้างบัญชีและยืนยันที่อยู่อีเมลของคุณเพื่อรับพื้นที่จัดเก็บข้อมูลฟรี 1 GB เพื่อนของคุณจะได้รับพื้นที่จัดเก็บข้อมูลฟรี 1 GB เช่นกัน',
    ...
    confirm_delete_user:
      'คุณแน่ใจว่าต้องการลบบัญชีของคุณ? ไฟล์และข้อมูลทั้งหมดของคุณจะถูกลบอย่างถาวร และไม่สามารถย้อนกลับได้',
    ...
    email_change_confirmation_sent:
      'อีเมล์ยืนยันได้ถูกส่งไปที่อยู่อีเมลใหม่ของคุณแล้ว กรุณาตรวจสอบกล่องข้อความของคุณและทำตามขั้นตอนต่อจนเสร็จ',
    ...
    feedback_c2a:
      'กรุณาใช้แบบฟอร์มด้านล่างเพื่อส่งความคิดเห็น ข้อคิดเห็น และรายงานข้อบกพร่องให้เรา',
    feedback_sent_confirmation:
      'ขอบคุณที่ติดต่อเรา หากคุณมีอีเมลที่เชื่อมโยงกับบัญชีของคุณ คุณจะได้รับการติดต่อกลับจากเราโดยเร็วที่สุด',
    fit: 'พอดี',
    folder: 'โฟลเดอร์',
    ...
    items_in_trash_cannot_be_renamed:
      'ไม่สามารถเปลี่ยนชื่อรายการนี้ได้เนื่องจากอยู่ในถังขยะ หากต้องการเปลี่ยนชื่อรายการนี้ ให้ลากออกจากถังขยะก่อน',
    jpeg_image: 'ภาพ JPEG',
    ...
    password_recovery_rate_limit:
      'คุณได้ใช้ถึงข้อจำกัดแล้ว; กรุณารอสองสามนาที. เพื่อไม่ให้เกิดแบบนี้ในอนาคต, พยายามเลี่ยงการรีโหลดหลายๆครั้ง.',
    ...
    password_strength_error:
      'รหัสผ่านต้องมีอย่างน้อยแปดตัวอักษร ประกอบไปด้วยตัวอักษรเล็ก ใหญ่ ตัวเลข และอักขระพิเศษอย่างน้อยหนึ่งตัว',
    ...
    refer_friends_c2a:
      'รับพื้นที่ 1 GB สำหรับเพื่อนทุกคนที่สร้าง และยืนยันบัญชีบน Puter เพื่อนของคุณจะได้รับพื้นที่ 1 GB เช่นกัน!',
    ...
    save_session_c2a:
      'สร้างบัญชีเพื่อบันทึกเซสชันปัจจุบัน และป้องกันการสูญเสียข้อมูลการทำงานของคุณ',
    ...
    'billing.email_confirmation_needed':
      'อีเมล์ของคุณยังไม่ได้รับการยืนยัน เราจะส่งโค้ดไปทางอีเมล์ของคุณเพื่อทำการยืนยันตอนนี้', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'สมาชิกของคุณได้ถูกยกเลิกแล้วและจะถูกเปลี่ยนเป็นระดับฟรีหลังจากสิ้นสุดรอบบิลนี้ จะไม่มีการเรียกเก็บค่าใช้จ่ายหลังจากนี้ ยกเว้นกรณีสมัครสมาชิกใหม่', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
