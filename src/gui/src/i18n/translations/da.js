...
const da = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Opret en konto og bekræft din e-mailadresse for at modtage 1 GB gratis lagerplads. Din ven vil også få 1 GB gratis lagerplads.',
    ...
    confirm_delete_user:
      'Er du sikker på, at du vil slette din konto? Alle dine filer og data vil blive permanent slettet. Denne handling kan ikke fortrydes.',
    ...
    contact_us_verification_required:
      'Du skal have en verificeret e-mailadresse for at bruge dette.',
    contain: 'Indeholde',
    continue: 'Fortsæt',
    copy: 'Kopier',
    ...
    email_change_confirmation_sent:
      'En bekræftelses-e-mail er sendt til din nye e-mailadresse. Kontroller din indbakke og følg instruktionerne for at fuldføre processen.',
    ...
    enter_password_to_confirm_delete_user:
      'Indtast din adgangskode for at bekræfte sletning af konto',
    ...
    feedback: 'Feedback',
    feedback_c2a:
      'Brug venligst formularen nedenfor til at sende os din feedback, kommentarer og fejlrapporter.',
    feedback_sent_confirmation:
      'Tak fordi du kontaktede os. Hvis du har en e-mail knyttet til din konto, vil du høre fra os så hurtigt som muligt.',
    fit: 'Pas',
    folder: 'Mappe',
    ...
    no_websites_published:
      'Du har ikke offentliggjort nogen websteder endnu. Højreklik på en mappe for at komme i gang.',
    ok: 'OK',
    open: 'Åbn',
    ...
    password_recovery_rate_limit:
      'Du har nået vores rate-limit; vent venligst et par minutter. For at undgå dette i fremtiden, undgå at genindlæse siden for mange gange.',
    ...
    password_strength_error:
      'Adgangskoden skal være mindst 8 tegn lang og indeholde mindst ét stort bogstav, ét lille bogstav, ét tal og ét specialtegn.',
    ...
    refer_friends_c2a:
      'Få 1 GB for hver ven, der opretter og bekræfter en konto på Puter. Din ven vil også få 1 GB!',
    ...
    save_session_c2a:
      'Opret en konto for at gemme din nuværende session og undgå at miste dit ændringer.',
    ...
    login2fa_recovery_instructions:
      'Indtast en af dine gendannelseskoder for at få adgang til din konto.',
    ...
    billing_subscription_cancelled_description:
      'Du vil stadig have adgang til dit abonnement indtil slutningen af denne faktureringsperiode.',
    ...
    billing_subscription_cancellation_confirmation:
    ...
    billing_subscription_check_error:
      'Der opstod et problem under kontrol af din abonnementsstatus.',
    billing_email_confirmation_needed:
      'Din e-mail er ikke blevet bekræftet. Vi sender dig en kode for at bekræfte den nu.',
    billing_sub_cancelled_but_valid_until:
      'Du har annulleret dit abonnement, og det vil automatisk skifte til den gratis plan ved slutningen af faktureringsperioden. Du vil ikke blive opkrævet igen, medmindre du genabonnerer.',
    billing_current_plan_until_end_of_period:
      'Din nuværende plan indtil slutningen af denne faktureringsperiode.',
