...
const da = {
	...
	dictionary: {
		...
		"create_desktop_shortcut_s": 'Opret genveje (Desktop)', // In English: "Create Shortcuts (Desktop)"
		"create_shortcut_s": 'Opret genveje', // In English: "Create Shortcuts"
		"minimize": 'Minimer', // In English: "Minimize"
		"reload_app": 'Genindlæs app', // In English: "Reload App"
		"new_window": 'Nyt vindue', // In English: "New Window"
		"open_trash": 'Åbn papirkurven', // In English: "Open Trash"
		"pick_name_for_worker": 'Vælg et navn til din medarbejder:', // In English: "Pick a name for your worker:"
		"publish_as_serverless_worker": 'Udgiv som arbejder', // In English: "Publish as Worker"
		"toolbar.enter_fullscreen": 'Gå ind i fuld skærm', // In English: "Enter Full Screen"
		"toolbar.github": 'GitHub', // In English: "GitHub"
		"toolbar.refer": 'Henvis', // In English: "Refer"
		"toolbar.save_account": 'Gem konto', // In English: "Save Account"
		"toolbar.search": 'Søge', // In English: "Search"
		"toolbar.qrcode": 'QR-kode', // In English: "QR Code"
		"used_of": '{{used}} brugt af {{available}}', // In English: "{{used}} used of {{available}}"
		"worker": 'Arbejder', // In English: "Worker"
		...
		"billing.change_payment_method": 'Forandring', // In English: "Change"
		"billing.cancel": 'Ophæve', // In English: "Cancel"
		...
		"billing.subscription_cancelled_description": 'Du vil stadig have adgang til dit abonnement indtil udgangen af ​​denne faktureringsperiode.', // In English: "You will still have access to your subscription until the end of this billing period."
		"billing.offering.free": 'Gratis', // In English: "Free"
		"billing.offering.basic": 'Grundlæggende', // In English: "Basic"
		"billing.offering.pro": 'Professionel', // In English: "Professional"
		"billing.offering.professional": 'Professionel', // In English: "Professional"
		"billing.offering.business": 'Forretning', // In English: "Business"
		...
		"billing.apps_and_games": 'Apps og spil', // In English: "Apps & Games"
		...
		"billing.you_are_now_subscribed_to": 'Du er nu abonneret på %strong%-niveauet.', // In English: "You are now subscribed to %strong% tier."
		...
		"billing.subscription_setup": 'Opsætning af abonnement', // In English: "Subscription Setup"
		...
		"billing.currently_on_free_plan": 'Du er i øjeblikket på gratisabonnementet.', // In English: "You are currently on the free plan."
		...
		"billing.email_confirmation_needed": 'Din e-mail er ikke blevet bekræftet. Vi sender dig en kode for at bekræfte den nu.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
		"billing.sub_cancelled_but_valid_until": 'Du har opsagt dit abonnement, og det skifter automatisk til gratisniveauet ved udgangen af ​​faktureringsperioden. Du bliver ikke opkrævet igen, medmindre du abonnerer igen.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
		"billing.current_plan_until_end_of_period": 'Dit nuværende abonnement indtil udgangen af ​​denne faktureringsperiode.', // In English: "Your current plan until the end of this billing period."
		...
		"billing.enjoy_msg": 'Få %% cloud-lagring plus andre fordele.', // In English: "Enjoy %% of Cloud Storage plus other benefits."
		"too_many_attempts": 'For mange forsøg. Prøv igen senere.', // In English: "Too many attempts. Please try again later."
		"server_timeout": 'Serveren var for lang om at svare. Prøv igen.', // In English: "The server took too long to respond. Please try again."
		"signup_error": 'Der opstod en fejl under tilmeldingen. Prøv igen.', // In English: "An error occurred during signup. Please try again."
		"welcome_title": 'Velkommen til din personlige internetcomputer', // In English: "Welcome to your Personal Internet Computer"
		"welcome_description": 'Gem filer, spil spil, find fantastiske apps og meget mere! Alt samlet ét sted, tilgængeligt hvor som helst og når som helst.', // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
		"welcome_get_started": 'Kom i gang', // In English: "Get Started"
		"welcome_terms": 'Vilkår', // In English: "Terms"
		"welcome_privacy": 'Privatliv', // In English: "Privacy"
		"welcome_developers": 'Udviklere', // In English: "Developers"
		"welcome_open_source": 'Open Source', // In English: "Open Source"
		"welcome_instant_login_title": 'Øjeblikkeligt login!', // In English: "Instant Login!"
		"alert_error_title": 'Fejl!', // In English: "Error!"
		...
		"alert_no": 'Ingen', // In English: "No"
		"alert_retry": 'Prøv igen', // In English: "Retry"
		"alert_cancel": 'Ophæve', // In English: "Cancel"
		"signup_confirm_password": 'Bekræft adgangskode', // In English: "Confirm Password"
		"login_email_username_required": 'E-mail eller brugernavn er påkrævet', // In English: "Email or username is required"
		"login_password_required": 'Adgangskode er påkrævet', // In English: "Password is required"
		"window_title_open": 'Åben', // In English: "Open"
		"window_title_change_password": 'Skift adgangskode', // In English: "Change Password"
		"window_title_select_font": 'Vælg skrifttype...', // In English: "Select font…"
		"window_title_session_list": 'Sessionsliste!', // In English: "Session List!"
		"window_title_set_new_password": 'Indstil ny adgangskode', // In English: "Set New Password"
		"window_title_instant_login": 'Øjeblikkeligt login!', // In English: "Instant Login!"
		"window_title_publish_website": 'Udgiv hjemmeside', // In English: "Publish Website"
		"window_title_publish_worker": 'Udgiv Arbejder', // In English: "Publish Worker"
		"window_title_authenticating": 'Godkender...', // In English: "Authenticating..."
		"window_title_refer_friend": 'Henvis en ven!', // In English: "Refer a friend!"
		"desktop_show_desktop": 'Vis skrivebord', // In English: "Show Desktop"
		"desktop_show_open_windows": 'Vis Åbne Windows', // In English: "Show Open Windows"
		"desktop_exit_full_screen": 'Afslut fuld skærm', // In English: "Exit Full Screen"
		"desktop_enter_full_screen": 'Gå ind i fuld skærm', // In English: "Enter Full Screen"
		"desktop_position": 'Position', // In English: "Position"
		"desktop_position_left": 'Venstre', // In English: "Left"
		"desktop_position_bottom": 'Bund', // In English: "Bottom"
		"desktop_position_right": 'Højre', // In English: "Right"
		"item_shared_with_you": 'En bruger har delt dette element med dig.', // In English: "A user has shared this item with you."
		"item_shared_by_you": 'Du har delt dette element med mindst én anden bruger.', // In English: "You have shared this item with at least one other user."
		"item_shortcut": 'Genvej', // In English: "Shortcut"
		"item_associated_websites": 'Tilknyttet hjemmeside', // In English: "Associated website"
		"item_associated_websites_plural": 'Tilknyttede hjemmesider', // In English: "Associated websites"
		"no_suitable_apps_found": 'Ingen passende apps fundet', // In English: "No suitable apps found"
		"window_click_to_go_back": 'Klik for at gå tilbage.', // In English: "Click to go back."
		"window_click_to_go_forward": 'Klik for at gå videre.', // In English: "Click to go forward."
		"window_click_to_go_up": 'Klik for at gå én mappe op.', // In English: "Click to go one directory up."
		"window_title_public": 'Offentlig', // In English: "Public"
		"window_title_videos": 'Videoer', // In English: "Videos"
		"window_title_pictures": 'Billeder', // In English: "Pictures"
		"window_title_puter": 'Puter', // In English: "Puter"
		"window_folder_empty": 'Denne mappe er tom', // In English: "This folder is empty"
		"manage_your_subdomains": 'Administrer dine underdomæner', // In English: "Manage Your Subdomains"
		"open_containing_folder": 'Åbn indeholdende mappe', // In English: "Open Containing Folder"
