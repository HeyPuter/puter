...
const cs = {
    ...
    "dictionary": {
        ...
        "add_app_browse_desc": "Procházet App Center a nainstalovat potřebné aplikace",
        ...
        "access_granted_to": "Přístup udělen",
        ...
        "confirm_code_2fa_submit_btn": "Předložit",
        ...
        "close_all_windows_and_log_out": "Zavřete Windows a odhlaste se",
        ...
        "directory_depth_limit_exceeded": "Tato složka je vnořena příliš hluboko. Než do něj přidáte další složky, přesuňte jej někam blíže k vrcholu.",
        "disable_2fa_confirm": "Opravdu chcete deaktivovat 2FA?",
        "dir_published_as_website": "%strong% byl publikován pro:",
        "documents": "Dokumenty",
        "dont_allow": "Nedovolte",
        ...
        "end_hard": "Tvrdý konec",
        "empty_trash_confirmation": "Opravdu chcete trvale smazat položky v koši?",
        "end_process_force_confirm": "Opravdu chcete tento proces vynutit-ukončit?",
        ...
        "get_copy_link": "Získejte Kopírovat odkaz",
        ...
        "name_cannot_contain_period": "Název nemůže být '.' charakter.",
        ...
        "no": "Ne",
        "name_cannot_contain_double_period": "Jméno nesmí být znakem '..'.",
        ...
        "phone_resend_in": "Znovu odeslat v %%",
        ...
        "keyboard_shortcuts_general": "Generál",
        "keyboard_shortcuts_search": "Otevřít vyhledávání",
        "keyboard_shortcuts_select_all": "Vyberte všechny položky",
        ...
        "keyboard_shortcuts_close_window": "Zavřete aktivní okno",
        "select_color": "Vyberte barvu…",
        "keyboard_shortcuts_arrow_navigation": "Procházení nabídek a výběrů",
        "keyboard_shortcuts_type_to_select": "Zadejte pro přechod na položku podle názvu",
        "keyboard_shortcuts_open_help": "Otevřete tohoto průvodce klávesovými zkratkami",
        "keyboard_shortcuts_close_menus": "Zavřete dialogová okna, nabídky a vyskakovací okna",
        "share": "Sdílet",
        "share_ellipsis": "Podíl…",
        "keyboard_shortcuts_copy": "Kopírovat vybrané položky",
        "keyboard_shortcuts_type_to_select_keys": "Zadejte písmena nebo čísla",
        ...
        "share_awaiting_signup": "Pozvaný",
        "share_invited": "Pozvaný {{recipient}} – získá přístup, jakmile se připojí",
        ...
        "blocked_all_on": "Nové akcie jsou nyní odmítány všemi",
        ...
        "taskmgr_header_status": "Postavení",
        "terms": "Podmínky",
        "toolbar.enter_fullscreen": "Vstupte na celou obrazovku",
        "taskmgr_header_type": "Typ",
        "toolbar.github": "GitHub",
        "toolbar.refer": "Odkazovat",
        "toolbar.search": "Vyhledávání",
        ...
        "two_factor": "Dvoufaktorová autentizace",
        ...
        "ui_session_current": "Proud",
        "ui_session_expires": "Platnost vyprší",
        "ui_session_ip": "IP",
        "ui_manage_sessions": "Správce relace",
        ...
        "undo": "Vrátit zpět",
        "unlimited": "Neomezený",
        "ui_session_last_active": "Poslední aktivní",
        "ui_session_count_other": "%% aktivních relací",
        "ui_revoke_all_other_sessions": "Zrušte všechny ostatní relace",
        ...
        "ui_toggle_session_children": "Přepnout dětské relace",
        "unzip": "Rozbalte zip",
        "untar": "Untar",
        ...
        "untarring": "Zrušení tarování %strong%",
        "visibility": "Viditelnost",
        "videos": "Videa",
        "yes": "Ano",
        "versions": "Verze",
        "yes_release_it": "Ano, uvolněte to",
        "uptime": "Doba provozuschopnosti",
        "upload_here": "Nahrajte sem",
        "zip": "zip",
        "worker": "Pracovník",
        "tar": "Dehet",
        "sequencing": "Sekvenování %strong%",
        "you_have_been_referred_to_puter_by_a_friend": "Na Putera vás odkázal přítel!",
        "setup2fa_1_step_heading": "Otevřete aplikaci pro ověřování",
        "zipping": "Komprimování %strong%",
        "used_of": "{{used}} využito z {{available}}",
        "username_changed": "Uživatelské jméno bylo úspěšně změněno.",
        "tarring": "Dehtování %strong%",
        ...
        "setup2fa_1_instructions": "Naskenujte QR kód pomocí své ověřovací aplikace a poté zadejte 6místný kód, který vygeneruje.",
        ...
        "download_as_tar": "Stáhnout jako Tar",
        ...
        "billing.offering.free": "Uvolnit",
        "business": "podnikání",
        "billing.offering.business": "podnikání",
        ...
        "billing.upgrade_to_pro": "Upgradovat na %strong%",
        ...
        "billing.email_confirmation_needed": "Váš email nebyl potvrzen. Nyní vám zašleme kód pro potvrzení.",
        ...
        "billing.current_plan_until_end_of_period": "Váš aktuální tarif do konce tohoto fakturačního období.",
        ...
        "your_personal_internet_computer": "Do vašeho osobního internetového počítače",
        ...
        "alert_confirm_title": "jsi si jistý?",
        "alert_yes": "Ano",
        "alert_no": "Žádný",
        ...
        "window_title_publish_worker": "Publikační pracovník",
        "desktop_show_desktop": "Zobrazit plochu",
        "window_title_select_font": "Vyberte písmo…",
        ...
        "desktop_position_right": "Právo",
        "desktop_position_left": "Vlevo",
        "desktop_position_bottom": "Dno",
        "desktop_enter_full_screen": "Vstupte na celou obrazovku",
        ...
        "desktop_exit_full_screen": "Ukončete celou obrazovku",
        ...
        "perm_fs_resource_access": "přístup {{resource_id}} s přístupem {{access}}.",
        "perm_fs_file_access": "použijte {{name}} umístěný na {{path}} s přístupem {{access}}.",
        "perm_driver_use": "použijte {{driver}} až {{action}}.",
        ...
        "open_containing_folder": "Otevřete složku obsahující",
        ...
        "approve": "Schvalovat",
        "copy_token_message": "Váš ověřovací token je zobrazen níže. Udržujte to v tajnosti – kdokoli s tímto tokenem má přístup k vašemu účtu.",
        ...
        "copy_auth_token": "Kopírovat token ověření",
        ...
        "copy_token_description": "Zobrazte a zkopírujte svůj ověřovací token",
        "create_api_token": "Vytvořte token API",
        ...
        "token_shown_once_warning": "Zkopírujte tento token nyní – už se nebude zobrazovat. Udržujte to v tajnosti; kdokoli s ním může přistupovat k datům vašeho účtu prostřednictvím rozhraní API.",
        ...
        "authme_full_token_request": "Aplikace požaduje token, který může dělat cokoli, co můžete.",
        ...
        "shared_full_token_item_act": "Chovejte se na Puterovi jako vy, dokud ho neodvoláte",
        "authme_full_token_confirm_label": "Zadejte {{phrase}} níže a dejte {{host}} úplný přístup k účtu {{username}}.",
