...
அவற்றை பாதுகாப்பான இடத்தில் சேமித்து வைப்பதை உறுதி செய்யவும்.
        ...
        "billing.change_payment_method": "கட்டண முறையை மாற்றவும்", // In English: "Change"
        "billing.cancel": "ரத்து செய்", // In English: "Cancel"
        "billing.download_invoice": "விலைப்பட்டியலை பதிவிறக்கவும்", // In English: "Download"
        "billing.payment_method": "கட்டண முறை", // In English: "Payment Method"
        "billing.payment_method_updated": "கட்டண முறை புதுப்பிக்கப்பட்டது!", // In English: "Payment method updated!"
        "billing.confirm_payment_method": "கட்டண முறையை உறுதிப்படுத்தவும்", // In English: "Confirm Payment Method"
        "billing.payment_history": "கட்டண வரலாறு", // In English: "Payment History"
        "billing.refunded": "திரும்பப்பெறப்பட்டது", // In English: "Refunded"
        "billing.paid": "செலுத்தப்பட்டது", // In English: "Paid"
        "billing.ok": "சரி", // In English: "OK"
        "billing.resume_subscription": "சந்தாவை மீண்டும் தொடங்கவும்", // In English: "Resume Subscription"
        "billing.subscription_cancelled": "உங்கள் சந்தா ரத்து செய்யப்பட்டது.", // In English: "Your subscription has been canceled."
        "billing.subscription_cancelled_description": "இந்த கட்டண காலத்தின் முடிவுவரை உங்கள் சந்தாவை அணுகலாம்.", // In English: "You will still have access to your subscription until the end of this billing period."
        "billing.offering.free": "இலவசம்", // In English: "Free"
        "billing.offering.pro": "தொழில்முறை", // In English: "Professional"
        "billing.offering.business": "வணிகம்", // In English: "Business"
        "billing.cloud_storage": "மேக சேமிப்பு", // In English: "Cloud Storage"
        "billing.ai_access": "ஏஐ அணுகல்", // In English: "AI Access"
        "billing.bandwidth": "பாண்ட்விட்த்", // In English: "Bandwidth"
        "billing.apps_and_games": "பயன்பாடுகள் & விளையாட்டுகள்", // In English: "Apps & Games"
        "billing.upgrade_to_pro": "%strong% க்கு மேம்படுத்தவும்", // In English: "Upgrade to %strong%"
        "billing.switch_to": "%strong% க்கு மாறவும்", // In English: "Switch to %strong%"
        "billing.payment_setup": "கட்டண அமைப்பு", // In English: "Payment Setup"
        "billing.back": "மீண்டும்", // In English: "Back"
        "billing.you_are_now_subscribed_to": "நீங்கள் இப்போது %strong% நிலைக்கு சந்தா செலுத்தியுள்ளீர்கள்.", // In English: "You are now subscribed to %strong% tier."
        "billing.you_are_now_subscribed_to_without_tier": "நீங்கள் இப்போது சந்தா செலுத்தியுள்ளீர்கள்", // In English: "You are now subscribed"
        "billing.subscription_cancellation_confirmation": "உங்கள் சந்தாவை நிச்சயமாக ரத்து செய்ய விரும்புகிறீர்களா?", // In English: "Are you sure you want to cancel your subscription?"
        "billing.subscription_setup": "சந்தா அமைப்பு", // In English: "Subscription Setup"
        "billing.cancel_it": "அதை ரத்து செய்", // In English: "Cancel It"
        "billing.keep_it": "அதை வைத்திரு", // In English: "Keep It"
        ...
        "billing.upgrade_now": "இப்போது மேம்படுத்தவும்", // In English: "Upgrade Now"
        "billing.upgrade": "மேம்படுத்தவும்", // In English: "Upgrade"
        "billing.currently_on_free_plan": "நீங்கள் தற்போது இலவச திட்டத்தில் உள்ளீர்கள்.", // In English: "You are currently on the free plan."
        "billing.download_receipt": "ரசீதை பதிவிறக்கவும்", // In English: "Download Receipt"
        "billing.subscription_check_error": "உங்கள் சந்தா நிலையைச் சரிபார்க்கும்போது ஒரு பிரச்சினை ஏற்பட்டது.", // In English: "A problem occurred while checking your subscription status."
        "billing.email_confirmation_needed": "உங்கள் மின்னஞ்சல் உறுதிப்படுத்தப்படவில்லை. அதை உறுதிப்படுத்த இப்போது ஒரு குறியீட்டை அனுப்புவோம்.", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
        "billing.sub_cancelled_but_valid_until": "நீங்கள் உங்கள் சந்தாவை ரத்து செய்துள்ளீர்கள், மேலும் இது கட்டண காலத்தின் முடிவுவரை உங்கள் சந்தாவை அணுகலாம்.", // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
        "billing.current_plan_until_end_of_period": "இந்த கட்டண காலத்தின் முடிவுவரை உங்கள் தற்போதைய திட்டம்.", // In English: "Your current plan until the end of this billing period."
        "billing.current_plan": "தற்போதைய திட்டம்", // In English: "Current plan"
        "billing.cancelled_subscription_tier": "ரத்து செய்யப்பட்ட சந்தா (%%)", // In English: "Cancelled Subscription (%%)"
        "billing.manage": "நிர்வகிக்கவும்", // In English: "Manage"
        "billing.limited": "வரையறுக்கப்பட்டது", // In English: "Limited"
        "billing.expanded": "விரிவாக்கப்பட்டது", // In English: "Expanded"
        "billing.accelerated": "வேகப்படுத்தப்பட்டது", // In English: "Accelerated"
        "billing.enjoy_msg": "மேக சேமிப்பில் %% மற்றும் பிற நன்மைகளை அனுபவிக்கவும்.", // In English: "Enjoy %% of Cloud Storage plus other benefits."
    }
};
