...
const fa = {
  ...
  dictionary: {
    ...
    confirm_code_generic_too_many_requests: 'تعداددرخواست‌ها زیاداست. لطفاً چند دقیقه صبر کنید',
    confirm_code_generic_submit: 'ثبت کد',
    confirm_code_generic_try_again: 'دوباره امتحان کنید',
    confirm_code_2fa_instruction: 'کد ۶ رقمی را از برنامه تأیید هویت خود وارد کنید',
    confirm_code_2fa_submit_btn: 'ثبت',
    confirm_code_2fa_title: 'کد احراز هویت دو مرحله ای را وارد کنید',
    confirm_delete_multiple_items: 'آیا مطمئن هستید که می‌خواهید این موارد را برای همیشه حذف کنید؟',
    confirm_delete_single_item: 'آیا می‌خواهید این مورد را برای همیشه حذف کنید؟',
    ...
    confirm_session_revoke: 'آیا مطمئن هستید که می خواهید این نشست را لغو کنید؟', // TN: It's better to use session instead ofنشست
    ...
    clock_visible_auto: 'خودکار - به صورت پیش‌فرض، قابل مشاهده فقط در حالت تمام-صفحه',
    close_all: 'بستن همه',
    created: 'ایجاد شده',
    ...
    disable_2fa_confirm: 'آیا مطمئن هستید که می‌خواهید احراز هویت دو مرحله ای را غیرفعال کنید؟',
    disable_2fa_instructions: 'برای غیرفعال کردن احراز هویت دو مرحله ای ،رمز عبور خود را وارد کنید',
    ...
    end_process_force_confirm: 'آیا مطمئن هستید که می‌خواهید این فرآیند را به اجبار متوقف کنید؟',
    end_soft: 'پایان دادن نرم',
    enlarged_qr_code: 'بارکد بزرگ شده',
    enter_password_to_confirm_delete_user: 'رمز عبور خود را برای تایید حذف حساب وارد کنید',
    ...
    password_recovery_token_invalid: 'این توکن بازیابی رمز عبور دیگر معتبر نیست',
    password_recovery_unknown_error: 'یک خطای ناشناخته رخ داده است. لطفاً بعداً دوباره تلاش کنید',
    ...
    restart_puter_confirm: 'آیا مطمئن هستید که می‌خواهید پیوتر را مجددا راه اندازی کنید',
    restore: 'بازیابی',
    save: 'ذخیره',
    ...
    type: 'نوع',
    type_confirm_to_delete_account: "عبارت 'تأیید' را برای حذف حساب خود وارد کنید",
    ...
    setup2fa_5_confirmation_1: 'من کدهای بازیابی خود را در مکانی امن ذخیره کرده‌ام',
    ...
    login2fa_otp_instructions: 'کد ۶ رقمی را از اپلیکیشن احراز هویت خود وارد کنید',
    login2fa_recovery_title: 'یک کد بازیابی وارد کنید',
    login2fa_recovery_instructions: 'یکی از کدهای بازیابی خود را برای دسترسی به حساب خود وارد کنید',
    ...
    Owner: 'مالک',
    "You can't share with yourself.": 'شما نمی‌توانید  با خودتان به اشتراک بگذارید',
    'This user already has access to this item': 'این کاربر از قبل به این مورد دسترسی دارد',
    ...
    'billing.subscription_cancelled_description':
      'شما تا پایان این دوره صورتحساب همچنان به اشتراک خود دسترسی خواهید داشت.',
    ...
    'billing.email_confirmation_needed':
      'ایمیل شما تأیید نشده است. ما اکنون یک کد برای تأیید آن ارسال خواهیم کرد.',
    'billing.sub_cancelled_but_valid_until':
      'شما اشتراک خود را لغو کرده‌اید و در پایان دوره صورتحساب به طور خودکار به سطح رایگان تغییر خواهد کرد. تا زمانی که مجدداً مشترک نشوید، هزینه‌ای از شما دریافت نخواهد شد.',
