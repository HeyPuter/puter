...
const pt = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Cria uma conta e confirma o endereço do email para receberes 1 GB de armazenamento gratuito. O teu amigo também receberá 1 GB de armazenamento gratuito.',
    ...
    confirm_delete_user:
      'Tens a certeza que queres apagar a tua conta? Todos os ficheiros e dados serão apagados permanentemente. Esta operação é final.',
    ...
    contact_us_verification_required:
      'É necessário ter um endereço de email verificado para usar isto.',
    contain: 'Contém',
    continue: 'Continua',
    copy: 'Copia',
    ...
    email_change_confirmation_sent:
      'Um email de confirmação foi enviado para o teu novo endereço de email. Por favor, verifique a sua caixa de entrada e siga as instruções para completar o processo.',
    ...
    password_recovery_rate_limit:
      'Atingiste o nosso limite de pedidos; por favor, espera alguns minutos. Para evitar isto no futuro, evita recarregar a página demasiadas vezes',
    ...
    password_strength_error:
      'A password deve ter pelo menos 8 caracteres e conter pelo menos uma letra maiúscula, uma letra minúscula, um número e um caractere especial.',
    ...
    refer_friends_c2a:
      'Ganha 1 GB por cada amigo que criar e confirmar uma conta Puter. Os teus amigos também ganham 1 GB!',
    ...
    login2fa_recovery_instructions:
      'Introduza um dos seus códigos de recuperação de 2FA para ter acesso a sua conta.',
    ...
    'billing.subscription_cancelled_description':
      'Ainda terá acesso à sua subscrição até ao final deste período de faturação.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.you_are_now_subscribed_to':
      'A sua subscrição no nivel %strong% foi realizada com uscesso.', // In English: "You are now subscribed to %strong% tier."
    ...
    'billing.subscription_cancellation_confirmation':
      'Tem a certeza de que deseja cancelar a sua subscrição?', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.subscription_check_error':
      'Ocorreu um problema ao verificar o estado da sua subscrição.', // In English: "A problem occurred while checking your subscription status."
    'billing.email_confirmation_needed':
      'O seu email não foi confirmado. Enviaremos agora um código para o confirmar.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'Cancelou a sua subscrição e será automaticamente ativado o plano gratuito no final do período de faturação. Não será cobrado novamente a menos que volte a subscrever.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'O seu plano atual até ao final deste período de faturação.', // In English: "Your current plan until the end of this billing period."
