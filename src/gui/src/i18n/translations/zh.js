...
const zh = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      '创建帐号并确认您的电子邮件地址，以获得1 GB的免费存储空间。您的朋友也将获得1 GB的免费存储空间。',
    ...
    'billing.sub_cancelled_but_valid_until':
      '您已取消订阅，在结算期后将会自动转为免费级别。除非您重新订阅，否则不会再向您收取费用。', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
