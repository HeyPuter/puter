...
const en = {
 ...
 הקפד לאחסן אותם במקום בטוח.
    ...
    // =============================================================
    "choose_publishing_option": "בחר כיצד ברצונך לפרסם את האתר שלך:", // In English: "Choose how you want to publish your website:"
    "create_desktop_shortcut": "צור קיצור דרך (שולחן העבודה)", // In English: "Create Shortcut (Desktop)"
    "create_desktop_shortcut_s": "צור קיצורי דרך (שולחן העבודה)", // In English: "Create Shortcuts (Desktop)"
    "create_shortcut_s": "צור קיצורי דרך", // In English: "Create Shortcuts"
    "minimize": "מזער", // In English: "Minimize"
    "reload_app": "טען מחדש את האפליקציה", // In English: "Reload App"
    ...
    "toolbar.enter_fullscreen": "כניסה למסך מלא", // In English: "Enter Full Screen"
    "toolbar.github": "GitHub", // In English: "GitHub"
    "toolbar.refer": "הפנה", // In English: "Refer"
    "toolbar.save_account": "שמור חשבון", // In English: "Save Account"
    "toolbar.search": "חיפוש", // In English: "Search"
    "toolbar.qrcode": "קוד QR", // In English: "QR Code"
    "used_of": "{{used}} בשימוש מתוך {{available}}", // In English: "{{used}} used of {{available}}"
    "worker": "עובד", // In English: "Worker"
    "billing.offering.basic": "בסיסי", // In English: "Basic"
    "too_many_attempts": "יותר מדי ניסיונות. אנא נסה שוב מאוחר יותר.", // In English: "Too many attempts. Please try again later."
    "server_timeout": "השרת לקח יותר מדי זמן לענות. אנא נסה שוב.", // In English: "The server took too long to respond. Please try again."
    "signup_error": "אירעה שגיאה במהלך ההרשמה. אנא נסה שוב.", // In English: "An error occurred during signup. Please try again."
    "welcome_title": "ברוכים הבאים למחשב האינטרנט האישי שלכם", // In English: "Welcome to your Personal Internet Computer"
    "welcome_description": "אחסנו קבצים, שחקו משחקים, מצאו אפליקציות מדהימות ועוד הרבה! הכל במקום אחד, נגיש מכל מקום ובכל זמן.", // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
    "welcome_get_started": "בואו נתחיל", // In English: "Get Started"
    ...
    "welcome_open_source": "קוד פתוח", // In English: "Open Source"
    "welcome_instant_login_title": "כניסה מיידית!", // In English: "Instant Login!"
    "alert_error_title": "שגיאה!", // In English: "Error!"
    ...
    "alert_retry": "נסה שוב", // In English: "Retry"
    "alert_cancel": "ביטול", // In English: "Cancel"
    "signup_confirm_password": "אשר סיסמה", // In English: "Confirm Password"
    "login_email_username_required": "נדרש אימייל או שם משתמש", // In English: "Email or username is required"
    "login_password_required": "סיסמה נדרשת", // In English: "Password is required"
    "window_title_open": "פתח", // In English: "Open"
    "window_title_change_password": "שנה סיסמה", // In English: "Change Password"
    "window_title_select_font": "בחר גופן…", // In English: "Select font…"
    "window_title_session_list": "רשימת הפעלות!", // In English: "Session List!"
    "window_title_set_new_password": "הגדר סיסמה חדשה", // In English: "Set New Password"
    "window_title_instant_login": "כניסה מיידית!", // In English: "Instant Login!"
    "window_title_publish_website": "פרסם אתר אינטרנט", // In English: "Publish Website"
    ...
    "desktop_show_desktop": "הצג שולחן עבודה", // In English: "Show Desktop"
    "desktop_show_open_windows": "הצג חלונות פתוחים", // In English: "Show Open Windows"
    "desktop_exit_full_screen": "יציאה ממסך מלא", // In English: "Exit Full Screen"
    "desktop_enter_full_screen": "כניסה למסך מלא", // In English: "Enter Full Screen"
    "desktop_position": "מיקום", // In English: "Position"
    "desktop_position_left": "שמאל", // In English: "Left"
    "desktop_position_bottom": "תחתון", // In English: "Bottom"
    "desktop_position_right": "ימין", // In English: "Right"
    "item_shared_with_you": "משתמש שיתף איתך את הפריט הזה.", // In English: "A user has shared this item with you."
    "item_shared_by_you": "שיתפת את הפריט הזה עם לפחות משתמש אחד אחר.", // In English: "You have shared this item with at least one other user."
    "item_shortcut": "קיצור דרך", // In English: "Shortcut"
    "item_associated_websites": "אתר אינטרנט משויך", // In English: "Associated website"
    "item_associated_websites_plural": "אתרי אינטרנט משויכים", // In English: "Associated websites"
    "no_suitable_apps_found": "לא נמצאו אפליקציות מתאימות", // In English: "No suitable apps found"
    "window_click_to_go_back": "לחץ כדי לחזור אחורה.", // In English: "Click to go back."
    "window_click_to_go_forward": "לחץ כדי ללכת קדימה.", // In English: "Click to go forward."
    "window_click_to_go_up": "לחץ כדי לעלות תיקיה אחת למעלה.", // In English: "Click to go one directory up."
    ...
    "window_folder_empty": "התיקיה הזו ריקה", // In English: "This folder is empty"
    "manage_your_subdomains": "נהל את תתי הדומיינים שלך", // In English: "Manage Your Subdomains"
    "open_containing_folder": "פתח תיקיה מכילה", // In English: "Open Containing Folder"
  },
};
