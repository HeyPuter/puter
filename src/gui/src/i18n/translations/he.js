...
const en = {
  ...
  dictionary: {
    ...
    confirm_code_generic_too_many_requests: 'יותר מדי בקשות. אנא המתינו מספר דקות.',
    ...
    confirm_delete_multiple_items: 'האם אתה בטוח שברצונך למחוק פריטים אלה לצמיתות?',
    confirm_delete_single_item: 'האם ברצונך למחוק פריט זה לצמיתות?',
    confirm_open_apps_log_out: 'יש לך אפליקציות פתוחות. האם אתה בטוח שברצונך להתנתק',
    ...
    contact_us: 'צור קשר',
    contact_us_verification_required: 'עליך להיות בעל כתובת אימייל מאומתת כדי להשתמש בזה.',
    contain: 'מכיל',
    continue: 'המשיך',
    copy: 'העתק',
    ...
    end_hard: 'נגמר קשה',
    end_process_force_confirm: 'האם אתה בטוח שאתה רוצה להפסיק בכוח את התהליך הזה?',
    end_soft: 'נגמר ברכות',
    enlarged_qr_code: 'קוד QR מוגדל',
    enter_password_to_confirm_delete_user: 'הזן את הסיסמה שלך כדי לאשר את מחיקת החשבון',
    error_message_is_missing: 'הודעת שגיאה חסרה.',
    error_unknown_cause: 'אירעה שגיאה לא ידועה.',
    error_uploading_files: 'העלאת קבצים נכשלה',
    favorites: 'מועדפים',
    feedback: 'משוב',
    feedback_c2a: 'אנא השתמש בטופס שלהלן כדי לשלוח לנו את המשוב, ההערות ודוחות הבאגים שלך.',
    ...
    no_websites_published: 'עדיין לא פרסמת אתרי אינטרנט. לחץ לחיצה ימנית על תיקיה כדי להתחיל.',
    ok: 'בסדר',
    open: 'פתח',
    ...
    password_recovery_unknown_error: 'אירעה שגיאה לא ידועה. נסה שוב מאוחר יותר.',
    ...
    save_session_c2a: 'צור חשבון כדי לשמור את ההפעלה הנוכחית שלך ולהימנע מאובדן העבודה שלך.',
 ...
 הקפד לאחסן אותם במקום בטוח.
    ...
    login2fa_recovery_instructions: 'הזן אחד מקודי השחזור שלך כדי לגשת לחשבון שלך.',
    ...
    'billing.sub_cancelled_but_valid_until':
      'ביטלתם את המנוי והוא אוטומתית יעבור למנוי חינמי בסוף תקופת החיוב. לא יתבצעו עוד חיובים אלא אם תשחזרו את המנוי', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
