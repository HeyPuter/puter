...
const bn = {
  ...
  dictionary: {
    ...
    confirm_delete_user: "আপনি কি নিশ্চিত যে আপনি আপনার অ্যাকাউন্টটি মুছতে চান? আপনার সমস্ত ফাইল এবং ডেটা স্থায়ীভাবে মুছে ফেলা হবে। এই প্রক্রিয়া শেষে আগের ডেটা আর ফিরে পাওয়া যাবে না।",
    ...
    item: "আইটেম",
    items_in_trash_cannot_be_renamed: `এই আইটেমটির নাম পরিবর্তন করা যাবে না কারণ এটি ট্র্যাশে রয়েছে। এই আইটেমটির নাম পরিবর্তন করতে, প্রথমে এটি ট্র্যাশ থেকে তুলে নিন।`,
    ...
    password_recovery_rate_limit: "আপনি আমাদের রিকভারি সিস্টেমে প্রতি দিনে অধিকতর পাঁচবার ব্যবহার করতে পারবেন না। দয়া করে কয়েক ঘণ্টা অপেক্ষা করুন এবং পুনরায় চেষ্টা করুন।",
    password_recovery_sent: "আপনার পাসওয়ার্ড পুনরুদ্ধারের জন্য নির্দেশানুযায়ী একটি ইমেল পাঠানো হয়েছে।",
    password_requirements: "পাসওয়ার্ড অবশ্যই অবশ্যই ৮ অক্ষরের বড় অক্ষর থাকতে হবে।",
  ...
  `,
    ...
    এই পুনরুদ্ধার কোডগুলি আপনার অ্যাকাউন্টে অ্যাক্সেস পাওয়ার একমাত্র উপায়। যদি আপনি আপনার ফোন হারিয়ে ফেলেন বা আপনার প্রামাণিকতা অ্যাপ ব্যবহার করতে না পারেন, তবে
