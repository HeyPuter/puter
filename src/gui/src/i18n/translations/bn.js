...
const bn = {
  ...
  dictionary: {
    ...
    cancel: "বাতিল করুন",
    center: "কেন্দ্র",
    change_desktop_background: "ডেস্কটপ পৃষ্ঠভূমি পরিবর্তন করুন…",
    ...
    clock_visible_auto: "অটো - ডিফল্ট, মুখ্যম্বর মোডে শুধুমাত্র দৃশ্যমান।",
    ...
    email: "ইমেল",
    email_change_confirmation_sent: "নতুন ইমেল ঠিকানা নিশ্চিতকরণের জন্য একটি নিশ্চিতকরণ ইমেল পাঠানো হয়েছে। আপনার ইনবক্স পরীক্ষা করুন এবং নির্দেশানুযায়ী প্রক্রিয়াটি সম্পন্ন করতে।",
    email_invalid: "ইমেল অবৈধ।",
    ...
    feedback_sent_confirmation: "আমাদের সাথে যোগাযোগ করার জন্য ধন্যবাদ। আপনার একাউন্টে ইমেল সংযোজন থাকলে আমরা যত তাড়াতাড়ি সম্ভব তাদের থেকে ফিরে পাবেন।",
    fit: "ফিট",
    folder: "ফোল্ডার",
    ...
    password_requirements: "পাসওয়ার্ড অবশ্যই অবশ্যই ৮ অক্ষরের বৃহত্তর হতে হবে।",
  ...
  `,
    ...
    "password_recovery_token_invalid": "এই পাসওয়ার্ড পুনরুদ্ধার টোকেনটি আর বৈধ নয়।", // In English: "This password recovery token is no longer valid."
    "password_recovery_unknown_error": "একটি অজানা ত্রুটি ঘটেছে। অনুগ্রহ করে পরে আবার চেষ্টা করুন।", // In English: "An unknown error occurred. Please try again later."
    "password_required": "পাসওয়ার্ড প্রয়োজন।", // In English: "Password is required."
    "password_strength_error": "পাসওয়ার্ড কমপক্ষে ৮ অক্ষরের হতে হবে এবং এতে অন্তত একটি বড় হাতের অক্ষর, একটি ছোট হাতের অক্ষর, একটি সংখ্যা এবং একটি বিশেষ অক্ষর থাকতে হবে।", // In English: "Password must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, one number, and one special character."
    "reading": "পড়া হচ্ছে %strong%", // In English: "Reading %strong%"
    "writing": "লেখা হচ্ছে %strong%", // In English: "Writing %strong%"
    "unzipping": "আনজিপ করা হচ্ছে %strong%", // In English: "Unzipping %strong%"
    "sequencing": "সিকোয়েন্সিং করা হচ্ছে %strong%", // In English: "Sequencing %strong%"
    "zipping": "জিপ করা হচ্ছে %strong%", // In English: "Zipping %strong%"
    "Editor": "সম্পাদক", // In English: "Editor"
    "Viewer": "দর্শক", // In English: "Viewer"
    "People with access": "অ্যাক্সেস সহ লোকেরা", // In English: "People with access"
    ...
    "This user already has access to this item": "এই ব্যবহারকারীর ইতিমধ্যেই এই আইটেমে অ্যাক্সেস রয়েছে" // In English: "This user already has access to this item"
