...
const bn = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'একটি অ্যাকাউন্ট তৈরি করুন এবং আপনার ইমেল ঠিকানা নিশ্চিত করুন যাতে ফ্রি ১ জিবি স্টোরেজ পান। আপনার বন্ধুও ১ জিবি ফ্রি স্টোরেজ পাবেন',
    confirm_code_generic_incorrect: 'কোডটি সঠিক নয় নিশ্চিত করুন।',
    confirm_code_generic_too_many_requests:
      'অনুরোধের সংখ্যা বেশি হয়েছে, দয়া করে পরে আবার চেষ্টা করুন।',
    ...
    confirm_code_2fa_instruction:
      'আপনার অথেন্টিকেশন অ্যাপ্লিকেশন থেকে ৬-ডিজিটের কোডটি প্রবেশ করুন।',
    ...
    confirm_delete_user:
      'আপনি কি নিশ্চিত যে আপনি আপনার অ্যাকাউন্টটি মুছতে চান? সমস্ত আপনার ফাইল এবং ডেটা স্থায়ীভাবে মুছে ফেলা হবে। এই ক্রিয়াটি ফিরে পাওয়া যাবে না।',
    ...
    email_change_confirmation_sent:
      'নতুন ই-মেইল ঠিকানা নিশ্চিতকরণের জন্য একটি নিশ্চিতকরণ ইমেল পাঠানো হয়েছে। আপনার ইনবক্স পরীক্ষা করুন এবং নির্দেশানুযায়ী প্রক্রিয়াটি সম্পন্ন করুন।',
    ...
    feedback_sent_confirmation:
      'আমাদের সাথে যোগাযোগ করার জন্য ধন্যবাদ। আপনার একাউন্টে ই-মেইল সংযোজন থাকলে আমরা যত তাড়াতাড়ি সম্ভব প্রতিক্রিয়া জানাবো',
    fit: 'ফিট',
    folder: 'ফোল্ডার',
    ...
    password_recovery_rate_limit:
      'আপনি আমাদের রেকভারি সিস্টেমে প্রতি দিনে অধিকতর পাঁচবার ব্যবহার করতে পারবেন না। দয়া করে কয়েক ঘণ্টা অপেক্ষা করুন এবং পুনরায় চেষ্টা করুন।',
    password_recovery_sent:
      'আপনার পাসওয়ার্ড পুনরুদ্ধারের জন্য নির্দেশানুযায়ী একটি ই-মেইল পাঠানো হয়েছে।',
    ...
    password_reset_request_expired:
      'আপনার পাসওয়ার্ড রিসেট রিকোয়েস্টের মেয়াদ শেষ হয়ে গেছে। দয়া করে পুনরায় চেষ্টা করুন।',
    password_reset_sent:
      'পাসওয়ার্ড রিসেট রিকোয়েস্ট সফলভাবে প্রেরিত হয়েছে। আপনার ইনবক্স দেখুন এবং নির্দেশানুযায়ী প্রক্রিয়াটি সম্পন্ন করুন।',
    ...
    refer_friends_c2a:
      'Puter তে অ্যাকাউন্ট তৈরি এবং নিশ্চিতকরণ করে ১ জিবি পান। আপনার বন্ধুও ১ জিবি পাবে!',
    ...
    save_session_c2a:
      'আপনার বর্তমান সেশনটি সংরক্ষণ করতে একটি অ্যাকাউন্ট তৈরি করুন যাতে আপনার কাজ হারাতে না হয়।',
    ...
    you_have_been_referred_to_puter_by_a_friend:
      'আপনাকে একটি বন্ধুর মাধ্যমে পিউটার-এ রেফার করা হয়েছে',
    zip: 'জিপ',
  ...
  `,
    ...
    password_strength_error:
      'পাসওয়ার্ড কমপক্ষে ৮ সংখার হতে হবে এবং এতে অন্তত একটি বড় হাতের অক্ষর, একটি ছোট হাতের অক্ষর, একটি সংখ্যা, এবং একটি বিশেষ অক্ষর থাকতে হবে।',
    reading: 'পড়া হচ্ছে',
    writing: 'লেখা হচ্ছে',
    ...
    'billing.subscription_cancelled_description':
      'এই বিলিং পিরিয়ডের শেষ পর্যন্ত আপনি আপনার সাবস্ক্রিপশনটি ব্যবহার করতে পারবেন।',
    ...
    'billing.subscription_check_error':
      'আপনার সাবস্ক্রিপশন স্ট্যাটাস চেক করার সময় একটি সমস্যা দেখা দিয়েছে।',
    'billing.email_confirmation_needed':
      'আপনার ইমেল নিশ্চিত করা হয়নি। আমরা এখনই এটি নিশ্চিত করার জন্য একটি কোড পাঠাব।',
    'billing.sub_cancelled_but_valid_until':
      'আপনি আপনার সাবস্ক্রিপশন বাতিল করেছেন এবং এটি বিলিং পিরিয়ডের শেষে স্বয়ংক্রিয়ভাবে ফ্রি স্তরে পরিবর্তিত হবে। আপনি পুনরায় সাবস্ক্রাইব না করা পর্যন্ত আর চার্জ হবে না।',
    'billing.current_plan_until_end_of_period':
      'এই বিলিং পিরিয়ডের শেষ পর্যন্ত আপনার বর্তমান প্ল্যান।',
