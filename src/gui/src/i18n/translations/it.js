...
const it = {
    ...
    dictionary: {
		...
		// ***********************************
        "change": "Cambiamento", // In English: "Change"
        "clock_visibility": "Visibilità dell'orologio", // In English: "Clock Visibility"
        "reading": "Lettura %strong%", // In English: "Reading %strong%"
        "writing": "Scrittura %strong%", // In English: "Writing %strong%"
        "unzipping": "Decompressione %strong%", // In English: "Unzipping %strong%"
        "sequencing": "Sequenziamento %strong%", // In English: "Sequencing %strong%"
        "zipping": "Compressione %strong%", // In English: "Zipping %strong%"
        ...
        "This user already has access to this item": "Questo utente ha già accesso a questo elemento.", // In English: "This user already has access to this item"
    }
};
