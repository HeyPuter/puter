...
const it = {
  ...
  dictionary: {
    ...
    'billing.subscription_cancelled_description':
      'Avrai ancora accesso al tuo abbonamento fino alla fine di questo periodo di fatturazione.',
    ...
    'billing.subscription_cancellation_confirmation':
      'Sei sicuro di voler annullare il tuo abbonamento?', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.subscription_check_error':
      "Si è verificato un problema durante il controllo dello stato dell'abbonamento.",
    // In English: "A problem occurred while checking your subscription status."
    'billing.email_confirmation_needed':
      'La tua email non è stata confermata. Ti invieremo un codice per completare la conferma.',
    ...
    'billing.sub_cancelled_but_valid_until':
      'Hai annullato il tuo abbonamento. Passerà automaticamente al piano gratuito alla fine del periodo di fatturazione. Non ti verrà addebitato nuovamente a meno che non ti iscrivi di nuovo.',
    ...
    'billing.current_plan_until_end_of_period':
      'Il tuo piano attuale è valido fino alla fine del periodo di fatturazione.',
