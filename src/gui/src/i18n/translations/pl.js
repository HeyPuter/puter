...
const pl = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Stwórz konto i potwierdź swój adres e-mail, żeby dostać 1 GB darmowego miejsca. Twój znajomy również dostanie 1 GB darmowego miejsca.',
    ...
    confirm_delete_user:
      'Czy jesteś pewien że chcesz skasować swoje konto? Wszystkie twoje pliki i dane zostaną trwale skasowane. Tej czynności nie da się cofnąć.',
    ...
    email_change_confirmation_sent:
      'Email z potwierdzeniem został wysłany na twój adres. Sprawdź swoją skrzynkę mailową i wykonaj przesłane instrukcje aby zakończyć proces.',
    ...
    feedback: 'Opinie',
    feedback_c2a:
      'Prosimy, aby użyć poniższego formularza do zwracania opinii, komentarzy i zgłaszania błędów.',
    feedback_sent_confirmation:
      'Dziękujemy za kontakt. Jeżeli z twoim kontem powiązany jest adres email, skontaktujemy się z tobą tak szybko jak to możliwe.',
    fit: 'Dopasuj',
    folder: 'Folder',
    ...
    password_recovery_rate_limit:
      'Osiągnąłeś limit szybkości powtórzeń; poczekaj kilka minut. Aby zapobiec temu w przyszłości, unikaj wielokrotnego przeładowywania strony.',
    ...
    password_strength_error:
      'Hasło musi mieć co najmniej 8 znaków i musi zawierać co najmniej jedną dużą literę, małą literę, cyfrę i znak specjalny.',
    ...
    refer_friends_c2a:
      'Zdobądź 1 GB za każdego znajomego, który założy konto na Puter! On również otrzyma 1 GB.',
    ...
    login2fa_recovery_instructions:
      'Wprowadź jeden ze swoich kodów odzyskiwania aby uzyskać dostęp do swojego konta.',
    ...
    'billing.subscription_cancelled_description':
      'Dostęp do Twojej subskrypcji będzie możliwy do końca tego okresu rozliczeniowego.',
    ...
    'billing.subscription_check_error':
      'Wystąpił błąd podczas sprawdzania stanu Twojej subskrypcji.',
    'billing.email_confirmation_needed':
      'Twój adres e-mail nie został potwierdzony. Wyślemy Ci kod, aby potwierdzić go teraz.',
    'billing.sub_cancelled_but_valid_until':
      'Twoja subskrypcja została anulowana i po zakończeniu okresu rozliczeniowego zostanie automatycznie zmieniona na plan darmowy. Opłata nie zostanie naliczona ponownie, dopóki nie dokonasz ponownej subskrypcji.',
    'billing.current_plan_until_end_of_period':
      'Twój obecny plan do końca tego okresu rozliczeniowego.',
