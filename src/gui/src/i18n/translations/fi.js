...
const fi = {
  ...
  dictionary: {
    ...
    'This user already has access to this item': 'Tällä käyttäjällä on jo pääsy tähän kohteeseen', // In English: "This user already has access to this item"
    ...
    'billing.subscription_cancelled_description':
      'Voit jatkaa tilauksesi käyttöä laskutuskauden loppuun asti.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.email_confirmation_needed':
      'Sähköpostiosoitettasi ei ole vahvistettu. Lähetämme sinulle vahvistuskoodin nyt.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'Olet peruuttanut tilauksesi, ja se vaihtuu automaattisesti ilmaiseen tasoon laskutuskauden lopussa. Sinulta ei veloiteta enää, ellet päätä uusia tilaustasi.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'Nykyinen suunnitelmasi on voimassa tämän laskutuskauden loppuun asti.', // In English: "Your current plan until the end of this billing period."
