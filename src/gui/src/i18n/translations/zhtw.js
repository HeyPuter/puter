...
const zhtw = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      '建立帳戶並確認您的電子郵件地址，即可獲得 1 GB 的免費儲存空間。您的朋友也會獲得 1 GB 的免費儲存空間。',
    ...
    email_change_confirmation_sent:
      '確認電子郵件已發送到您的新電子郵件地址。請查看您的收件匣並按照指示完成此過程。',
    ...
    refer_friends_c2a:
      '每邀請一位朋友在 Puter 上建立並確認帳戶，您就可獲得 1 GB 空間。您的朋友也會獲得 1 GB！',
    ...
    'billing.sub_cancelled_but_valid_until':
      '您已取消訂閱，訂閱將在計費週期結束後自動轉為免費方案。除非重新訂閱，否則不會再次收費。', // You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe.
