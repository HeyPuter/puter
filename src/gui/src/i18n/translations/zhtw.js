...
const zhtw = {
    ...
    dictionary: {
        ...
        "create_desktop_shortcut": 建立桌面捷徑, // In English: "Create Shortcut (Desktop)"
        "create_desktop_shortcut_s": 建立桌面捷徑, // In English: "Create Shortcuts (Desktop)"
        "create_shortcut_s": 建立捷徑, // In English: "Create Shortcuts"
        "minimize": 最小化, // In English: "Minimize"
        "reload_app": 重新載入應用程式, // In English: "Reload App"
        "new_window": 新視窗, // In English: "New Window"
        "open_trash": 開啟回收桶, // In English: "Open Trash"
        "pick_name_for_worker": 為您的 Worker 選擇名稱：, // In English: "Pick a name for your worker:"
        ...
        "used_of": 已使用 {{used}}，總共 {{available}}, // In English: "{{used}} used of {{available}}"
        "worker": Worker, // In English: "Worker"
        "billing.offering.basic": 基本方案, // In English: "Basic"
        "too_many_attempts": 嘗試次數過多。請稍後再試。, // In English: "Too many attempts. Please try again later."
        "server_timeout": 伺服器回應超時。請稍後再試。, // In English: "The server took too long to respond. Please try again."
        "signup_error": 註冊過程中發生錯誤。, // In English: "An error occurred during signup. Please try again."
        "welcome_title": 歡迎使用您的個人互聯網電腦, // In English: "Welcome to your Personal Internet Computer"
        "welcome_description": 儲存檔案、玩遊戲、尋找優秀應用程式，還有更多功能！一站式管理，隨時隨地可存取。, // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
        "welcome_get_started": 開始使用, // In English: "Get Started"
        "welcome_terms": 使用條款, // In English: "Terms"
        "welcome_privacy": 隱私權, // In English: "Privacy"
        "welcome_developers": 開發者, // In English: "Developers"
        "welcome_open_source": 開放原始碼, // In English: "Open Source"
        ...
        "window_title_change_password": 更改密碼, // In English: "Change Password"
        ...
        "window_title_authenticating": 驗證中..., // In English: "Authenticating..."
        "window_title_refer_friend": 推薦朋友！, // In English: "Refer a friend!"
        ...
        "item_shared_by_you": 您已與至少一位其他使用者分享了此項目。, // In English: "You have shared this item with at least one other user."
        "item_shortcut": 捷徑, // In English: "Shortcut"
        "item_associated_websites": 相關網站, // In English: "Associated website"
        "item_associated_websites_plural": 相關網站, // In English: "Associated websites"
        "no_suitable_apps_found": 找不到合適的應用程式, // In English: "No suitable apps found"
        "window_click_to_go_back": 點擊返回。, // In English: "Click to go back."
        "window_click_to_go_forward": 點擊前進。, // In English: "Click to go forward."
        "window_click_to_go_up": 點擊上移一個資料夾。, // In English: "Click to go one directory up."
        ...
        "window_folder_empty": 此資料夾為空, // In English: "This folder is empty"
        "manage_your_subdomains": 管理您的子網域, // In English: "Manage Your Subdomains"
        "open_containing_folder": 開啟包含資料夾, // In English: "Open Containing Folder"
    }
};
