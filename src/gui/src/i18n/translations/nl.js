...
const nl = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Maak een account aan en bevestig uw e-mailadres om 1 GB gratis opslag te ontvangen. Uw vriend krijgt ook 1 GB gratis opslag.',
    ...
    confirm_delete_user:
      'Weet u zeker dat u uw account wilt verwijderen? Al uw bestanden en gegevens worden permanent verwijderd. Deze actie kan niet ongedaan worden gemaakt.',
    ...
    contact_us_verification_required:
      'U moet een geverifieerd e-mailadres hebben om dit te gebruiken.',
    contain: 'Bevatten',
    continue: 'Doorgaan',
    copy: 'Kopiëren',
    ...
    email_change_confirmation_sent:
      'Er is een bevestigingsmail gestuurd naar uw nieuwe e-mailadres. Controleer uw inbox en volg de instructies om het proces te voltooien.',
    ...
    enter_password_to_confirm_delete_user:
      'Voer uw wachtwoord in om de verwijdering van het account te bevestigen',
    ...
    feedback: 'Feedback',
    feedback_c2a:
      'Gebruik het onderstaande formulier om ons uw feedback, opmerkingen en bugrapporten te sturen.',
    feedback_sent_confirmation:
      'Bedankt dat u contact met ons heeft opgenomen. Als u een e-mail heeft gekoppeld aan uw account, hoort u zo snel mogelijk van ons.',
    fit: 'Aanpassen',
    folder: 'Map',
    ...
    no_websites_published:
      'Je hebt nog geen websites gepubliceerd. Klik met de rechtermuisknop op een map om te beginnen.',
    ok: 'OK',
    open: 'Openen',
    ...
    password_recovery_rate_limit:
      'U heeft te veel verzoeken ingediend. Wacht een paar minuten voordat u het opnieuw probeert.',
    password_recovery_token_invalid: 'Wachtwoord hersteltoken is verlopen of ongeldig.',
    password_recovery_unknown_error:
      'Onbekende fout opgetreden bij het herstellen van het wachtwoord. Probeer het opnieuw.',
    ...
    refer_friends_c2a:
      'Krijg 1 GB voor elke vriend die een account aanmaakt en bevestigt op Puter. Je vriend krijgt ook 1 GB!',
    ...
    save_session_c2a:
      'Maak een account aan om je huidige sessie op te slaan en verlies van werk te voorkomen.',
    ...
    login2fa_recovery_instructions:
      'Voer een van je herstelcodes in om toegang te krijgen tot je account.',
    ...
    'billing.subscription_cancelled_description':
      'U behoudt toegang tot uw abonnement tot het einde van deze factureringsperiode.', // In English: 'You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'Bent u zeker dat u uw abonnement wilt stopzetten?', // In English: 'Are you sure you want to cancel your subscription?"
    ...
    'billing.subscription_check_error':
      'Er is een probleem opgetreden bij het controleren van uw abonnementsstatus.', // In English: 'A problem occurred while checking your subscription status."
    'billing.email_confirmation_needed':
      'Uw e-mail is nog niet bevestigd. We zullen u een code sturen om het te bevestigen.', // In English: 'Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'U hebt uw abonnement stopgezet en het zal automatisch overschakelen naar het gratis abonnement op het einde van deze factureringsperiode. Er worden geen kosten in rekening gebracht, tenzij u opnieuw abonneert.', // In English: 'You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'Uw huidige abonnement tot het einde van deze factureringsperiode.', // In English: 'Your current plan until the end of this billing period."
