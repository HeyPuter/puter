...
const nl = {
	...
	dictionary: {
		...
		"writing": 'Schrijven', // In English: "Writing %strong%"
		"unzipping": 'Decomprimeren', // In English: "Unzipping %strong%"
		"sequencing": 'Alles op een rijtje aan het zetten', // In English: "Sequencing %strong%"
		"zipping": 'Aan het comprimeren', // In English: "Zipping %strong%"
