...
const br = {
  ...
  dictionary: {
    ...
    "toolbar.qrcode": "Codigo QR", // In English: "QR Code"
    "used_of": "{{used}} utilizado de {{available}} disponivel", // In English: "{{used}} used of {{available}}"
    ...
    "server_timeout": "O sevidor demorou muito em responder. Por Favor tente novamente mais tarde.", // In English: "The server took too long to respond. Please try again."
    "signup_error": "Um erro ocorreu durante durante o registro, Por Favor tente novamente mais tarde.", // In English: "An error occurred during signup. Please try again."
    "welcome_title": "Bem vindo(a) para seu Computador Pessoal de Internet", // In English: "Welcome to your Personal Internet Computer"
    "welcome_description": "Armazenar arquivos, jogar jogos, encontrar apps incriveis, e muito mais! Tudo em um só lugar, acessível de qualquer lugar a qualquer momento.", // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
    ...
    "welcome_open_source": "Codigo aberto", // In English: "Open Source"
    "welcome_instant_login_title": "Inicio de Sessão Instantaneo", // In English: "Instant Login!"
    ...
    "login_email_username_required": "Email ou nome de usuario é obrigatorio", // In English: "Email or username is required"
    "login_password_required": "Senha é obrigatoria", // In English: "Password is required"
    ...
    "window_title_instant_login": "Inicio de Sessão Instantaneo", // In English: "Instant Login!"
    "window_title_publish_website": "Publicar Website", // In English: "Publish Website"
    ...
    "item_shared_with_you": "Um usuario compartilhou este item com você.", // In English: "A user has shared this item with you."
    "item_shared_by_you": "Você compartilhou este item com pelo menos um usuario.", // In English: "You have shared this item with at least one other user."
    "item_shortcut": "Atalho", // In English: "Shortcut"
    "item_associated_websites": "Website associado", // In English: "Associated website"
    "item_associated_websites_plural": "Websites associados", // In English: "Associated websites"
    "no_suitable_apps_found": "Nenhuma app adecuada encontrada", // In English: "No suitable apps found"
    "window_click_to_go_back": "Click para retornar.", // In English: "Click to go back."
    "window_click_to_go_forward": "Click para avanzar.", // In English: "Click to go forward."
    "window_click_to_go_up": "Click para subir um diretório.", // In English: "Click to go one directory up."
    "window_title_public": "Publico", // In English: "Public"
    ...
    "window_folder_empty": "Esta pasta esta vazia", // In English: "This folder is empty"
    "manage_your_subdomains": "Gerencair seus subdomíos", // In English: "Manage Your Subdomains"
