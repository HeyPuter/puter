...
const br = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Crie uma conta e confirme seu endereço de e-mail para receber 1 GB de armazenamento gratuito. Seu amigo também receberá 1 GB de armazenamento gratuito.',
    ...
    confirm_delete_user:
      'Tem certeza de que deseja excluir sua conta? Todos os seus arquivos e dados serão permanentemente excluídos. Esta ação não pode ser desfeita.',
    ...
    contact_us_verification_required:
      'Você deve ter um endereço de e-mail verificado para usar isto.',
    contain: 'Conter',
    continue: 'Continuar',
    copy: 'Copiar',
    ...
    email_change_confirmation_sent:
      'Um e-mail de confirmação foi enviado para seu novo endereço de e-mail. Por favor, verifique sua caixa de entrada e siga as instruções para concluir o processo.',
    ...
    feedback: 'Feedback',
    feedback_c2a:
      'Por favor, use o formulário abaixo para nos enviar seu feedback, comentários e relatórios de bugs.',
    feedback_sent_confirmation:
      'Obrigado por nos contatar. Se você tiver um e-mail associado à sua conta, você receberá uma resposta nossa o mais rápido possível.',
    fit: 'Ajustar',
    folder: 'Pasta',
    ...
    password_recovery_rate_limit:
      'Você atingiu nosso limite de tentativas; por favor, aguarde alguns minutos. Para evitar isso no futuro, evite recarregar a página muitas vezes.',
    ...
    puter_description:
      'Puter é uma nuvem pessoal que prioriza a privacidade para manter todos os seus arquivos, aplicativos e jogos em um lugar seguro, acessível de qualquer lugar a qualquer momento.',
    reading_file: 'Lendo %strong%',
    recent: 'Recente',
    recommended: 'Recomendado',
    recover_password: 'Recuperar Senha',
    refer_friends_c2a:
      'Ganhe 1 GB para cada amigo que criar e confirmar uma conta no Puter. Seu amigo também ganhará 1 GB!',
    ...
    scan_qr_c2a:
      'Escaneie o código abaixo para fazer login nesta sessão a partir de outros dispositivos',
    ...
    taking_longer_than_usual:
      'Levando um pouco mais de tempo do que o normal. Por favor, aguarde...',
    ...
    tos_fineprint:
      "Ao clicar em 'Criar Conta Gratuita' você concorda com os {{link=terms}}Termos de Serviço{{/link}} e a {{link=privacy}}Política de Privacidade{{/link}} do Puter.",
    ...
    'billing.subscription_cancelled_description':
      'Você ainda terá acesso a sua assinatura até finalizar o período pago', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'Você tem certeza que quer cancelar sua assinatura ?', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.subscription_check_error':
      'Ocorreu um problema ao verificar o status da sua assinatura.', // In English: "A problem occurred while checking your subscription status."
    'billing.email_confirmation_needed':
      'Seu e-mail não foi confirmado. Enviaremos um código para confirmá-lo agora.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'Você cancelou sua assinatura e ela será automaticamente revertida para o plano gratuito no final do período de cobrança. Você não será cobrado novamente, a menos que reative a assinatura.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'Seu plano atual até o final deste período de cobrança.', // In English: "Your current plan until the end of this billing period."
