...
const es = {
  ...
  dictionary: {
    ...
    "pick_name_for_worker": 'Elije un nombre para tu Worker:', // In English: "Pick a name for your worker:"
    ...
    "too_many_attempts": 'Demasiados intentos. Por favor intente más tarde', // In English: "Too many attempts. Please try again later."
    "server_timeout": 'El servidor ha tardado mucho en reponder. Intente nuevamente', // In English: "The server took too long to respond. Please try again."
    "signup_error": 'Ocurrrió un error durante el registro. Intente nuevamente', // In English: "An error occurred during signup. Please try again."
    "welcome_title": 'Bienvenido a tu Computadora Personal de Internet', // In English: "Welcome to your Personal Internet Computer"
    "welcome_description": '¡Guarda archivos, juega, encuentra apps increíbles y mucho más! Todo en un solo lugar, accesible en cualquier momento y lugar', // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
    ...
    "item_associated_websites": 'Sitio web Asocioado', // In English: "Associated website"
    "item_associated_websites_plural": 'Sitios web Asocioados', // In English: "Associated websites"
    "no_suitable_apps_found": 'No se econtraron aplicaciones adecuadas', // In English: "No suitable apps found"
