...
const hy = {
  ...
  dictionary: {
    ...
    choose_publishing_option:
      "Ընտրեք, թե ինչպես եք ցանկանում հրապարակել ձեր կայքը՝",
    create_desktop_shortcut: "Ստեղծել դասավորության մուտք (աշխատասեղան)",
    create_desktop_shortcut_s: "Ստեղծել դասավորության մուտքեր (աշխատասեղան)",
    create_shortcut_s: "Ստեղծել դասավորության մուտքեր",
    minimize: "Փոքրացնել",
    reload_app: "Վերաբեռնել հավելվածը",
    new_window: "Նոր պատուհան",
    open_trash: "Բացել աղբամանը",
    pick_name_for_worker: "Ընտրեք ձեր worker-ի համար անուն՝",
    publish_as_serverless_worker: "Հրապարակել որպես Worker",
    "toolbar.enter_fullscreen": "Մուտք լիացածածան ռեժիմ",
    "toolbar.github": "GitHub",
    "toolbar.refer": "Ուղղորդել",
    "toolbar.save_account": "Պահպանել հաշիվը",
    "toolbar.search": "Որոնում",
    "toolbar.qrcode": "QR կոդ",
    used_of: "{{used}} օգտագործված է {{available}}-ից",
    worker: "Worker",
    "billing.offering.basic": "Հիմնարար",
    too_many_attempts:
      "Չափազանց շատ փորձեր: Խնդրում ենք կրկին փորձել ավելի ուշ:",
    server_timeout: "Սերվերը չարձագանքեց ժամանակին: Խնդրում ենք կրկին փորձել:",
    signup_error:
      "Գրանցման ընթացքում սխալ տեղի ունեցավ: Խնդրում ենք կրկին փորձել:",
    welcome_title: "Բարի գալուստ ձեր անձնական ինտերնետ համակարգչին",
    welcome_description:
      "Պահպանեք ֆայլեր, խաղացեք խաղեր, գտեք հիանալի հավելվածներ և շատ ավելին՝ ամեն ինչ մեկ տեղում, հասանելի ցանկացած տեղից և ցանկացած ժամանակ:",
    welcome_get_started: "Սկսել",
    welcome_terms: "Պայմաններ",
    welcome_privacy: "Գաղտնիություն",
    welcome_developers: "Ծրագրավորողներ",
    welcome_open_source: "Բաց կոդով",
    welcome_instant_login_title: "Անմիջական մուտք!",
    alert_error_title: "Սխալ!",
    alert_warning_title: "Զգուշացում!",
    alert_info_title: "Տեղեկություն",
    alert_success_title: "Հաջողություն!",
    alert_confirm_title: "Վստա՞հ եք:",
    alert_yes: "Այո",
    alert_no: "Ոչ",
    alert_retry: "Կրկին փորձել",
    alert_cancel: "Չեղարկել",
    signup_confirm_password: "Հաստատել գաղտնաբառը",
    ...
    window_title_session_list: "Սեսիաների ցուցակ!",
    window_title_set_new_password: "Սահմանել նոր գաղտնաբառ",
    window_title_instant_login: "Անմիջական մուտք!",
    window_title_publish_website: "Հրապարակել կայքը",
    window_title_publish_worker: "Հրապարակել Worker-ը",
    window_title_authenticating: "Ինքնության ստուգում...",
    window_title_refer_friend: "Ուղղորդել ընկերոջը!",
    desktop_show_desktop: "Ցույց տալ աշխատասեղանը",
    desktop_show_open_windows: "Ցույց տալ բաց պատուհանները",
    desktop_exit_full_screen: "Դուրս գալ լիացածածան ռեժիմից",
    desktop_enter_full_screen: "Մուտք գործել լիացածածան ռեժիմ",
    ...
    item_shortcut: "Դասավորության մուտք",
    item_associated_websites: "Կապված կայք",
    item_associated_websites_plural: "Կապված կայքեր",
    no_suitable_apps_found: "Համապատասխան հավելվածներ չեն գտնվել",
    window_click_to_go_back: "Սեղմեք՝ ետ գնալու համար:",
    window_click_to_go_forward: "Սեղմեք՝ առաջ գնալու համար:",
    window_click_to_go_up: "Սեղմեք՝ մեկ թղթապանակ վեր գնալու համար:",
    window_title_public: "Հանրային",
    window_title_videos: "Տեսանյութեր",
    window_title_pictures: "Նկարներ",
    window_title_puter: "Puter",
    window_folder_empty: "Այս թղթապանակը դատարկ է",
    manage_your_subdomains: "Կառավարել ձեր ենթատիրույթները",
    open_containing_folder: "Բացել պարունակող թղթապանակը",
  },
};
