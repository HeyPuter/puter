...
const ml = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      '1 GB സൗജന്യ സ്റ്റോറേജ് ലഭിക്കാൻ ഒരു അക്കൗണ്ട് സൃഷ്ടിച്ച് നിങ്ങളുടെ ഇമെയിൽ സ്ഥിരീകരിക്കുക. നിങ്ങളുടെ സുഹൃത്തിനും 1 GB സൗജന്യ സ്റ്റോറേജ് ലഭിക്കും.',
    confirm_code_generic_incorrect: 'തെറ്റായ കോഡ്.',
    confirm_code_generic_too_many_requests:
      'വളരെയധികം അഭ്യർത്ഥനകൾ. കുറച്ച് മിനിറ്റുകൾ കാത്തിരിക്കുക.',
    ...
    confirm_delete_user:
      'നിങ്ങളുടെ അക്കൗണ്ട് ഇല്ലാതാക്കണമെന്ന് തീർച്ചയാണോ? നിങ്ങളുടെ എല്ലാ ഫയലുകളും ഡാറ്റയും സ്ഥിരമായി ഇല്ലാതാക്കപ്പെടും. ഈ പ്രവർത്തി പിന്നീട് പഴയപടിയാക്കാൻ കഴിയില്ല.',
    ...
    contact_us_verification_required:
      'ഇത് ഉപയോഗിക്കാൻ നിങ്ങൾക്ക് സ്ഥിരീകരിച്ച ഇമെയിൽ വിലാസം ഉണ്ടായിരിക്കണം.',
    contain: 'ഉൾക്കൊള്ളുക',
    continue: 'തുടരുക',
    copy: 'പകർത്തുക',
    ...
    email_change_confirmation_sent:
      'നിങ്ങളുടെ പുതിയ ഇമെയിൽ വിലാസത്തിലേക്ക് ഒരു സ്ഥിരീകരണ ഇമെയിൽ അയച്ചിട്ടുണ്ട്. ദയവായി നിങ്ങളുടെ ഇൻബോ',
    ...
    enter_password_to_confirm_delete_user:
      'അക്കൗണ്ട് ഇല്ലാതാക്കൽ സ്ഥിരീകരിക്കാൻ നിങ്ങളുടെ പാസ്‌വേഡ് നൽകുക',
    ...
    feedback: 'പ്രതികരണം',
    feedback_c2a:
      'നിങ്ങളുടെ പ്രതികരണം, അഭിപ്രായങ്ങൾ, ബഗ് റിപ്പോർട്ടുകൾ എന്നിവ അയയ്ക്കാൻ താഴെയുള്ള ഫോം ഉപയോഗിക്കുക.',
    feedback_sent_confirmation:
      'ഞങ്ങളെ ബന്ധപ്പെട്ടതിന് നന്ദി. നിങ്ങളുടെ അക്കൗണ്ടുമായി ബന്ധപ്പെട്ട ഒരു ഇമെയിൽ ഉണ്ടെങ്കിൽ, കഴിയുന്നത്ര വേഗം നിങ്ങൾക്ക് മറുപടി ലഭിക്കും.',
    fit: 'ഫിറ്റ്',
    folder: 'ഫോൾഡർ',
    ...
    no_websites_published:
      'നിങ്ങൾ ഇതുവരെ വെബ്സൈറ്റുകളൊന്നും പ്രസിദ്ധീകരിച്ചിട്ടില്ല. ആരംഭിക്കാൻ ഒരു ഫോൾഡറിൽ റൈറ്റ് ക്ലിക്ക് ചെയ്യുക.',
    ok: 'ശരി',
    open: 'തുറക്കുക',
    ...
    password_recovery_rate_limit:
      'നിങ്ങൾ പരിധി കവിഞ്ഞു; ദയവായി കുറച്ച് മിനിറ്റുകൾ കാത്തിരിക്കുക. ഭാവിയിൽ ഇത് ഒഴിവാക്കാൻ, പേജ് വളരെയധികം തവണ റീലോഡ് ചെയ്യുന്നത് ഒഴിവാക്കുക.',
    password_recovery_token_invalid: 'ഈ പാസ്‌വേഡ് റിക്കവറി ടോക്കൺ ഇനി സാധുവല്ല.',
    password_recovery_unknown_error:
      'അജ്ഞാതമായ ഒരു പിശക് സംഭവിച്ചു. ദയവായി പിന്നീട് വീണ്ടും ശ്രമിക്കുക.',
    password_required: 'പാസ്‌വേഡ് ആവശ്യമാണ്.',
    password_strength_error:
      'പാസ്‌വേഡിൽ കുറഞ്ഞത് 8 അക്ഷരങ്ങൾ, ഒരു അപ്പർകേസ് അക്ഷരം, ഒരു ലോവർകേസ് അക്ഷരം, ഒരു അക്കം, ഒരു പ്രത്യേക അക്ഷരം എന്നിവ ഉണ്ടായിരിക്കണം.',
    passwords_do_not_match:
      '`പുതിയ പാസ്‌വേഡ്` ഉം `പുതിയ പാസ്‌വേഡ് സ്ഥിരീകരിക്കുക` യും പൊരുത്തപ്പെടുന്നില്ല.',
    paste: 'പേസ്റ്റ്',
    ...
    refer_friends_c2a:
      'അക്കൗണ്ട് സൃഷ്ടിച്ച് സ്ഥിരീകരിക്കുന്ന ഓരോ സുഹൃത്തിനും 1 GB നേടുക. നിങ്ങളുടെ സുഹൃത്തിനും 1 GB ലഭിക്കും!',
    ...
    save_session_c2a:
      'നിങ്ങളുടെ നിലവിലെ സെഷൻ സംരക്ഷിക്കാനും ജോലി നഷ്ടപ്പെടുന്നത് ഒഴിവാക്കാനും ഒരു അക്കൗണ്ട് സൃഷ്ടിക്കുക.',
    scan_qr_c2a:
      'മറ്റ് ഉപകരണങ്ങളിൽ നിന്ന് ഈ സെഷനിലേക്ക് ലോഗിൻ ചെയ്യാൻ\nതാഴെയുള്ള കോഡ് സ്കാൻ ചെയ്യുക',
    ...
    type_confirm_to_delete_account:
      "നിങ്ങളുടെ അക്കൗണ്ട് ഇല്ലാതാക്കാൻ 'confirm' എന്ന് ടൈപ്പ് ചെയ്യുക.",
    ...
    you_have_been_referred_to_puter_by_a_friend:
      'ഒരു സുഹൃത്ത് നിങ്ങളെ പ്യൂട്ടറിലേക്ക് റഫർ ചെയ്തിരിക്കുന്നു!',
    zip: 'സിപ്പ്',
    ...
    login2fa_recovery_instructions:
      'നിങ്ങളുടെ അക്കൗണ്ടിൽ ആക്സസ് നേടാൻ നിങ്ങളുടെ ഒരു റിക്കവറി കോഡ് നൽകുക.',
    ...
    'billing.subscription_cancelled_description':
      'ഈ ബില്ലിംഗ് കാലാവധിയുടെ അവസാനം വരെ നിങ്ങൾക്ക് നിങ്ങളുടെ സബ്സ്ക്രിപ്ഷൻ ആക്സസ് ലഭിക്കും.',
    ...
    'billing.subscription_cancellation_confirmation':
      'നിങ്ങളുടെ സബ്സ്ക്രിപ്ഷൻ റദ്ദാക്കാൻ നിങ്ങൾക്കു താൽപ്പര്യമുണ്ടോ?',
    ...
    'billing.subscription_check_error':
      'നിങ്ങളുടെ സബ്സ്ക്രിപ്ഷൻ നില പരിശോധിക്കുമ്പോൾ പ്രശ്നം ഉണ്ടായി.',
    'billing.payment_method_updated': 'പേയ്‌മെന്റ് രീതി അപ്ഡേറ്റ് ചെയ്തു!',
    'billing.email_confirmation_needed':
      'നിങ്ങളുടെ ഇമെയിൽ സ്ഥിരീകരിച്ചിട്ടില്ല. ഇത് സ്ഥിരീകരിക്കാൻ ഞങ്ങൾ നിങ്ങൾക്ക് ഒരു കോഡ് അയയ്ക്കും.',
    'billing.sub_cancelled_but_valid_until':
      'നിങ്ങൾ നിങ്ങളുടെ സബ്സ്ക്രിപ്ഷൻ റദ്ദാക്കി. ഇത് ബില്ലിംഗ് കാലാവധിയുടെ അവസാനം ഫ്രീ ടിയറിലേക്ക് സ്വിച്ച് ചെയ്യും. നിങ്ങൾ വീണ്ടും സബ്സ്ക്രൈബ് ചെയ്യാതെ വീണ്ടും ചാർജ് ചെയ്യില്ല.',
    'billing.current_plan_until_end_of_period':
      'ഈ ബില്ലിംഗ് കാലാവധിയുടെ അവസാനം വരെ നിങ്ങളുടെ നിലവിലെ പ്ലാൻ.',
