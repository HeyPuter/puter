...
const ru = {
  ...
  dictionary: {
    ...
    "toolbar.refer": 'ссылаться', // In English: "Refer"
    ...
    "too_many_attempts": 'Опубликовать как воркер', // In English: "Too many attempts. Please try again later."
    ...
    "welcome_privacy": 'Уединение', // In English: "Privacy"
    ...
    "login_email_username_required": 'Требуется электронной почты или имя пользователя', // In English: "Email or username is required"
    ...
    "window_title_refer_friend": 'Cсылаться друга!', // In English: "Refer a friend!"
    ...
    "desktop_position_bottom": 'Низ', // In English: "Bottom"
