...
const fr = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Créez un compte et confirmez votre adresse e-mail pour recevoir 1 Go de stockage gratuit. Votre ami bénéficiera également de 1 Go de stockage gratuit.',
    confirm_code_generic_incorrect: 'Code incorrect.',
    confirm_code_generic_too_many_requests:
      'Trop de demandes. Veuillez patienter quelques minutes.',
    ...
    confirm_open_apps_log_out:
      'Vous avez des applications ouvertes. Êtes-vous sûr de vouloir vous déconnecter ?',
    confirm_new_password: 'Confirmer le nouveau mot de passe',
    confirm_delete_user:
      'Êtes-vous sûr de vouloir supprimer votre compte ? Tous vos fichiers et données seront définitivement supprimés. Cette action est irréversible.',
    ...
    contact_us_verification_required:
      "Vous devez disposer d'une adresse e-mail vérifiée pour pouvoir utiliser ceci.",
    contain: 'Contenir',
    continue: 'Continuer',
    copy: 'Copier',
    ...
    email_change_confirmation_sent:
      'Un e-mail de confirmation a été envoyé à votre nouvelle adresse e-mail. Veuillez vérifier votre boîte de réception et suivre les instructions pour terminer le processus.',
    ...
    enter_password_to_confirm_delete_user:
      'Entrez votre mot passe pour confirmer la supression du compte',
    ...
    feedback_c2a:
      'Veuillez utiliser le formulaire ci-dessous pour nous envoyer vos retours, commentaires et rapports de bugs.',
    feedback_sent_confirmation:
      'Merci de nous contacter. Si vous avez un e-mail associé à votre compte, vous recevrez une réponse de notre part dans les plus brefs délais.',
    fit: 'Ajuster',
    folder: 'Dossier',
    ...
    password_recovery_rate_limit:
      "Vous avez atteint notre limite de débit ; veuillez patienter quelques minutes. Pour éviter cela à l'avenir, évitez de recharger la page trop de fois.",
    ...
    passwords_do_not_match:
      '`Nouveau mot de passe` et `Confirmer le nouveau mot de passe` ne correspondent pas.',
    paste: 'Coller',
    ...
    refer_friends_c2a:
      'Obtenez 1 Go pour chaque ami qui crée et confirme un compte sur Puter. Votre ami recevra également 1 Go !',
    ...
    save_session_c2a:
      'Créez un compte pour enregistrer votre session actuelle et éviter de perdre votre travail.',
    scan_qr_c2a:
    ...
    taking_longer_than_usual:
      "Cela prend un peu plus de temps que d'habitude. Veuillez patienter...",
    ...
    setup2fa_5_confirmation_1:
      "J'ai enregistré mes codes de récupération dans un emplacement sécurisé",
    ...
    'billing.subscription_cancelled_description':
      "Vous aurez toujours accès à votre abonnement jusqu'à la fin de cette période de facturation.",
    ...
    'billing.subscription_check_error':
      "Un problème est survenu lors de la vérification de l'état de votre abonnement.",
    'billing.email_confirmation_needed':
      "Votre e-mail n'a pas été confirmé. Nous allons vous envoyer un code pour le confirmer maintenant.",
    'billing.sub_cancelled_but_valid_until':
      'Vous avez annulé votre abonnement, et il passera automatiquement au niveau gratuit à la fin de la période de facturation. Vous ne serez pas facturé à nouveau, sauf si vous vous réabonnez.',
    'billing.current_plan_until_end_of_period':
      "Votre plan actuel jusqu'à la fin de cette période de facturation.",
