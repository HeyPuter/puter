...
const en = {
    ...
    dictionary: {
        ...
        teams_audit_require_2fa_enabled: 'Two-factor authentication required',
        teams_audit_require_2fa_disabled: 'Two-factor authentication no longer required',
        teams_audit_reset_member_2fa: 'Two-factor authentication reset',
        teams_reset_2fa: 'Reset 2FA',
        teams_reset_2fa_confirm: 'This clears two-factor authentication on {{username}}, so they can set it up again on a new device. They will be signed out everywhere and told it happened. Their password is unchanged.',
        teams_reset_2fa_confirm_action: 'Reset 2FA',
