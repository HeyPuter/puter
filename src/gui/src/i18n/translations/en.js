...
const en = {
    ...
    dictionary: {
        ...
        contact_us_attach: 'Attach Files',
        contact_us_attach_hint: 'Images and videos — up to %% files, %% MB each.',
        contact_us_attachment_remove: 'Remove attachment',
        contact_us_attachment_too_large: 'That file is too large. Each attachment can be up to %% MB.',
        contact_us_attachment_too_many: 'You can attach up to %% files.',
        contact_us_attachment_total_too_large: 'Those files add up to more than %% MB. Try attaching fewer of them, or smaller ones.',
        contact_us_attachment_unsupported: 'That file type is not supported. Attach an image (PNG, JPEG, GIF, WebP) or a video (MP4, MOV, WebM).',
        contact_us_error: 'Something went wrong. Please try again.',
        contact_us_message_required: 'Please write a message before sending.',
        contact_us_rate_limited: 'You have sent a lot of messages recently. Please try again later.',
