...
const en = {
    ...
    dictionary: {
        ...
        shared_by: 'Shared by',
        shared_link_other_account: 'This link was sent to a different Puter account. Sign in to that account to see what was shared with it.',
        shared_link_sign_in: 'Sign in to another account',
        shared_link_continue_as: 'Continue as {{username}}',
