...
const en = {
  ...
  dictionary: {
    ...
    confirm_delete_user:
      'Are you sure you want to delete your account? All your files and data will be permanently deleted. This action cannot be undone.',
    ...
    email_change_confirmation_sent:
      'A confirmation email has been sent to your new email address. Please check your inbox and follow the instructions to complete the process.',
    ...
    no_websites_published:
      'You have not published any websites yet. Right click on a folder to get started.',
    ok: 'OK',
    open: 'Open',
    ...
    password_recovery_rate_limit:
      "You've reached our rate-limit; please wait a few minutes. To prevent this in the future, avoid reloading the page too many times.",
    ...
    'billing.subscription_cancelled_description':
      'You will still have access to your subscription until the end of this billing period.',
    ...
    'billing.subscription_check_error':
      'A problem occurred while checking your subscription status.',
    'billing.payment_method_updated': 'Payment method updated!',
    'billing.email_confirmation_needed':
      "Your email has not been confirmed. We'll send you a code to confirm it now.",
    'billing.sub_cancelled_but_valid_until':
      'You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe.',
    'billing.current_plan_until_end_of_period':
      'Your current plan until the end of this billing period.',
