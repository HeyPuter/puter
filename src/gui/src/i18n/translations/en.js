...
const en = {
    ...
    dictionary: {
        ...
        magic_link_title: 'Continue with Puter',
        magic_link_app_uses_puter: '{{host}} uses Puter for AI and cloud features.',
        magic_link_continue: 'Continue with email',
        magic_link_sent_message: 'Check your email. We sent a sign-in link to {{email}}. This window will close once you open it.',
