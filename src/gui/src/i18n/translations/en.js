...
const en = {
    ...
    dictionary: {
        ...
        adjust_profile_picture: 'Adjust your photo',
        ai_app_unavailable: 'AI app is not available. Please try again later.',
        all_fields_required: 'All fields are required.',
        allow: 'Allow',
        app_feedback_c2a: 'Your feedback will be sent directly to the developer of this app.',
        ...
        confirm_events_worker_destroy: 'Are you sure you want to destroy this background worker? Its published event handlers will be removed, and any subscriptions using them will be suspended.',
        ...
        events_workers: 'Background workers',
        events_workers_description: 'Apps that run event handlers for you in the background. Destroying one removes its published handlers; subscriptions using them are suspended.',
        events_workers_destroy: 'Destroy',
        events_workers_handler_count_one: '1 handler',
        events_workers_handler_count_other: '%% handlers',
        events_workers_none: 'No background workers.',
        favorites: 'Favorites',
        feedback: 'Feedback',
        ...
        notification_mark_read_named: 'Mark as read: {{title}}',
        ...
        notifications_mark_read_failed: "Couldn't mark that notification as read. Please try again.",
        notifications_new_count: '{{count}} new notifications',
        notifications_open_hint: 'Open Notifications to see them',
        ...
        password_change_required_title: 'Choose your own password',
        password_change_required_hint: 'This account was created for you, and its password is still the one you were given. Pick your own to continue.',
        password_change_required_same: 'Your new password must be different from the one you were given.',
        ...
        share_confirm_remove_team:
            'Remove {{recipient}}’s access to this item? Everyone in the team loses it.',
        ...
        blocked_added: 'Blocked {{username}}',
        blocked_removed: 'Unblocked {{username}}',
        blocked_failed: 'Could not update your blocked list.',
        share_you: 'you',
        ...
        teams_untitled: 'Untitled team',
        teams_loading: 'Loading your team…',
        teams_load_failed: 'Could not load your team.',
        teams_rename: 'Rename',
        teams_rename_prompt: 'What should this team be called?',
        teams_create_team: 'Create a team',
        ...
        previous: 'Previous',
        next: 'Next',
        teams_seat_limit: 'Your plan covers {{limit}} accounts on this team, and they are all taken.',
        teams_seat_limit_upgrade: 'Upgrading raises the limit. The accounts you already have are untouched.',
        teams_see_plans: 'See plans',
        ...
        teams_member_actions: 'Actions',
        teams_member_provisioned: 'Provisioned',
        teams_member_joined: 'Joined',
        teams_member_state_active: 'Active',
        teams_member_state_disabled: 'Suspended',
        teams_billing_summary_one:
            'You’re billed for 1 active account. {{disabled}} suspended cost nothing per account, but you’re still billed for the files they hold.',
        teams_billing_summary:
            'You’re billed for {{billed}} active accounts. {{disabled}} suspended cost nothing per account, but you’re still billed for the files they hold.',
        teams_reissue_credential: 'Reissue password',
        teams_disable_account: 'Suspend',
        teams_enable_account: 'Restore',
        teams_credential_heading: 'One-time password for {{username}}',
        teams_credential_once:
            'This is the only time it’s shown. Pass it on yourself — they’ll have to change it when they sign in.',
        teams_confirm_reissue:
            'Give {{username}} a new one-time password? Their old one stops working, they’ll be emailed about it, and it goes in this team’s record. It only works before they’ve ever signed in — after that they reset it themselves.',
        teams_confirm_disable:
            'Suspend {{username}}? They’re signed out and can’t sign back in. Their files are untouched, and you can restore them at any time.',
        teams_audit: 'Record',
        teams_audit_hint: 'What this team has done to its accounts.',
        teams_no_audit: 'Nothing has happened yet.',
        teams_audit_when: 'When',
        teams_audit_action: 'What',
        teams_audit_account: 'Account',
        teams_audit_actor: 'By',
        teams_audit_provision: 'Account created',
        teams_audit_disable: 'Suspended',
        teams_audit_enable: 'Restored',
        teams_audit_delete_team: 'Team deleted',
        ...
        teams_your_record_hint:
            'What {{team}} has done to your account. Only you and its administrator can see this.',
        teams_delete_account: 'Delete account',
        teams_confirm_delete_account:
            'Permanently delete {{username}}? Their files are removed, their username is released, and this cannot be undone. It is also the only thing that stops the storage charge for what they held.',
        teams_danger_zone: 'Danger zone',
        teams_delete_team: 'Delete team',
        teams_delete_team_hint:
            'Suspends every account this team created. Recovering them takes a support request.',
        teams_confirm_delete_team:
            'Delete {{team}}? Every account it created is suspended, and getting them back takes a support request.',
        teams_confirm_delete_billing:
            'This stops the per-account charges. It does not stop the storage charges — the files those accounts hold are still billed to you until they’re deleted.',
        ...
        // Tier ids are persisted spellings; only the display names moved when
        // the lineup became Basic / Plus / Pro (Business grandfathered).
        ...
        magic_link_title: 'Sign In With Email Link',
        magic_link_app_uses_puter: '%strong% is powered by Puter for its AI and cloud features.\nUse your Puter account to continue.',
        magic_link_continue: 'Send sign-in link',
        magic_link_sent_message: 'Check your inbox. We sent a sign-in link to {{email}}.',
        magic_link_invalid_email: 'Please enter a valid email address.',
        magic_link_log_in_c2a: 'Already have an account? Log In',
        sign_in_with_email_link: 'Sign in with Email Link',
        magic_link_tos_fineprint: 'By signing in, you agree to Puter\'s {{link=terms}}Terms of Service{{/link}} and {{link=privacy}}Privacy Policy{{/link}}.',
        magic_link_request_failed: 'We could not send the link. Please try again.',
        magic_link_too_many_requests: 'Too many links requested. Please wait a few minutes and try again.',
        magic_link_expired_message: 'That sign-in link has expired or was already used. Request a new one from the app.',
