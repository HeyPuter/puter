...
const ku = {
  ...
  dictionary: {
    ...
    confirm_2fa_recovery: 'کۆدەکانی ڕێکخستنەوە پشتڕاست کردووە بۆ مەبەستێکی تایبەتی',
    ...
    confirm_code_generic_too_many_requests: 'داواکاریی زۆر. تکایە چەند خولەکێک چاوەڕوانبە.',
    ...
    confirm_delete_multiple_items: 'دڵنیایت کە ئەتەوێت ئەم بابەتانە هەمی نابود بکەیتەوە؟',
    confirm_delete_single_item: 'ئەتەوێت ئەم بابەتە نابود بکەیتەوە؟',
    confirm_open_apps_log_out: 'هەبوونەوەی ئەپەکان. دڵنیایت کە ئەتەوێت چوونە دەرەوە؟',
    ...
    contact_us_verification_required: 'پێویستە ناونیشانی ئیمەیلەکەت پشتڕاست بکرێت بۆ بەکارهێنان.',
    contain: 'پێکەوە',
    ...
    clock_visible_auto: 'ئۆتۆ - بنەڕەت، تەنها پیشاندراوە لە دۆخەکانی شاشەی تەواو.',
    ...
    end_process_force_confirm: 'دڵنیایت کە ئەتەوێت بەهێزەوە کۆتای پڕۆسەکە بگریت؟',
    end_soft: 'کۆتای هەواڵ',
    enlarged_qr_code: 'کۆدی QR گەورەکراو',
    enter_password_to_confirm_delete_user: 'وشەی تێپەڕت بنووسە بۆ پشتڕاستکردنی سڕینەوەی هەژمار',
    ...
    no: 'نەخێر',
    no_dir_associated_with_site: 'هیچ ڕێکەوتێک پەیوەندیداری ئەم ناونیشانە نییە.',
    ...
    password_recovery_token_invalid: 'ئەم تۆکنی ڕێکخستنەوەی وشەی تێپەڕە نادروستە.',
    password_recovery_unknown_error: 'هەڵەیەکی نادیاری رووی دا. تکایە دووبارە هەوڵبەرە.',
    ...
    passwords_do_not_match: '`وشەی تێپەڕی نوێ` و `پشتڕاستکردنی وشەی تێپەڕی نوێ` جیاوازن.',
    paste: 'دانان',
    ...
    save_session_c2a: 'هەژمارێک دروست بکە بۆ پاشەکەوتکردنی دانیشتنەکەت و جلە نبەرینەوەی کاریەکانت.',
    scan_qr_c2a: 'کۆدی خوارەوە پشکنین\nبۆ چوونەژوورەوەی ئەم دانیشتنە لە ئامرازە ترەکان',
    ...
    you_have_been_referred_to_puter_by_a_friend: 'هاوڕێکت پەیوەندیداری پوتەر کردووە!',
    zip: 'زیپ',
