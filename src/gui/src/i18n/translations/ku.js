...
const ku = {
  ...
  dictionary: {
    ...
    "billing.change_payment_method": "گۆڕینی شێوازی پارەدان", // In English: "Change"
    "billing.cancel": "ڕەتکردنەوە", // In English: "Cancel"
    "billing.download_invoice": "داگرتن", // In English: "Download"
    "billing.payment_method": "شێوازی پارەدان", // In English: "Payment Method"
    "billing.payment_method_updated": "شێوازی پارەدان نوێکرایەوە!", // In English: "Payment method updated!"
    "billing.confirm_payment_method": "پشتڕاستکردنی شێوازی پارەدان", // In English: "Confirm Payment Method"
    "billing.payment_history": "مێژووی پارەدان", // In English: "Payment History"
    "billing.refunded": "گەڕاندنەوەی پارە", // In English: "Refunded"
    "billing.paid": "پارەدرا", // In English: "Paid"
    "billing.ok": "باشە", // In English: "OK"
    "billing.resume_subscription": "دووبارە دەستپێکردنی بەشداربوون", // In English: "Resume Subscription"
    "billing.subscription_cancelled": "بەشداربوونەکەت ڕەتکرایەوە.", // In English: "Your subscription has been canceled."
    "billing.subscription_cancelled_description": "هێشتا دەتوانیت بەشداربوونەکەت بەکاربهێنیت تا کۆتایی ئەم ماوەی پارەدانە.", // In English: "You will still have access to your subscription until the end of this billing period."
    "billing.offering.free": "ئازاد", // In English: "Free"
    "billing.offering.pro": "پەروەردەیی", // In English: "Professional"
    "billing.offering.business": "کاروباری", // In English: "Business"
    "billing.cloud_storage": "پارێزگای هەورە", // In English: "Cloud Storage"
    "billing.ai_access": "دەستگەیشتن بە AI", // In English: "AI Access"
    "billing.bandwidth": "پانی باند", // In English: "Bandwidth"
    "billing.apps_and_games": "ئەپەکان و یارییەکان", // In English: "Apps & Games"
    "billing.upgrade_to_pro": "نوێکردنەوە بۆ %strong%", // In English: "Upgrade to %strong%"
    "billing.switch_to": "گۆڕینی بۆ %strong%", // In English: "Switch to %strong%"
    "billing.payment_setup": "ڕێکخستنی پارەدان", // In English: "Payment Setup"
    "billing.back": "گەڕانەوە", // In English: "Back"
    "billing.you_are_now_subscribed_to": "ئێستا بەشداربووی %strong% بوویت.", // In English: "You are now subscribed to %strong% tier."
    "billing.you_are_now_subscribed_to_without_tier": "ئێستا بەشداربووی بوویت", // In English: "You are now subscribed"
    "billing.subscription_cancellation_confirmation": "دڵنیایت کە ئەتەوێت بەشداربوونەکەت ڕەتبکەیتەوە؟", // In English: "Are you sure you want to cancel your subscription?"
    "billing.subscription_setup": "ڕێکخستنی بەشداربوون", // In English: "Subscription Setup"
    "billing.cancel_it": "ڕەتکردنەوە", // In English: "Cancel It"
    "billing.keep_it": "پاشەکەوتکردن", // In English: "Keep It"
    "billing.subscription_resumed": "بەشداربوونی %strong%ەکەت دووبارە دەستپێکرا!", // In English: "Your %strong% subscription has been resumed!"
    "billing.upgrade_now": "نوێکردنەوە ئێستا", // In English: "Upgrade Now"
    "billing.upgrade": "نوێکردنەوە", // In English: "Upgrade"
    "billing.currently_on_free_plan": "ئێستا لە پلانی ئازادیدا هەیە.", // In English: "You are currently on the free plan."
    "billing.download_receipt": "داگرتنی وەسڵ", // In English: "Download Receipt"
    "billing.subscription_check_error": "کێشەیەک ڕوویدا کاتێک دەتوانی دۆخی بەشداربوونەکەت بپشکنیت.", // In English: "A problem occurred while checking your subscription status."
    "billing.email_confirmation_needed": "ئیمەیلەکەت پشتڕاست نەکراوە. ئێمە کۆدیەک ناردووە بۆ پشتڕاستکردن.", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    "billing.sub_cancelled_but_valid_until": "بەشداربوونەکەت ڕەتکرایەوە و بە شێوەیەکی خۆکار بۆ پلانی ئازاد دەگۆڕێت لە کۆتایی ماوەی پارەدانە. دووبارە پارە ناداترێت تا کە دووبارە بەشداربووی بکرێت.", // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    "billing.current_plan_until_end_of_period": "پلانی ئێستا تا کۆتایی ئەم ماوەی پارەدانە.", // In English: "Your current plan until the end of this billing period."
    "billing.current_plan": "پلانی ئێستا", // In English: "Current plan"
    "billing.cancelled_subscription_tier": "بەشداربوونی ڕەتکراوە (%%)", // In English: "Cancelled Subscription (%%)"
    "billing.manage": "بەڕێوەبردن", // In English: "Manage"
    "billing.limited": "سنووردار", // In English: "Limited"
    "billing.expanded": "فراوان", // In English: "Expanded"
    "billing.accelerated": "خێرا", // In English: "Accelerated"
    "billing.enjoy_msg": "لە %% پارێزگای هەورە بەهەڵبژاردنەکان وەرگرتن." // In English: "Enjoy %% of Cloud Storage plus other benefits."
  },
};
