...
const ar = {
  ...
  dictionary: {
    ...
    `,
      ...
      // ----------------------------------------
      "billing.change_payment_method": "تغيير", // In English: "Change"
      "billing.cancel": "إلغاء", // In English: "Cancel"
      "billing.download_invoice": "تنزيل", // In English: "Download"
      "billing.payment_method": "وسيلة الدفع", // In English: "Payment Method"
      "billing.payment_method_updated": "تم تحديث وسيلة الدفع", // In English: "Payment method updated!"
      "billing.confirm_payment_method": "تأكيد وسيلة الدفع", // In English: "Confirm Payment Method"
      "billing.payment_history": "تاريخ الدفع", // In English: "Payment History"
      "billing.refunded": "مسترجع", // In English: "Refunded"
      "billing.paid": "مدفوع", // In English: "Paid"
      "billing.ok": "حسنا", // In English: "OK"
      "billing.resume_subscription": "استعادة الاشتراك", // In English: "Resume Subscription"
      "billing.subscription_cancelled": "تم إلغاء اشتراكك", // In English: "Your subscription has been canceled."
      "billing.subscription_cancelled_description": "سيظل بإمكانك استخدام اشتراكك حتى نهاية مدة الفاتورة الحالية", // In English: "You will still have access to your subscription until the end of this billing period."
      "billing.offering.free": "مجانا", // In English: "Free"
      "billing.offering.pro": "محترف", // In English: "Professional"
      "billing.offering.business": "الأعمال", // In English: "Business"
      "billing.cloud_storage": "التخزين السحابي", // In English: "Cloud Storage"
      "billing.ai_access": "الوصول إلى الذكاء الاصطناعي", // In English: "AI Access"
      "billing.bandwidth": "النطاق الترددي", // In English: "Bandwidth"
      ...
      "billing.switch_to": "التبديل إلى %strong%", // In English: "Switch to %strong%"
      "billing.payment_setup": "إعداد الدفع", // In English: "Payment Setup"
      "billing.back": "رجوع", // In English: "Back"
      "billing.you_are_now_subscribed_to": "لقد اشتركت الآن في المستوى %strong%.", // In English: "You are now subscribed to %strong% tier."
      "billing.you_are_now_subscribed_to_without_tier": "لقد تم اشتراكك الآن", // In English: "You are now subscribed"
      "billing.subscription_cancellation_confirmation": "هل أنت متأكد أنك تريد إلغاء اشتراكك؟", // In English: "Are you sure you want to cancel your subscription?"
      "billing.subscription_setup": "إعداد الاشتراك", // In English: "Subscription Setup"
      "billing.cancel_it": "إلغها", // In English: "Cancel It"
      "billing.keep_it": "احتفظ بها", // In English: "Keep It"
      "billing.subscription_resumed": "لقد تم استئناف اشتراكك في %strong%!", // In English: "Your %strong% subscription has been resumed!"
      "billing.upgrade_now": "قم بالترقية الآن", // In English: "Upgrade Now"
      "billing.upgrade": "ترقية", // In English: "Upgrade"
      "billing.currently_on_free_plan": "أنت حاليًا في الخطة المجانية.", // In English: "You are currently on the free plan."
      "billing.download_receipt": "تنزيل الإيصال", // In English: "Download Receipt"
      ...
      "billing.email_confirmation_needed": "لم يتم تأكيد بريدك الإلكتروني. سنرسل إليك رمزًا لتأكيده الآن.", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
      "billing.sub_cancelled_but_valid_until": "لقد قمت بإلغاء اشتراكك وسيتم تحويله تلقائيًا إلى المستوى المجاني في نهاية فترة الفاتورة. لن يتم تحصيل أي رسوم منك مرة أخرى إلا إذا قمت بإعادة الاشتراك.", // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
      "billing.current_plan_until_end_of_period": "خطتك الحالية حتى نهاية مدة الفاتورة الحالية.", // In English: "Your current plan until the end of this billing period."
      "billing.current_plan": "الخطة الحالية", // In English: "Current plan"
      "billing.cancelled_subscription_tier": "الاشتراك الملغى (%%)", // In English: "Cancelled Subscription (%%)"
      "billing.manage": "إدارة", // In English: "Manage"
      "billing.limited": "محدود", // In English: "Limited"
      "billing.expanded": "موسعة", // In English: "Expanded"
      "billing.accelerated": "مُتسارع", // In English: "Accelerated"
      "billing.enjoy_msg": "استمتع بنسبة %% من مساحة التخزين السحابية بالإضافة إلى مزايا أخرى.", // In English: "Enjoy %% of Cloud Storage plus other benefits."
  },
};
