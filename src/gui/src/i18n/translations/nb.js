...
const nb = {
  ...
  dictionary: {
    ...
    email_change_confirmation_sent:
      'En bekreftelsese-post har blitt sendt til din nye e-postadresse. Vennligst sjekk innboksen din og følg instruksjonene for å fullføre prosessen.',
    ...
    password_recovery_rate_limit:
      'Du har nådd vår hastighetsgrense; vennligst vent noen minutter. For å unngå dette i fremtiden, unngå å laste siden på nytt for mange ganger.',
    ...
    public: 'Offentlig',
    puter_description:
      'Puter er en personvernsikker personlig sky for å oppbevare alle dine filer, apper og spill på ett sikkert sted, tilgjengelig hvor som helst og når som helst.',
    ...
    login2fa_recovery_instructions:
      'Skriv inn en av gjenopprettingskodene dine for å få tilgang til kontoen din.',
    ...
    'billing.subscription_cancelled_description':
      'Du vil fortsatt ha tilgang til abonnementet ditt ut denne fakturaperioden.',
    ...
    'billing.subscription_check_error':
      'Det oppstod et problem ved sjekk av abonnementsstatusen din.',
    'billing.email_confirmation_needed':
      'E-postadressen din har ikke blitt bekreftet. Vi sender deg nå en kode for å bekrefte den.',
    'billing.sub_cancelled_but_valid_until':
      'Du har kansellert abonnementet ditt og det vil automatisk bytte til gratisversjonen ved slutten av fakturaperioden. Du vil ikke bli belastet igjen med mindre du fornyer abonnementet.',
