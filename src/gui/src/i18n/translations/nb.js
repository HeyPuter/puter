...
const nb = {
  ...
  dictionary: {
    ...
    confirm_2fa_recovery:
      "Jeg har lagret gjenopprettingskodene mine på et sikkert sted",
    confirm_account_for_free_referral_storage_c2a:
      "Opprett en konto og bekreft e-postadressen din for å motta 1 GB gratis lagringsplass. Din venn vil også få 1 GB gratis lagringsplass.",
    confirm_code_generic_incorrect: "Feil kode.",
    confirm_code_generic_too_many_requests:
      "For mange forespørsler. Vennligst vent noen minutter.",
    ...
    confirm_delete_single_item:
      "Er du sikker på at du vil slette dette elemente permanent?",
    confirm_open_apps_log_out:
      "Du har åpene apper, er du sikker på at du vil logge ut?",
    confirm_new_password: "Bekreft nytt passord",
    confirm_delete_user:
      "Er du sikker på at du vil slette kontoen din? Alle filene og dataene dine vil bli permanent slettet. Denne handlingen kan ikke angres.",
    ...
    contact_us_verification_required:
      "Du må ha en bekreftet e-postadresse for å bruke dette.",
    contain: "Inneholde",
    continue: "Fortsett",
    copy: "Kopier",
    ...
    email_change_confirmation_sent:
      "En bekreftelses-e-post har blitt sendt til din nye e-postadresse. Sjekk innboksen din og følg instruksjonene for å fullføre prosessen.",
    ...
    feedback_c2a:
      "Vennligst bruk skjemaet nedenfor for å sende oss din tilbakemelding, kommentarer og feilrapporter.",
    feedback_sent_confirmation:
      "Takk for at du kontaktet oss. Hvis du har en e-post knyttet til kontoen din, vil du høre fra oss så snart som mulig.",
    fit: "Tilpass",
    folder: "Mappe",
    ...
    items_in_trash_cannot_be_renamed:
      "Dette elementet kan ikke omdøpes fordi det er i papirkurven. For å omdøpe dette elementet, dra det først ut av papirkurven.",
    ...
    password_recovery_rate_limit:
      "Du har nådd grensen for antall forespørsler; vennligst vent noen minutter. For å unngå dette i fremtiden, unngå å laste inn siden for mange ganger.",
    password_recovery_token_invalid:
      "Denne lenken for passordgjenoppretting er ikke lenger gyldig.",
    password_recovery_unknown_error:
      "En ukjent feil har oppstått. Prøv igjen senere.",
    password_required: "Passord er påkrevd.",
    password_strength_error:
      "Passordet må være minst 8 tegn langt og inneholde minst én stor bokstav, én liten bokstav, ett tall og ett spesialtegn.",
    ...
    puter_description:
      "Puter er en personvernfokusert personlig sky der du kan samle alle filene, appene og spillene dine på ett sikkert sted, tilgjengelig fra hvor som helst, når som helst.",
    ...
    refer_friends_c2a:
      "Få 1 GB for hver venn som oppretter og bekrefter en konto på Puter. Vennen din får også 1 GB.",
    refer_friends_social_media_c2a:
      "Få 1 GB gratis lagringsplass på Puter.com!",
    refresh: "Oppdater",
    release_address_confirmation:
      "Er du sikker på at du vil frigi denne adressen?",
    ...
    save_account_to_get_copy_link:
      "Vennligst opprett en konto for å fortsette.",
    save_account_to_publish: "Vennligst opprett en konto for å fortsette.",
    save_session: "Lagre økt",
    save_session_c2a:
      "Opprett en konto for å lagre gjeldende økt og unngå å miste arbeidet ditt.",
    scan_qr_c2a:
      "Skann koden nedenfor for å logge inn på denne økten fra andre enheter",
    scan_qr_2fa: "Skann QR-koden med autentiseringsappen din",
    scan_qr_generic:
      "Skann denne QR-koden med telefonen din eller en annen enhet",
    search: "Søk",
    seconds: "sekunder",
    security: "Sikkerhet",
    select: "Velg",
    ...
    taking_longer_than_usual:
      "Dette tar litt lenger tid enn vanlig. Vennligst vent...",
    ...
    tos_fineprint:
      "Ved å klikke på 'Opprett gratis konto' godtar du Puters {{link=terms}}tjenestevilkår{{/link}} og {{link=privacy}}personvernpolicy{{/link}}.",
    ...
    you_have_been_referred_to_puter_by_a_friend:
      "Du har blitt invitert til Puter av en venn!",
    zip: "Zip",
    ...
    login2fa_recovery_instructions:
      "Skriv inn en av gjenopprettingskodene dine for å få tilgang til kontoen.",
    ...
    "This user already has access to this item":
      "Denne brukeren har allerede tilgang til dette elementet",
    ...
    "billing.subscription_cancelled_description":
      "Du vil fortsatt ha tilgang til abonnementet ditt frem til slutten av denne faktureringsperioden.",
    ...
    "billing.you_are_now_subscribed_to":
      "Du har nå abonnert på %strong%-nivået.",
    ...
    "billing.subscription_resumed":
      "Abonnementet ditt på %strong% er gjenopptatt!",
    ...
    "billing.subscription_check_error":
      "Det oppstod et problem med å sjekke abonnementets status.",
    "billing.email_confirmation_needed":
      "E-posten din er ikke bekreftet. Vi sender deg nå en kode for å bekrefte den.",
    "billing.sub_cancelled_but_valid_until":
      "Du har kansellert abonnementet ditt. Det vil automatisk byttes til gratisplan ved slutten av faktureringsperioden. Du blir ikke belastet igjen med mindre du abonnerer på nytt.",
    "billing.current_plan_until_end_of_period":
      "Gjeldende plan til slutten av faktureringsperioden.",
    ...
    cookies_agree:
      "Ved å bruke dette nettstedet samtykker du i vår bruk av informasjonskapsler.",
    learn_more: "Lær mer",
    languages: "Språk",
    contribute: "Bidra",
    join_us: "Bli med oss",
    ...
    // =============================================================
    choose_publishing_option: "Velg hvordan du vil publisere nettstedet ditt:", // In English: "Choose how you want to publish your website:"
    minimize: "Minimer", // In English: "Minimize"
    reload_app: "Last appen på nytt", // In English: "Reload App"
    open_trash: "Åpne papirkurv", // In English: "Open Trash"
    pick_name_for_worker: "Velg et navn for workeren din:", // In English: "Pick a name for your worker:"
    plural_suffix: "", // In English: "s"
    publish_as_serverless_worker: "Publiser som Worker", // In English: "Publish as Worker"
    worker: "Worker", // In English: "Worker"
    too_many_attempts: "For mange forsøk. Prøv igjen senere.", // In English: "Too many attempts. Please try again later."
    server_timeout: "Serveren brukte for lang tid på å svare. Prøv igjen.", // In English: "The server took too long to respond. Please try again."
    signup_error: "Det oppstod en feil under registreringen. Prøv igjen.", // In English: "An error occurred during signup. Please try again."
    welcome_title: "Velkommen til din personlige Internett-datamaskin", // In English: "Welcome to your Personal Internet Computer"
    welcome_description:
      "Lagre filer, spill spill, finn flotte apper og mye mer! Alt på ett sted, tilgjengelig fra hvor som helst, når som helst.", // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
    welcome_get_started: "Kom i gang", // In English: "Get Started"
    welcome_terms: "Vilkår", // In English: "Terms"
    welcome_privacy: "Personvern", // In English: "Privacy"
    welcome_developers: "Utviklere", // In English: "Developers"
    welcome_open_source: "Åpen kildekode", // In English: "Open Source"
    welcome_instant_login_title: "Direkte innlogging!", // In English: "Instant Login!"
    alert_error_title: "Feil!", // In English: "Error!"
    alert_warning_title: "Advarsel!", // In English: "Warning!"
    alert_info_title: "Info", // In English: "Info"
    alert_success_title: "Suksess!", // In English: "Success!"
    alert_confirm_title: "Er du sikker?", // In English: "Are you sure?"
    alert_yes: "Ja", // In English: "Yes"
    alert_no: "Nei", // In English: "No"
    alert_retry: "Prøv igjen", // In English: "Retry"
    alert_cancel: "Avbryt", // In English: "Cancel"
    signup_confirm_password: "Bekreft passord", // In English: "Confirm Password"
    login_email_username_required: "E-post eller brukernavn er påkrevd", // In English: "Email or username is required"
    login_password_required: "Passord er påkrevd", // In English: "Password is required"
    window_title_open: "Åpne", // In English: "Open"
    window_title_change_password: "Endre passord", // In English: "Change Password"
    window_title_select_font: "Velg skrifttype…", // In English: "Select font…"
    window_title_session_list: "Øktliste!", // In English: "Session List!"
    window_title_set_new_password: "Angi nytt passord", // In English: "Set New Password"
    window_title_instant_login: "Direkte innlogging!", // In English: "Instant Login!"
    window_title_publish_website: "Publiser nettsted", // In English: "Publish Website"
    window_title_publish_worker: "Publiser Worker", // In English: "Publish Worker"
    window_title_authenticating: "Autentiserer...", // In English: "Authenticating..."
    window_title_refer_friend: "Henvis en venn!", // In English: "Refer a friend!"
    desktop_show_desktop: "Vis skrivebord", // In English: "Show Desktop"
    desktop_show_open_windows: "Vis åpne vinduer", // In English: "Show Open Windows"
    desktop_exit_full_screen: "Avslutt fullskjerm", // In English: "Exit Full Screen"
    desktop_enter_full_screen: "Gå til fullskjerm", // In English: "Enter Full Screen"
    desktop_position: "Posisjon", // In English: "Position"
    desktop_position_left: "Venstre", // In English: "Left"
    desktop_position_bottom: "Bunn", // In English: "Bottom"
    desktop_position_right: "Høyre", // In English: "Right"
    item_shared_with_you: "En bruker har delt dette elementet med deg.", // In English: "A user has shared this item with you."
    item_shared_by_you:
      "Du har delt dette elementet med minst én annen bruker.", // In English: "You have shared this item with at least one other user."
    item_shortcut: "Snarvei", // In English: "Shortcut"
    item_associated_websites: "Tilknyttet nettsted", // In English: "Associated website"
    item_associated_websites_plural: "Tilknyttede nettsteder", // In English: "Associated websites"
    no_suitable_apps_found: "Ingen passende apper funnet", // In English: "No suitable apps found"
    window_click_to_go_back: "Klikk for å gå tilbake.", // In English: "Click to go back."
    window_click_to_go_forward: "Klikk for å gå fremover.", // In English: "Click to go forward."
    window_click_to_go_up: "Klikk for å gå én mappe opp.", // In English: "Click to go one directory up."
    window_title_public: "Offentlig", // In English: "Public"
    window_title_videos: "Videoer", // In English: "Videos"
    window_title_pictures: "Bilder", // In English: "Pictures"
    window_title_puter: "Puter", // In English: "Puter"
    window_folder_empty: "Denne mappen er tom", // In English: "This folder is empty"
    manage_your_subdomains: "Administrer underdomenene dine", // In English: "Manage Your Subdomains"
    open_containing_folder: "Åpne inneholdende mappe", // In English: "Open Containing Folder"
  },
};
