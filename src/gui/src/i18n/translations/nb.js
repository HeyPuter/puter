...
const nb = {
    ...
    dictionary: {
        ...
        "pick_name_for_worker": Velg et navn for arbeideren din:, // In English: "Pick a name for your worker:"
        "plural_suffix": er, // In English: "s"
        ...
        "server_timeout": Tjeneren brukte for lang tid på å svare. Prøv igjen., // In English: "The server took too long to respond. Please try again."
        "signup_error": En feil oppstod under registreringen. Prøv igjen., // In English: "An error occurred during signup. Please try again."
        "welcome_title": Velkommen til din personlige internettmaskin, // In English: "Welcome to your Personal Internet Computer"
        "welcome_description": Lagre filer, spill spill, finn fantastiske apper og mye mer! Alt på ett sted, tilgjengelig hvor som helst og når som helst., // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
        ...
        "welcome_instant_login_title": Øyeblikkelig innlogging!, // In English: "Instant Login!"
        ...
        "alert_success_title": Vellykket!, // In English: "Success!"
        ...
        "window_title_select_font": Velg skrift…, // In English: "Select font…"
        ...
        "window_title_instant_login": Øyeblikkelig innlogging!, // In English: "Instant Login!"
        ...
        "desktop_position_bottom": Nederst, // In English: "Bottom"
        ...
        "item_shared_by_you": Du har delt dette elementet med minst én annen bruker., // In English: "You have shared this item with at least one other user."
        ...
        "window_click_to_go_up": Klikk for å gå ett katalognivå opp., // In English: "Click to go one directory up."
