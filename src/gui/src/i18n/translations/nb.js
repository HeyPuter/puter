...
const nb = {
    ...
    dictionary: {
        ...
        billing = {
            ...
            cancel: "Avbryt",
            download_invoice: "Last ned",
            payment_method: "Betalingsmåte",
            payment_method_updated: "Betalingsmåte oppdatert!",
            confirm_payment_method: "Bekreft betalingsmåte",
            payment_history: "Betalingshistorikk",
            refunded: "Refundert",
            paid: "Betalt",
            ok: "OK",
            resume_subscription: "Gjenoppta abonnement",
            subscription_cancelled: "Abonnementet ditt har blitt kansellert.",
            subscription_cancelled_description: "Du vil fortsatt ha tilgang til abonnementet ditt ut denne fakturaperioden.",
            offering: {
                free: "Gratis",
                pro: "Professional",
                business: "Business",
            },
            cloud_storage: "Skylagring",
            ai_access: "AI-tilgang",
            bandwidth: "Båndbredde",
            apps_and_games: "Apper og spill",
            upgrade_to_pro: "Oppgrader til %strong%",
            switch_to: "Bytt til %strong%",
            payment_setup: "Betalingsoppsett",
            back: "Tilbake",
            you_are_now_subscribed_to: "Du abonnerer nå på %strong%-nivået.",
            you_are_now_subscribed_to_without_tier: "Du abonnerer nå",
            subscription_cancellation_confirmation: "Er du sikker på at du vil kansellere abonnementet ditt?",
            subscription_setup: "Abonnementsoppsett",
            cancel_it: "Kanseller",
            keep_it: "Behold",
            subscription_resumed: "Ditt %strong%-abonnement har blitt gjenopptatt!",
            upgrade_now: "Oppgrader nå",
            upgrade: "Oppgrader",
            currently_on_free_plan: "Du bruker for tiden gratisversjonen.",
            download_receipt: "Last ned kvittering",
            subscription_check_error: "Det oppstod et problem ved sjekk av abonnementsstatusen din.",
            email_confirmation_needed: "E-postadressen din har ikke blitt bekreftet. Vi sender deg nå en kode for å bekrefte den.",
            sub_cancelled_but_valid_until: "Du har kansellert abonnementet ditt og det vil automatisk bytte til gratisversjonen ved slutten av fakturaperioden. Du vil ikke bli belastet igjen med mindre du fornyer abonnementet.",
            current_plan_until_end_of_period: "Din nåværende plan ut denne fakturaperioden.",
            current_plan: "Nåværende plan",
            cancelled_subscription_tier: "Kansellert abonnement (%%)",
            manage: "Administrer",
            limited: "Begrenset",
            expanded: "Utvidet",
