...
const de = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Erstellen Sie ein Konto und bestätigen Sie Ihre E-Mail-Adresse, um 1 GB kostenlosen Speicherplatz zu erhalten. Ihr Freund erhält ebenfalls 1 GB kostenlosen Speicherplatz.',
    ...
    confirm_delete_user:
      'Möchten Sie Ihr Konto wirklich löschen? Alle Ihre Dateien und Daten werden dauerhaft gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.',
    ...
    contact_us_verification_required:
      'Sie müssen eine verifizierte E-Mail-Adresse haben, um dies zu verwenden.',
    contain: 'Füllen',
    continue: 'Weiter',
    copy: 'Kopieren',
    ...
    email_change_confirmation_sent:
      'Eine Bestätigungs-E-Mail wurde an Ihre neue E-Mail-Adresse gesendet. Bitte überprüfen Sie Ihren Posteingang und folgen Sie den Anweisungen, um den Vorgang abzuschließen.',
    ...
    enter_password_to_confirm_delete_user:
      'Geben Sie Ihr Passwort ein, um die Entferung des Kontos zu bestätigen',
    ...
    feedback_c2a:
      'Bitte verwenden Sie das folgende Formular, um uns Ihre Rückmeldung, Kommentare und Fehlerberichte zu senden.',
    feedback_sent_confirmation:
      'Danke, dass Sie uns kontaktiert haben. Wenn Sie eine E-Mail mit Ihrem Konto verknüpft haben, werden Sie so schnell wie möglich von uns hören.',
    fit: 'Anpassen',
    folder: 'Ordner',
    ...
    password_recovery_rate_limit:
      'Sie haben unser Limit erreicht; bitte warten Sie ein paar Minuten. Um dies in Zukunft zu vermeiden, laden Sie die Seite nicht zu oft neu.',
    password_recovery_token_invalid:
      'Dieses Passwort-Wiederherstellungstoken ist nicht mehr gültig.',
    ...
    refer_friends_c2a:
      'Erhalten Sie 1 GB für jeden Freund, der ein Konto auf Puter erstellt und bestätigt. Ihr Freund erhält ebenfalls 1 GB!',
    ...
    save_session_c2a:
      'Erstellen Sie ein Konto, um Ihre aktuelle Sitzung zu speichern um den Verlust Ihrer Arbeit zu verhindern.',
    scan_qr_c2a:
      'Scannen Sie den folgenden Code, um sich von anderen Geräten in diese Sitzung einzuloggen',
    ...
    session_saved:
      'Vielen Dank, dass Sie ein Konto erstellt haben. Diese Sitzung wurde gespeichert.',
    ...
    login2fa_recovery_instructions:
      'Geben Sie einen Ihrer Wiederherstellungscodes ein, um auf Ihr Konto zuzugreifen.',
    ...
    'This user already has access to this item':
      'Dieser Benutzer hat bereits Zugriff auf dieses Element', // In English: "This user already has access to this item"
    ...
    'billing.subscription_cancelled_description':
      'Bis zum Ende des Abrechnungszeitraums haben Sie weiterhin Zugriff auf Ihr Abonnement.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'Sind Sie sicher, dass Sie Ihr Abonnement kündigen möchten?', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.subscription_check_error':
      'Bei der Überprüfung Ihres Abonnementstatus ist ein Problem aufgetreten.', // In English: "A problem occurred while checking your subscription status."
    'billing.email_confirmation_needed':
      'Ihre E-Mail wurde noch nicht bestätigt. Wir senden Ihnen jetzt einen Code zur Bestätigung.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'Sie haben Ihr Abonnement gekündigt und es wird am Ende des Abrechnungszeitraums automatisch auf die kostenlose Version umgestellt. Es wird Ihnen nicht erneut in Rechnung gestellt, es sei denn, Sie abonnieren es erneut.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'Ihr aktueller Plan bis zum Ende dieses Abrechnungszeitraums.', // In English: "Your current plan until the end of this billing period."
