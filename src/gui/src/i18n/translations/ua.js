...
const ua = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Створіть обліковий запис і підтвердіть свою електронну адресу, щоб отримати 1 Гб безкоштовного дискового простору. Ваш друг також отримає 1 Гб безкоштовного дискового простору.',
    ...
    confirm_delete_user:
      'Ви впевнені, що хочете видалити свій обліковий запис? Усі ваші файли та дані будуть видалені назавжди. Цю дію неможливо скасувати.',
    ...
    contact_us_verification_required:
      'Вам необхідно мати підтверджену електронну адресу для використання цієї функції',
    contain: 'Зміст',
    continue: 'Продовжити',
    copy: 'Копіювати',
    ...
    email_change_confirmation_sent:
      'На вашу нову електронну адресу було надіслано листа з підтвердженням. Будь ласка, перевірте свою поштову скриньку і дотримуйтесь інструкцій, щоб завершити процес.',
    ...
    enter_password_to_confirm_delete_user:
      'Введіть пароль для підтвердження видалення облікового запису',
    ...
    feedback_c2a:
      'Будь ласка, скористайтеся формою нижче, щоб надіслати нам свої відгуки, коментарі та повідомлення про помилки.',
    feedback_sent_confirmation:
      "Дякуємо, що зв'язалися з нами. Якщо у вас є електронна пошта, пов'язана з вашим обліковим записом, ми відповімо вам якомога швидше.",
    fit: 'Вмістити',
    folder: 'Папка',
    ...
    password_recovery_rate_limit:
      'Ви досягли ліміту; будь ласка, зачекайте кілька хвилин. Щоб уникнути цього в майбутньому, не перезавантажуйте сторінку занадто багато разів.',
    ...
    password_strength_error:
      'Пароль має містити не менше 8 символів і включати хоча б одну велику літеру, одну малу літеру, одну цифру та один спеціальний символ.',
    ...
    puter_description:
      'Puter — це персональна хмара, яка забезпечує конфіденційність, дозволяючи зберігати всі ваші файли, додатки та ігри в одному безпечному місці, доступному з будь-якого місця в будь-який час.',
    ...
    refer_friends_c2a:
      'Отримайте 1 ГБ за кожного друга, який створить і підтвердить обліковий запис на Puter. Ваш друг також отримає 1 ГБ!',
    ...
    tos_fineprint:
      "Натискаючи 'Створити безкоштовний обліковий запис', ви погоджуєтеся з {{link=terms}}Умовами Використання{{/link}} та {{link=privacy}}Політикою Конфіденційності{{/link}} Puter.",
    ...
    setup2fa_4_instructions:
      'Ці коди відновлення є єдиним способом входу у ваш обліковий запис, якщо ви втратите телефон або не зможете використовувати додаток для аутентифікації. Упевніться, що ви їх зберегли.',
    ...
    login2fa_recovery_instructions:
      'Введіть один з кодів відновлення для доступу до облікового запису',
    ...
    'billing.subscription_cancelled_description':
      'Ви матимете доступ до своєї підписки до кінця поточного розрахункового періоду.',
    ...
    'billing.email_confirmation_needed':
      'Ваша електронна пошта не була підтверджена. Ми надішлемо Вам код для підтвердження.',
    'billing.sub_cancelled_but_valid_until':
      'Ви скасували підписку, і вона автоматично перейде на безкоштовний рівень в кінці розрахункового періоду. Плата за підписку не стягуватиметься, якщо ви не оформите її повторно.',
    'billing.current_plan_until_end_of_period':
      'Ваш тарифний план до кінця поточного розрахункового періоду',
