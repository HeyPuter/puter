...
const ro = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Creați un cont și confirmați adresa de e-mail pentru a primi 1 GB de spațiu de stocare gratuit. Deasemenea, un prieten de-al tău va primi 1 GB de spațiu de stocare gratuit.',
    confirm_code_generic_incorrect: 'Cod incorect',
    confirm_code_generic_too_many_requests:
      'Prea multe solicitări. Vă rugăm așteptați câteva minute.',
    ...
    confirm_code_2fa_instruction:
      'Introduceți codul de 6 cifre generat de aplicația de autentificare',
    confirm_code_2fa_submit_btn: 'Trimite',
    confirm_code_2fa_title: 'Introduceți codul 2FA',
    confirm_delete_multiple_items:
      'Sunteți sigur(ă) că doriți să ștergeți aceste obiecte permanent',
    confirm_delete_single_item: 'Doriți să ștergeți acest obiect permanent?',
    confirm_open_apps_log_out:
      'Aveți aplicații care rulează. Sunteți sigur(ă) că doriți să vă delogați?',
    confirm_new_password: 'Confirmă Parola Nouă',
    confirm_delete_user:
      'Sunteți sigur(ă) că doriți să ștergeți acest cont? Toate fișierele dumneavoastră și toate datele vor fi șterse permanent. Această operație nu poate fi anulată.',
    ...
    email_change_confirmation_sent:
      'Un e-mail de confirmare a fost trimis către noua dumneavoastră adresă de e-mail. Vă rugăm să verificați ©ăsuța și să urmați intrucțiunile pentru a finaliza procesul.',
    ...
    enter_password_to_confirm_delete_user:
      'Introduceți parola pentru a confirma începerea ștergerii contului',
    ...
    feedback: 'Evaluare',
    feedback_c2a:
      'Vă rugăm să folosiți formularul de mai jos pentru a ne trimite feedback, comentarii și rapoarte de erori.',
    feedback_sent_confirmation:
      'Mulțumim că ne-ți contactat. Dacă aveți un e-mail asociat contului dvs, veți primi un răspuns de la noi cât mai curând posibil.',
    fit: 'Potrivit',
    folder: 'Folder',
    ...
    password_recovery_rate_limit:
      'Ați ajuns la frecvența limită; vă rugăm așteptați câteva minute. Pentru a nu se mai repeta pe viitor, evitați să reîncărcați pagina de prea multe ori.',
    password_recovery_token_invalid: 'Acest cod de recuperare nu mai este valabil.',
    password_recovery_unknown_error:
      'A apărut o eroare necunoscută. Vă rugăm încercați din nou mai târziu.',
    password_required: 'Parola este necesară',
    password_strength_error:
      'Parola trebuie să aibe cel puțin 8 caractere și să conțină cel puțin o literă mare, o litera mică, o cifră și un caracter special.',
    ...
    puter_description:
      'Puter este un cloud personal care pune pe primul loc confidențialitatea pentru păstrarea tuturor fișierelor dumneavoastră, a app-urilor, a jocurilor într-un loc sigur și accesibil de oriunde oricând.',
    reading_file: 'Citind %strong%',
    recent: 'Recente',
    recommended: 'Recomandat',
    recover_password: 'Recuperare Parolă',
    refer_friends_c2a:
      'Obțineți 1 GB pentru fiecare prieten care creează și confirmă un cont pe Puter. și prietenul tău va primi 1 GB!',
    ...
    save_session_c2a:
      'Creați un cont pentru a vă salva sesiunea curentă și pentru a evita pierderea muncii.',
    scan_qr_c2a:
      'Scanați codul de mai jos pentru a vă conecta la această sesiune de pe alte dispozitive',
    ...
    login2fa_recovery_instructions:
      'Introduceți unul dintre codurile de restaurare pentru a vă accesa contul.',
    ...
    'billing.subscription_cancelled_description':
      'Vei avea în continuare acces la abonament până la sfârșitul perioadei de facturare actuale.',
    ...
    'billing.email_confirmation_needed':
      'E-mailul tău nu a fost confirmat. Îți vom trimite acum un cod de confirmare.',
    'billing.sub_cancelled_but_valid_until':
      'Ți-ai anulat abonamentul și va trece automat la planul gratuit la sfârșitul perioadei de facturare. Nu vei mai fi taxat decât dacă te reabonezi.',
    'billing.current_plan_until_end_of_period':
      'Planul tău actual până la sfârșitul perioadei de facturare actuale.',
