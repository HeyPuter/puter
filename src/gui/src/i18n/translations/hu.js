...
const hu = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Hozz létre egy fiókot és erősítsd meg email címedet, hogy 1 GB ingyenes tárhelyet kapj. A barátod is kap 1 GB ingyenes tárhelyet.',
    ...
    confirm_delete_user:
      'Biztosan törölni akarod a fiókodat? Minden fájlod és adatod véglegesen törlődik. Ez a művelet nem visszavonható.',
    ...
    contact_us_verification_required:
      'A használathoz érvényesített email címmel kell rendelkezned.',
    contain: 'Tartalmaz',
    continue: 'Folytatás',
    copy: 'Másolás',
    ...
    email_change_confirmation_sent:
      'Megerősítő emailt küldtünk az új email címedre. Kérlek, ellenőrizd a postaládádat és kövesd az utasításokat a folyamat befejezéséhez.',
    ...
    feedback_c2a:
      'Kérlek, használd az alábbi űrlapot, hogy elküldd nekünk visszajelzésedet, észrevételeidet és hibajelentéseidet.',
    feedback_sent_confirmation:
      'Köszönjük, hogy kapcsolatba léptél velünk. Ha van email címed a fiókodhoz társítva, hamarosan hallani fogsz rólunk.',
    fit: 'Illesztés',
    folder: 'Mappa',
    ...
    items_in_trash_cannot_be_renamed:
      'Ez az elem nem nevezhető át, mert a kukában van. A név megváltoztatásához először húzd ki a Kukából.',
    jpeg_image: 'JPEG kép',
    ...
    no_websites_published:
      'Még nem publikáltál egyetlen weboldalt sem. Kattints jobb gombbal egy mappára a kezdéshez.',
    ok: 'Rendben',
    open: 'Megnyitás',
    ...
    password_recovery_rate_limit:
      'Elérted a korlátunkat; kérlek, várj néhány percet. A jövőben kerüld az oldal túl sokszori újratöltését.',
    ...
    puter_description:
      'A Puter egy adatvédelmi elsőként kezelt személyes felhő, amelyben minden fájlodat, alkalmazásodat és játékodat egy biztonságos helyen tárolhatod, bárhonnan, bármikor elérhetően.',
    reading_file: 'Fájl olvasása: %strong%',
    recent: 'Legutóbbi',
    recommended: 'Ajánlott',
    recover_password: 'Jelszó visszaállítása',
    refer_friends_c2a:
      'Kapj 1 GB-ot minden barátodért, aki létrehoz és megerősít egy fiókot a Puteren. A barátod is kap 1 GB-ot!',
    ...
    save_session_c2a:
      'Hozz létre egy fiókot, hogy mentsd az aktuális munkamenetedet és elkerüld a munkád elvesztését.',
    scan_qr_c2a:
      'Olvasd be az alábbi kódot, hogy bejelentkezhess ebbe a munkamenetbe más eszközökről',
    ...
    tos_fineprint:
      "A 'Ingyenes fiók létrehozása' gombra kattintva elfogadod a Puter {{link=terms}}Szolgáltatási feltételeit{{/link}} és {{link=privacy}}Adatvédelmi irányelveit{{/link}}.",
    ...
    setup2fa_1_instructions:
      "Bármely hitelesítő alkalmazást használhatod, amely támogatja az időalapú egyszeri jelszó (TOTP) protokollt. Sok választási lehetőség van, de ha nem vagy biztos benne, az <a target='_blank' href='https://authy.com/download'>Authy</a> jó választás Android és iOS rendszeren.",
    ...
    setup2fa_4_instructions:
      'Ezek a helyreállítási kódok az egyetlen módja annak, hogy hozzáférj a fiókodhoz, ha elveszíted a telefonodat vagy nem tudod használni a hitelesítő alkalmazásodat. Ügyelj arra, hogy biztonságos helyen tárold őket.',
    ...
    login2fa_recovery_instructions:
      'Add meg az egyik helyreállítási kódodat a fiókhoz való hozzáféréshez.',
    ...
    'billing.subscription_cancelled_description':
      'Az aktuális számlázási időszak végéig továbbra is hozzáférsz az előfizetésedhez.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'Biztos, hogy le akarod mondani az előfizetésedet?', // In English: "Are you sure you want to cancel your subscription?"
