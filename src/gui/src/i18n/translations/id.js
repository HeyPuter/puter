...
const id = {
    ...
    dictionary: {
        ...
        all_fields_required: 'Semua kolom harus diisi.',
        allow: 'Izinkan',
        apply: "Terapkan",
        ascending: 'Menaik',
        associated_websites: "Situs Web Terkait",
        auto_arrange: 'Tata Secara Otomatis',
        ...
        close_all_windows_and_log_out: 'Tutup Semua Jendela dan Keluar',
        change_always_open_with: "Ingin selalu membuka jenis file ini dengan",
        color: 'Warna',
        confirm: 'Konfirmasi',
        ...
        confirm_account_for_free_referral_storage_c2a: 'Buat akun dan konfirmasi alamat email Anda untuk menerima 1 GB penyimpanan gratis. Teman Anda juga akan mendapatkan 1 GB penyimpanan gratis.',
        confirm_code_generic_incorrect: "Kode Salah.",
        confirm_code_generic_too_many_requests: "Terlalu banyak permintaan. Silakan tunggu beberapa menit.",
        ...
        confirm_delete_multiple_items: 'Apakah Anda yakin ingin menghapus item-item ini secara permanen?',
        confirm_delete_single_item: 'Apakah Anda ingin menghapus item ini secara permanen?',
        confirm_open_apps_log_out: 'Anda memiliki aplikasi yang terbuka. Apakah Anda yakin ingin keluar?',
        confirm_new_password: "Konfirmasi Kata Sandi Baru",
        confirm_delete_user: "Apakah Anda yakin ingin menghapus akun Anda? Semua file dan data Anda akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.",
        ...
        email: "Email",
        email_change_confirmation_sent: "Konfirmasi perubahan email telah dikirim ke alamat email baru Anda. Periksa kotak masuk Anda dan ikuti petunjuk untuk menyelesaikan prosesnya.",
        email_invalid: 'Email tidak valid.',
        email_or_username: "Email atau Nama Pengguna",
        email_required: 'Email wajib diisi.',
        empty_trash: 'Kosongkan Sampah',
        empty_trash_confirmation: 'Anda yakin ingin menghapus item di Sampah secara permanen?',
        emptying_trash: 'Mengosongkan Sampah…',
        enable_2fa: 'Aktifkan 2FA',
        end_hard: "Akhiri Paksa",
        end_process_force_confirm: "Apakah Anda yakin ingin menghentikan proses ini secara paksa?",
        end_soft: "Akhiri dengan Aman",
        enlarged_qr_code: "Kode QR Diperbesar",
        enter_password_to_confirm_delete_user: "Masukkan kata sandi Anda untuk mengonfirmasi penghapusan akun",
        ...
        feedback_c2a: "Silakan gunakan formulir di bawah ini untuk mengirimkan umpan balik, komentar, dan laporan bug kepada kami.",
        feedback_sent_confirmation: "Terima kasih telah menghubungi kami. Jika Anda memiliki email yang terhubung dengan akun Anda, Anda akan menerima balasan dari kami sesegera mungkin.",
        fit: "Cocokkan",
        folder: 'Folder',
        ...
        no_websites_published: "Anda belum menerbitkan situs web. Klik kanan pada folder untuk memulai.",
        ok: "OK",
        open: "Buka",
        ...
        password_recovery_rate_limit: "Anda telah mencapai batas kecepatan kami; silakan tunggu beberapa menit. Untuk mencegah ini di masa depan, hindari memuat ulang halaman terlalu sering.",
        password_recovery_token_invalid: "Token pemulihan kata sandi ini tidak lagi berlaku.",
        password_recovery_unknown_error: "Terjadi kesalahan yang tidak dikenal. Silakan coba lagi nanti.",
        password_required: "Kata sandi diperlukan.",
        password_strength_error: "Kata sandi harus panjangnya setidaknya 8 karakter dan mengandung setidaknya satu huruf kapital, satu huruf kecil, satu angka, dan satu karakter khusus.",
        ...
        refer_friends_c2a: "Dapatkan 1 GB untuk setiap teman yang membuat dan mengonfirmasi akun di Puter. Teman Anda juga akan mendapatkan 1 GB!",
        refer_friends_social_media_c2a: "Dapatkan 1 GB penyimpanan gratis di Puter.com!",
        refresh: "Muat Ulang",
        release_address_confirmation: "Anda yakin ingin melepaskan alamat ini",
        ...
        save: "Simpan",
        saturation: "Saturasi",
        save_account: "Simpan Akun Anda",
        save_account_to_get_copy_link: "Buat akun untuk mendapatkan tautan salinan dan melanjutkan.",
        save_account_to_publish: "Silakan buat akun untuk melanjutkan",
        save_session: "Simpan Sesi Anda",
        save_session_c2a: "Buat akun untuk menyimpan sesi Anda dan mencegah kehilangan pekerjaan Anda.",
        scan_qr_c2a: "Pindai kode di bawah ini untuk mengakses sesi ini dari perangkat lain.",
        scan_qr_2fa: "Pindai kode QR menggunakan aplikasi autentikator Anda.",
        scan_qr_generic: "Pindai kode QR ini dengan ponsel atau perangkat lain Anda.",
        search: "Cari",
        seconds: "Detik",
        security: "Keamanan",
        select: "Pilih",
        ...
        sessions: "Sesi",
        send: "Kirim",
        send_password_recovery_email: "Kirim Email untuk Pemulihan Kata Sandi",
        session_saved: "Terima kasih telah mendaftar. Sesi Anda telah berhasil disimpan.",
        settings: "Pengaturan",
        ...
        taking_longer_than_usual: "Proses ini memakan waktu lebih lama dari biasanya. Mohon bersabar...",
        ...
        tos_fineprint: `Dengan mengklik 'Buat Akun Gratis', Anda menyetujui {{link=terms}}Syarat dan Ketentuan{{/link}} serta {{link=privacy}}Kebijakan Privasi{{/link}} Puter.`,
        ...
        type: "Tipe",
        type_confirm_to_delete_account: "Ketik 'Konfirmasi' untuk menghapus akun Anda.",
        ui_colors: "Warna UI",
        ...
        username_changed: "Nama pengguna Anda berhasil diperbarui.",
        username_required: "Nama pengguna wajib diisi.",
        versions: "Versi",
        videos: "Video",
        visibility: "Visibilitas",
        yes: "Ya",
        yes_release_it: "Ya, Lepaskan Sekarang",
