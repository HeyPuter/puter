...
const id = {
  ...
  dictionary: {
    ...
    confirm_code_2fa_instruction: 'Masukkan kode 6-digit dari aplikasi autentikator Anda.',
    ...
    passwords_do_not_match: '`Kata Sandi Baru` dan `Konfirmasi Kata Sandi Baru` tidak cocok.',
    paste: 'Tempel',
    ...
    taking_longer_than_usual: 'Memakan waktu sedikit lebih lama dari biasanya. Silakan tunggu...',
    ...
    you_have_been_referred_to_puter_by_a_friend: 'Anda telah dirujuk ke Puter oleh seorang teman!',
    zip: 'Zip',
    ...
    'billing.subscription_cancelled_description':
      'Anda masih memiliki akses ke langganan Anda hingga akhir periode penagihan ini.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'Apakah Anda yakin ingin membatalkan langganan Anda?', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.email_confirmation_needed':
      'Email Anda belum dikonfirmasi. Kami akan mengirimkan kode untuk mengonfirmasinya sekarang.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'Anda telah membatalkan langganan Anda dan secara otomatis akan beralih ke paket gratis di akhir periode penagihan. Anda tidak akan dikenakan biaya lagi kecuali Anda berlangganan ulang.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'Paket Anda saat ini berlaku hingga akhir periode penagihan ini.', // In English: "Your current plan until the end of this billing period."
