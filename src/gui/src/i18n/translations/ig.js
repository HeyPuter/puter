...
const ig = {
  ...
  dictionary: {
    ...
    // =============================================================
    choose_publishing_option: "Họrọ otu ị chọrọ isi bipụta weebụsaịtị gị:", // In English: "Choose how you want to publish your website:"
    ...
    minimize: "Belata", // In English: "Minimize"
    reload_app: "Tọgharịa ngwa", // In English: "Reload App"
    new_window: "Windo Ọhụrụ", // In English: "New Window"
    open_trash: "Mepee ahịhịa", // In English: "Open Trash"
    pick_name_for_worker: "Họrọ aha maka ọrụ gị:", // In English: "Pick a name for your worker:"
    publish_as_serverless_worker: "Bipụta dịka Ọrụ", // In English: "Publish as Worker"
    "toolbar.enter_fullscreen": "Banye n'ihuenyo zuru ezu", // In English: "Enter Full Screen"
    "toolbar.github": "GitHub", // In English: "GitHub"
    "toolbar.refer": "Kpọọ enyi", // In English: "Refer"
    ...
    used_of: "{{used}} ejiri n'ime {{available}}", // In English: "{{used}} used of {{available}}"
    worker: "Ọrụ", // In English: "Worker"
    "billing.offering.basic": "Isi", // In English: "Basic"
    too_many_attempts: "Ọtụtụ nnwale. Biko nwaa ọzọ ma emechaa.", // In English: "Too many attempts. Please try again later."
    server_timeout: "Sava weere ogologo oge iji zaa. Biko nwaa ọzọ.", // In English: "The server took too long to respond. Please try again."
    signup_error: "Njehie mere n’oge ndebanye aha. Biko nwaa ọzọ.", // In English: "An error occurred during signup. Please try again."
    welcome_title: "Nnọọ na Kọmpụta Ịntanetị Nkeonwe gị", // In English: "Welcome to your Personal Internet Computer"
    welcome_description:
      "Chekwaa faịlụ, kpọọ egwuregwu, chọta ngwa dị egwu, na ọtụtụ ihe ọzọ! Ihe niile n’otu ebe, enwere ike ịnweta ya ebe ọ bụla n’oge ọ bụla.", // In English: "Store files, play games, find awesome apps, and much more! All in one place, accessible from anywhere at any time."
    ...
    welcome_instant_login_title: "Nbanye ozugbo!", // In English: "Instant Login!"
    ...
    alert_confirm_title: "Ị ji n'aka?", // In English: "Are you sure?"
    alert_yes: "Ee", // In English: "Yes"
    alert_no: "Mba", // In English: "No"
    alert_retry: "Nwaa ọzọ", // In English: "Retry"
    alert_cancel: "Kagbuo", // In English: "Cancel"
    signup_confirm_password: "Kwenye paswọọdụ", // In English: "Confirm Password"
    login_email_username_required: "A chọrọ email ma ọ bụ aha njirimara", // In English: "Email or username is required"
    login_password_required: "A chọrọ paswọọdụ", // In English: "Password is required"
    window_title_open: "Mepee", // In English: "Open"
    window_title_change_password: "Gbanwee paswọọdụ", // In English: "Change Password"
    window_title_select_font: "Họrọ ụdị mkpụrụedemede…", // In English: "Select font…"
    window_title_session_list: "Ndepụta nnọkọ!", // In English: "Session List!"
    window_title_set_new_password: "Tinye paswọọdụ ọhụrụ", // In English: "Set New Password"
    window_title_instant_login: "Nbanye ozugbo!", // In English: "Instant Login!"
    window_title_publish_website: "Bipụta weebụsaịtị", // In English: "Publish Website"
    window_title_publish_worker: "Bipụta Ọrụ", // In English: "Publish Worker"
    window_title_authenticating: "Na-ekwenye njirimara...", // In English: "Authenticating..."
    window_title_refer_friend: "Kpọọ enyi!", // In English: "Refer a friend!"
    desktop_show_desktop: "Gosi Desktọpụ", // In English: "Show Desktop"
    desktop_show_open_windows: "Gosi windo meghere", // In English: "Show Open Windows"
    desktop_exit_full_screen: "Pụọ na ihuenyo zuru ezu", // In English: "Exit Full Screen"
    desktop_enter_full_screen: "Banye n'ihuenyo zuru ezu", // In English: "Enter Full Screen"
    desktop_position: "Ọnọdụ", // In English: "Position"
    desktop_position_left: "Aka ekpe", // In English: "Left"
    desktop_position_bottom: "Ala", // In English: "Bottom"
    desktop_position_right: "Aka nri", // In English: "Right"
    item_shared_with_you: "Onye ọrụ kesara ihe a na gị.", // In English: "A user has shared this item with you."
    item_shared_by_you: "I kesara ihe a na opekata mpe otu onye ọzọ.", // In English: "You have shared this item with at least one other user."
    item_shortcut: "Ụzọ mkpirisi", // In English: "Shortcut"
    item_associated_websites: "Weebụsaịtị ejikọtara", // In English: "Associated website"
    item_associated_websites_plural: "Weebụsaịtị ejikọtara", // In English: "Associated websites"
    no_suitable_apps_found: "Enweghị ngwa kwekọrọ", // In English: "No suitable apps found"
    window_click_to_go_back: "Pịa ka ị la azụ.", // In English: "Click to go back."
    window_click_to_go_forward: "Pịa ka ị gaa n’ihu.", // In English: "Click to go forward."
    window_click_to_go_up: "Pịa ka ị gaa otu ndekọ elu.", // In English: "Click to go one directory up."
    ...
    window_folder_empty: "Enweghị ihe n'ime nchekwa a", // In English: "This folder is empty"
    manage_your_subdomains: "Jikwaa subdomains gị", // In English: "Manage Your Subdomains"
    open_containing_folder: "Mepee nchekwa nwere ya", // In English: "Open Containing Folder"
  },
};
