...
const ur = {
  ...
  dictionary: {
    ...
    confirm_2fa_recovery: 'میں نے اپنے ریکوری کوڈز کو محفوظ جگہ پر محفوظ کر لیا ہے۔',
    ...
    confirm_code_generic_too_many_requests: 'بہت زیادہ درخواستیں براہ کرم چند منٹ انتظار کریں۔',
    ...
    confirm_code_2fa_instruction: 'اپنی تصدیق کنندہ ایپ سے 6 ہندسوں کا کوڈ درج کریں۔',
    confirm_code_2fa_submit_btn: 'جمع کرائیں',
    confirm_code_2fa_title: '2FA کوڈ درج کریں۔',
    confirm_delete_multiple_items: 'کیا آپ واقعی ان آئٹمز کو مستقل طور پر حذف کرنا چاہتے ہیں؟',
    confirm_delete_single_item: 'کیا آپ اس آئٹم کو مستقل طور پر حذف کرنا چاہتے ہیں؟',
    confirm_open_apps_log_out: 'آپ کے پاس کھلی ایپس ہیں۔ کیا آپ واقعی لاگ آؤٹ کرنا چاہتے ہیں؟',
    ...
    clock_visible_auto: 'خودکار - پہلے سے طے شدہ، صرف فل سکرین موڈ میں نظر آتا ہے۔',
    ...
    disable_2fa_instructions: '2FA کو غیر فعال کرنے کے لیے اپنا پاس ورڈ درج کریں۔',
    ...
    end_process_force_confirm: 'کیا آپ واقعی اس عمل کو زبردستی چھوڑنا چاہتے ہیں؟',
    end_soft: 'اینڈ نرم',
    enlarged_qr_code: 'بڑھا ہوا QR کوڈ',
    enter_password_to_confirm_delete_user: 'اکاؤنٹ حذف کرنے کی تصدیق کے لیے اپنا پاس ورڈ درج کریں۔',
    ...
    password_recovery_unknown_error: 'ایک نامعلوم خرابی پیش آگئی۔ براہ کرم کچھ دیر بعد کوشش کریں۔',
    ...
    scan_qr_generic: 'اس QR کوڈ کو اپنے فون یا کسی دوسرے آلے کا استعمال کرکے اسکین کریں۔',
    search: 'تلاش کریں۔',
    seconds: 'سیکنڈ',
    security: 'سیکورٹی',
    select: 'منتخب کریں',
    ...
    type: 'لکہنا',
    type_confirm_to_delete_account: "اپنا اکاؤنٹ حذف کرنے کے لیے 'تصدیق' ٹائپ کریں۔",
    ui_colors: 'UI رنگ',
    ...
    setup2fa_5_confirmation_1: 'میں نے اپنے ریکوری کوڈز کو محفوظ جگہ پر محفوظ کر لیا ہے۔',
    ...
    login2fa_otp_instructions: 'اپنی تصدیق کنندہ ایپ سے 6 ہندسوں کا کوڈ درج کریں۔',
    login2fa_recovery_title: 'ایک ریکوری کوڈ درج کریں۔',
    login2fa_recovery_instructions: 'اپنے اکاؤنٹ تک رسائی کے لیے اپنا ایک ریکوری کوڈ درج کریں۔',
    ...
    'billing.subscription_cancelled_description':
      'آپ کو اس بلنگ مدت کے اختتام تک اپنی سبسکرپشن تک رسائی حاصل رہے گی۔', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'کیا آپ واقعی اپنی سبسکرپشن منسوخ کرنا چاہتے ہیں؟', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.email_confirmation_needed':
      'آپ کا ای میل تصدیق شدہ نہیں ہے۔ ہم اسے تصدیق کرنے کے لیے آپ کو ایک کوڈ بھیجیں گے۔', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'آپ نے اپنی سبسکرپشن منسوخ کر دی ہے اور یہ بلنگ پیریڈ کے آخر تک مفت پلان پر منتقل ہو جائے گی۔ آپ کو دوبارہ سبسکرائب کرنے تک دوبارہ چارج نہیں کیا جائے گا۔', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'آپ کا موجودہ پلان اس بلنگ پیریڈ کے آخر تک برقرار رہے گا۔', // In English: "Your current plan until the end of this billing period."
