...
const ur = {
  ...
  dictionary: {
    ...
    "billing.change_payment_method": "ادائیگی کا طریقہ تبدیل کریں", // In English: "Change"
    "billing.cancel": "منسوخ کریں", // In English: "Cancel"
    "billing.download_invoice": "ڈاؤن لوڈ کریں", // In English: "Download"
    "billing.payment_method": "ادائیگی کا طریقہ", // In English: "Payment Method"
    "billing.payment_method_updated": "ادائیگی کا طریقہ اپ ڈیٹ ہو گیا!", // In English: "Payment method updated!"
    ...
    "billing.refunded": "واپس کر دیا گیا", // In English: "Refunded"
    "billing.paid": "ادا کیا گیا", // In English: "Paid"
    "billing.ok": "ٹھیک ہے", // In English: "OK"
    "billing.resume_subscription": "سبسکرپشن دوبارہ شروع کریں", // In English: "Resume Subscription"
    ...
    "billing.ai_access": "AI رسائی", // In English: "AI Access"
    "billing.bandwidth": "بینڈوڈتھ", // In English: "Bandwidth"
    "billing.apps_and_games": "ایپس اور گیمز", // In English: "Apps & Games"
    "billing.upgrade_to_pro": "%strong% کو اپ گریڈ کریں", // In English: "Upgrade to %strong%"
    "billing.switch_to": "%strong% پر سوئچ کریں", // In English: "Switch to %strong%"
    "billing.payment_setup": "ادائیگی کی ترتیب", // In English: "Payment Setup"
    "billing.back": "پیچھے", // In English: "Back"
    "billing.you_are_now_subscribed_to": "آپ اب %strong% درجے کے سبسکرائب ہیں۔", // In English: "You are now subscribed to %strong% tier."
    ...
    "billing.subscription_setup": "سبسکرپشن کی ترتیب", // In English: "Subscription Setup"
    "billing.cancel_it": "اسے منسوخ کریں", // In English: "Cancel It"
    "billing.keep_it": "اسے رکھیں", // In English: "Keep It"
    "billing.subscription_resumed": "آپ کی %strong% سبسکرپشن دوبارہ شروع ہو گئی ہے!", // In English: "Your %strong% subscription has been resumed!"
    "billing.upgrade_now": "ابھی اپ گریڈ کریں", // In English: "Upgrade Now"
    "billing.upgrade": "اپ گریڈ", // In English: "Upgrade"
    "billing.currently_on_free_plan": "آپ فی الحال مفت منصوبے پر ہیں۔", // In English: "You are currently on the free plan."
    "billing.download_receipt": "رسید ڈاؤن لوڈ کریں", // In English: "Download Receipt"
    "billing.subscription_check_error": "آپ کی سبسکرپشن کی حیثیت چیک کرتے وقت ایک مسئلہ پیش آیا۔", // In English: "A problem occurred while checking your subscription status."
    "billing.email_confirmation_needed": "آپ کا ای میل تصدیق نہیں ہوا ہے۔ ہم آپ کو تصدیق کے لیے ایک کوڈ بھیجیں گے۔", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    "billing.sub_cancelled_but_valid_until": "آپ نے اپنی سبسکرپشن منسوخ کر دی ہے اور یہ بلنگ مدت کے اختتام پر خود بخود مفت درجے میں تبدیل ہو جائے گی۔ جب تک آپ دوبارہ سبسکرائب نہیں کرتے، آپ سے دوبارہ چارج نہیں کیا جائے گا۔", // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    "billing.current_plan_until_end_of_period": "آپ کا موجودہ منصوبہ اس بلنگ مدت کے اختتام تک۔", // In English: "Your current plan until the end of this billing period."
    "billing.current_plan": "موجودہ منصوبہ", // In English: "Current plan"
    ...
    "billing.accelerated": "تیز", // In English: "Accelerated"
    "billing.enjoy_msg": "کلاؤڈ اسٹوریج کے %% کے ساتھ دیگر فوائد کا لطف اٹھائیں۔", // In English: "Enjoy %% of Cloud Storage plus other benefits."
