...
const sv = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Skapa ett konto och bekräfta din e-postadress för att få 1 GB gratis lagringsutrymme. Din vän får också 1 GB gratis lagringsutrymme.',
    confirm_code_generic_incorrect: 'Felaktig kod.',
    confirm_code_generic_too_many_requests:
      'För många förfrågningar. Var god vänta ett par minuter.',
    ...
    confirm_delete_user:
      'Är det säkert att du vill radera ditt konto? Alla dina filer och data kommer att tas bort permanent. Detta steg kan inte ångras.',
    ...
    contact_us_verification_required:
      'Du behöver en verifierad e-postadress för att använda den här funktionen.',
    contain: 'Innehåll',
    continue: 'Continue',
    copy: 'Kopiera',
    ...
    email_change_confirmation_sent:
      'Ett bekräftelsemail har skickats till din nya e-postadress. Var god kontrollera inkorgen och följ instruktionerna för att fullfölja processen.',
    ...
    enter_password_to_confirm_delete_user:
      'Fyll i ditt lösenord för att bekräfta kontots borttagning.',
    ...
    feedback: 'Feedback',
    feedback_c2a:
      'Vänligen använd formuläret nedan för att skicka oss din feedback, kommentarer och felrapporter.',
    feedback_sent_confirmation:
      'Tack för att du kontaktade oss. Om du har en e-post kopplad till ditt konto kommer du att höra från oss så snart som möjligt.',
    fit: 'Anpassa',
    folder: 'Mapp',
    ...
    items_in_trash_cannot_be_renamed:
      'Det här objektet kan inte byta namn eftersom det är i papperskorgen. För att byta namn på detta objekt, dra det först ur papperskorgen.',
    ...
    password_recovery_rate_limit:
      'Du har uppnått vår hastighetsgräns; var god vänta ett par minuter. För att motverka detta i framtiden, undvik att ladda om sidan för många gånger.',
    ...
    password_strength_error:
      'Lösenordet måste vara minst 8 tecken och innehålla minst en stor bokstav, en liten bokstav, en siffra, och ett specialtecken.',
    ...
    puter_description:
      'Puter är ett integritetsvänligt personligt moln för alla dina filer, appar och spel på ett säkert ställe, tillgängligt varsomhelst och närsomhelst.',
    reading_file: 'Läser in %strong%',
    recent: 'Senaste',
    recommended: 'Rekommenderat',
    recover_password: 'Återställ lösenord',
    refer_friends_c2a:
      'Få 1 GB för varje vän som skapar och bekräftar ett konto på Puter. Din vän får också 1 GB.',
    ...
    save_session_c2a:
      'Skapa ett konto för att spara den nuvarande sessionen och undvika att ditt arbete går förlorat.',
    ...
    tos_fineprint:
      "Genom att klicka på 'Skapa gratis konto' godkänner du Puters {{link=terms}}användarvillkor{{/link}} och {{link=privacy}}integritetspolicy{{/link}}.",
    ...
    login2fa_recovery_instructions:
      'Fyll i en av dina återhämtningskoder för att få tillgång till ditt konto.',
    ...
    'billing.subscription_cancelled_description':
      'Du har fortfarande tillgång till din prenumeration fram till slutet av denna faktureringsperiod.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'Är du säker på att du vill avsluta din prenumeration?', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.subscription_check_error':
      'Ett problem uppstod när du kontrollerade din prenumerationsstatus.', // In English: "A problem occurred while checking your subscription status."
    'billing.email_confirmation_needed':
      'Din e-post har inte bekräftats. Vi skickar dig en kod för att bekräfta den nu.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'Du har sagt upp din prenumeration och den byter automatiskt till gratisnivån i slutet av faktureringsperioden. Du kommer inte att debiteras igen om du inte prenumererar på nytt.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'Din nuvarande plan fram till slutet av denna faktureringsperiod.', // In English: "Your current plan until the end of this billing period."
