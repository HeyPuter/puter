...
const ja = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'アカウントを作成してメールアドレスを確認すると、1GBの無料ストレージを獲得できます。友人も1GBの無料ストレージを獲得します。',
    ...
    confirm_delete_user:
      'アカウントを削除してよろしいですか？すべてのファイルとデータが完全に削除されます。この操作は元に戻せません。',
    ...
    email_change_confirmation_sent:
      '確認メールが新しいメールアドレスに送信されました。受信トレイを確認し、指示に従って手続きを完了してください。',
    ...
    feedback: 'フィードバック',
    feedback_c2a:
      '以下のフォームを使用して、フィードバック、コメント、およびバグ報告をお送りください。',
    feedback_sent_confirmation:
      'お問い合わせいただきありがとうございます。アカウントに関連付けられたメールがある場合は、できるだけ早く返信いたします。',
    fit: 'フィット',
    folder: 'フォルダー',
    force_quit: '強制終了',
    ...
    items_in_trash_cannot_be_renamed:
      'このアイテムはゴミ箱にあるため、名前を変更できません。このアイテムの名前を変更するには、まずゴミ箱からドラッグしてください。',
    jpeg_image: 'JPEG画像',
    ...
    no_websites_published:
      'まだウェブサイトを公開していません。開始するにはフォルダーを右クリックしてください。',
    ok: 'OK',
    open: '開く',
    ...
    save_session_c2a:
      '現在のセッションを保存して、作業を失わないようにするにはアカウントを作成してください。',
    ...
    session_saved:
      'アカウントを作成していただきありがとうございます。このセッションは保存されました。',
    settings: '設定',
    ...
    login2fa_recovery_instructions:
      'アカウントにアクセスするために、回復コードの1つを入力してください。',
    ...
    'This user already has access to this item':
      'このユーザーは既にこのアイテムにアクセスできます。', // In English: "This user already has access to this item"
    ...
    'billing.subscription_cancelled_description':
      'この請求期間の終了までサブスクリプションを利用できます。', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'サブスクリプションをキャンセルしてもよろしいですか？', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.sub_cancelled_but_valid_until':
      'サブスクリプションをキャンセルしました。この請求期間の終了時に自動的に無料プランに切り替わります。再加入しない限り、追加料金は発生しません。', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
