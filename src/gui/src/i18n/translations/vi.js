...
const vi = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      'Tạo tài khoản và xác nhận địa chỉ email của bạn để nhận 1 GB dung lượng lưu trữ miễn phí. Bạn của bạn cũng sẽ nhận được 1 GB dung lượng lưu trữ miễn phí.',
    ...
    confirm_delete_user:
      'Bạn có chắc chắn muốn xóa tài khoản của mình không? Tất cả các tệp và dữ liệu của bạn sẽ bị xóa vĩnh viễn. Hành động này không thể hoàn tác.',
    ...
    contact_us_verification_required:
      'Bạn phải có địa chỉ email đã xác minh để sử dụng tính năng này.',
    contain: 'Chứa',
    continue: 'Tiếp tục',
    copy: 'Sao chép',
    ...
    email_change_confirmation_sent:
      'Một email xác nhận đã được gửi đến địa chỉ email mới của bạn. Vui lòng kiểm tra hộp thư đến và làm theo hướng dẫn để hoàn tất quy trình.',
    ...
    feedback: 'Phản hồi',
    feedback_c2a:
      'Vui lòng sử dụng biểu mẫu dưới đây để gửi phản hồi, nhận xét và báo cáo lỗi của bạn.',
    feedback_sent_confirmation:
      'Cảm ơn bạn đã liên hệ với chúng tôi. Nếu bạn có email liên kết với tài khoản của mình, chúng tôi sẽ phản hồi bạn trong thời gian sớm nhất.',
    fit: 'Vừa khít',
    folder: 'Thư mục',
    ...
    no_websites_published:
      'Bạn chưa xuất bản trang web nào. Nhấp chuột phải vào một thư mục để bắt đầu.',
    ok: 'OK',
    open: 'Mở',
    ...
    password_recovery_rate_limit:
      'Bạn đã đạt đến giới hạn tốc độ của chúng tôi; vui lòng đợi vài phút. Để tránh điều này trong tương lai, hãy tránh tải lại trang quá nhiều lần.',
    ...
    password_strength_error:
      'Mật khẩu phải có ít nhất 8 ký tự và chứa ít nhất một chữ cái viết hoa, một chữ cái viết thường, một số và một ký tự đặc biệt.',
    ...
    refer_friends_c2a:
      'Nhận 1 GB cho mỗi người bạn tạo và xác nhận tài khoản trên Puter. Bạn của bạn cũng sẽ nhận được 1 GB!',
    ...
    save_session_c2a:
      'Tạo một tài khoản để lưu phiên hiện tại của bạn và tránh mất công việc của bạn.',
    ...
    you_have_been_referred_to_puter_by_a_friend:
      'Bạn đã được giới thiệu đến Puter bởi một người bạn!',
    zip: 'Nén',
    ...
    'This user already has access to this item':
      'Người dùng này đã có sẵn quyền truy cập cho mục này', // In English: "This user already has access to this item"
    ...
    'billing.subscription_cancelled_description':
      'Bạn vẫn có thể tiếp tục sử dụng dịch vụ của mình cho đến cuối kỳ thanh toán này.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.email_confirmation_needed':
      'Email của bạn chưa được xác nhận. Chúng tôi sẽ gửi mã xác nhận ngay bây giờ.', // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    'billing.sub_cancelled_but_valid_until':
      'Bạn đã hủy đăng ký và được tự động chuyển sang gói miễn phí vào cuối kỳ thanh toán. Bạn sẽ không bị tính phí nữa đến khi đăng ký lại.', // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    'billing.current_plan_until_end_of_period':
      'Gói cước hiện tại của bạn đến cuối kỳ thanh toán này.', // In English: "Your current plan until the end of this billing period."
