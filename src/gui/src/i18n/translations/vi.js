...
const vi = {
    ...
    dictionary: {
        ...
        "billing.cancel": "Hủy bỏ", // In English: "Cancel"
        ...
        "billing.refunded": "Hoàn tiền", // In English: "Refunded"
        "billing.paid": "Đã thanh toán", // In English: "Paid"
        "billing.ok": "OK", // In English: "OK"
        "billing.resume_subscription": "Tiếp tục gói thuê bao", // In English: "Resume Subscription"
        "billing.subscription_cancelled": "Gói thuê bao của bạn đã bị hủy.", // In English: "Your subscription has been canceled."
        "billing.subscription_cancelled_description": "Bạn vẫn có quyền truy cập gói thuê bao cho đến cuối kỳ thanh toán này.", // In English: "You will still have access to your subscription until the end of this billing period."
        ...
        "billing.switch_to": "Chuyển sang %strong%", // In English: "Switch to %strong%"
        "billing.payment_setup": "Cài đặt thanh toán", // In English: "Payment Setup"
        "billing.back": "Quay lại", // In English: "Back"
        "billing.you_are_now_subscribed_to": "Bạn hiện đã đăng ký gói %strong%.", // In English: "You are now subscribed to %strong% tier."
        "billing.you_are_now_subscribed_to_without_tier": "Bạn đã đăng ký gói", // In English: "You are now subscribed"
        "billing.subscription_cancellation_confirmation": "Bạn có chắc chắn muốn hủy đăng ký gói của mình không?", // In English: "Are you sure you want to cancel your subscription?"
        "billing.subscription_setup": "Cài đặt đăng ký gói thuê bao", // In English: "Subscription Setup"
        ...
        "billing.download_receipt": "Tải xuống hóa đơn", // In English: "Download Receipt"
        "billing.subscription_check_error": "Đã xảy ra sự cố khi kiểm tra trạng thái đăng ký gói của bạn.", // In English: "A problem occurred while checking your subscription status."
        "billing.email_confirmation_needed": "Email của bạn chưa được xác nhận. Chúng tôi sẽ gửi cho bạn mã để xác nhận ngay bây giờ.", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
        "billing.sub_cancelled_but_valid_until": "Bạn đã hủy đăng ký gói và sẽ tự động chuyển sang gói miễn phí vào cuối kỳ thanh toán. Bạn sẽ không bị tính phí nữa trừ khi bạn đăng ký lại.", // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
        "billing.current_plan_until_end_of_period": "Gói hiện tại của bạn cho đến cuối kỳ thanh toán này.", // In English: "Your current plan until the end of this billing period."
        ...
        "billing.enjoy_msg": "Tận hưởng %% lưu trữ đám mây cùng các lợi ích khác.", // In English: "Enjoy %% of Cloud Storage plus other benefits."
    }
};
