...
const ko = {
  ...
  dictionary: {
    ...
    confirm_code_generic_too_many_requests: '요청이 너무 많습니다. 몇 분만 기다려주십시오.', // Improvement suggestion: "요청이 너무 많습니다. 잠시만 기다려주세요."
    ...
    confirm_delete_multiple_items: '정말로 이 항목들을 영구적으로 삭제하시겠습니까?', // Improvement suggestion: "항목들을 정말 영구적으로 삭제하시겠습니까?" (if it's a selection you could add "selected" to items like this: "선택된 항목들을 정말 영구적으로 삭제하시겠습니까?")
    ...
    enter_password_to_confirm_delete_user: '계정 삭제를 승인하려면 비밀번호를 입력하십시오.', // Improvement suggestion: "계정 삭제를 승인하려면 비밀번호를 입력해주세요."
    ...
    favorites: '즐겨찾기',
    feedback: '피드백',
    feedback_c2a: '아래 양식을 사용하여 피드백, 의견 및 버그 보고를 보내십시오.', // Improvement suggestion: "아래 양식을 통해 피드백, 의견 또는 버그 보고를 보내주세요."
    ...
    password_recovery_token_invalid: '이 비밀번호 복구 토큰은 더 이상 유효하지 않습니다.', // Improvement suggestion: "유효하지 않은 비밀번호 복구 토큰입니다."
    password_recovery_unknown_error: '알 수 없는 오류가 발생했습니다. 나중에 다시 시도해주십시오.', // Improvement suggestion: "알 수 없는 오류가 발생했습니다. 잠시 후 다시 시도해주세요."
    ...
    save_session: '세션 저장',
    save_session_c2a: '현재 세션을 저장하고 작업을 잃지 않으려면 계정을 생성하십시오.', // Improvement suggestion: "현재 세션을 저장하고 작업을 잃지 않으려면 계정을 만들어주세요."
    scan_qr_c2a: '다른 기기에서 이 세션으로 로그인하려면 아래 코드를 스캔하십시오', // Improvement suggestion: change 스캔하십시오 to 스캔해주세요 for the next 3 lines.
    ...
    taking_longer_than_usual: '보통보다 조금 더 오래 걸립니다. 잠시만 기다려 주십시오...', // Improvement suggestion: "평소보다 조금 더 오래 걸리고 있습니다. 잠시만 기다려주세요..."
    ...
    type: '유형',
    type_confirm_to_delete_account: "계정을 삭제하려면 'confirm'을 입력하십시오.", // Improvement suggestion: "계정을 삭제하려면 'confirm'을 입력해주세요."
    ui_colors: 'UI 색상',
    ...
    login2fa_recovery_instructions: '계정 접속을 위해 복구코드들 중 하나를 입력하십시오.', // Improvement suggestion: "계정에 접속하려면 복구코드 중 하나를 입력해주세요."
    ...
    'billing.you_are_now_subscribed_to': '%strong% 플랜으로 구독이 완료되었습니다.', // In English: "You are now subscribed to %strong% tier."
    'billing.you_are_now_subscribed_to_without_tier': '구독이 완료되었습니다', // In English: "You are now subscribed"
    'billing.subscription_cancellation_confirmation': '정말 구독을 취소하시겠습니까?', // In English: "Are you sure you want to cancel your subscription?"
    ...
    'billing.subscription_check_error': '구독 상태를 확인하는 중 문제가 발생했습니다.', // In English: "A problem occurred while checking your subscription status."
    ...
    'billing.current_plan_until_end_of_period': '청구 기간이 끝날 때까지 유지되는 현재 플랜입니다.', // In English: "Your current plan until the end of this billing period."
