...
const ko = {
  ...
  dictionary: {
    ...
    "billing.payment_method_updated": "결제 수단 수정!",
    "billing.confirm_payment_method": "결제 수단 완료", // In English: "Confirm Payment Method"
    "billing.payment_history": "결제 내역", // In English: "Payment History"
    "billing.refunded": "환불", // In English: "Refunded"
    "billing.paid": "결제완료", // In English: "Paid"
    "billing.ok": "완료", // In English: "OK"
    "billing.resume_subscription": "재구독", // In English: "Resume Subscription"
    "billing.subscription_cancelled": "구독이 취소되었습니다", // In English: "Your subscription has been canceled."
    "billing.subscription_cancelled_description": "청구기간 동안 구독이 가능합니다", // In English: "You will still have access to your subscription until the end of this billing period."
    "billing.offering.free": "무료", // In English: "Free"
    "billing.offering.pro": "프로", // In English: "Professional"
    "billing.offering.business": "사업", // In English: "Business"
    "billing.cloud_storage": "클라우드 스토리지", // In English: "Cloud Storage"
    "billing.ai_access": "AI 접근", // In English: "AI Access"
    "billing.bandwidth": "대역폭", // In English: "Bandwidth"
    "billing.apps_and_games": "앱 & 게임", // In English: "Apps & Games"
    "billing.upgrade_to_pro": "%strong%로 업데이트하세요", // In English: "Upgrade to %strong%"
    "billing.switch_to": "%strong%로 변경하세요", // In English: "Switch to %strong%"
    "billing.payment_setup": "결제 설정", // In English: "Payment Setup"
    "billing.back": "뒤로가기", // In English: "Back"
    "billing.you_are_now_subscribed_to": "이제 %strong% 등급으로 가입 완료", // In English: "You are now subscribed to %strong% tier."
    "billing.you_are_now_subscribed_to_without_tier": "구독 중입니다", // In English: "You are now subscribed"
    "billing.subscription_cancellation_confirmation": "구독을 취소하시겠습니까?", // In English: "Are you sure you want to cancel your subscription?"
    "billing.subscription_setup": "구독 설정", // In English: "Subscription Setup"
    "billing.cancel_it": "취소", // In English: "Cancel It"
    "billing.keep_it": "유지", // In English: "Keep It"
    "billing.subscription_resumed": "%strong%을 재구독 했습니다!", // In English: "Your %strong% subscription has been resumed!"
    "billing.upgrade_now": "지금 업그레이드 하세요", // In English: "Upgrade Now"
    "billing.upgrade": "업그레이드", // In English: "Upgrade"
    "billing.currently_on_free_plan": "현재 무료 요금제에 가입되어있습니다.", // In English: "You are currently on the free plan."
    "billing.download_receipt": "영수증 다운로드", // In English: "Download Receipt"
    "billing.subscription_check_error": "구독 상태를 확인하는 중에 문제가 발생했습니다.", // In English: "A problem occurred while checking your subscription status."
    "billing.email_confirmation_needed": "이메일이 확인되지 않았습니다. 지금 확인할 수 있도록 코드를 보내드리겠습니다", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    "billing.sub_cancelled_but_valid_until": "구독 취소 완료. 청구 기간이 끝나면 자동으로 무료 등급으로 전환됩니다. 재구독하지 않으면 다시 요금이 부과되지 않습니다.", // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    "billing.current_plan_until_end_of_period": "이 청구 기간이 끝날 때까지 현재 요금제.", // In English: "Your current plan until the end of this billing period."
    "billing.current_plan": "현재 요금제", // In English: "Current plan"
    ...
    "billing.enjoy_msg": "클라우드 스토리지의 %%와 기타 혜택을 누리세요.", // In English: "Enjoy %% of Cloud Storage plus other benefits."
  },
};
