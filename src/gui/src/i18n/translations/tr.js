...
const tr = {
  ...
  dictionary: {
    ...
    confirm_account_for_free_referral_storage_c2a:
      '1 GB ücretsiz depolama alanı kazanmak için bir hesap oluşturun ve e-posta adresinizi onaylayın. Arkadaşınız da 1 GB ücretsiz depolama alanı kazanacak.',
    ...
    confirm_delete_user:
      'Hesabınızı silmek istediğinize emin misiniz? Tüm dosyalarınız ve verileriniz kalıcı olarak silinecektir. Bu işlem geri alınamaz.',
    ...
    contact_us_verification_required:
      'Bunu kullanmak için doğrulanmış bir e-posta adresiniz olmalıdır.',
    contain: 'Dahil et',
    continue: 'Devam',
    copy: 'Kopyala',
    ...
    email_change_confirmation_sent:
      'Yeni e-posta adresinize bir onay e-postası gönderilmiştir. Lütfen gelen kutunuzu kontrol edin ve işlemi tamamlamak için talimatları takip edin.',
    ...
    empty_trash_confirmation:
      'Çöp Kutusundaki öğeleri kalıcı olarak silmek istediğinize emin misiniz?',
    ...
    feedback_c2a:
      'Lütfen geri bildirimlerinizi, yorumlarınızı ve hata raporlarınızı bize göndermek için aşağıdaki formu kullanın.',
    feedback_sent_confirmation:
      'Bizimle iletişime geçtiğiniz için teşekkür ederiz. Hesabınızla ilişkili bir e-postanız varsa, en kısa sürede size geri döneceğiz.',
    fit: 'Sığdır',
    folder: 'Klasör',
    ...
    items_in_trash_cannot_be_renamed:
      'Bu öğe, çöp kutusunda olduğu için yeniden adlandırılamaz. Bu öğeyi yeniden adlandırmak için önce çöp kutusundan çıkarın.',
    ...
    password_recovery_rate_limit:
      'Hız sınırımıza ulaştınız; lütfen birkaç dakika bekleyin. Gelecekte bunu önlemek için sayfayı çok fazla yeniden yüklemekten kaçının.',
    ...
    password_strength_error:
      'Parola en az 8 karakter uzunluğunda olmalı ve en az bir büyük harf, bir küçük harf, bir sayı ve bir özel karakter içermelidir.',
    ...
    puter_description:
      'Puter, tüm dosyalarınızı, uygulamalarınızı ve oyunlarınızı tek bir güvenli yerde tutmak için gizliliğe öncelik veren kişisel bir buluttur ve her yerden her zaman erişilebilir.',
    reading_file: '%strong% okunuyor',
    recent: 'En son',
    recommended: 'Önerilen',
    recover_password: 'Parolayı Kurtar',
    refer_friends_c2a:
      'Hesap oluşturup onaylayan her arkadaşınız için 1 GB kazanın. Arkadaşınız da 1 GB kazanacak!',
    ...
    save_session_c2a:
      'Geçerli oturumunuzu kaydetmek ve çalışmalarınızı kaybetmemek için bir hesap oluşturun.',
    ...
    tos_fineprint:
      "'Ücretsiz Hesap Oluştur'u tıklayarak Puter'ın {{link=terms}}Hizmet Şartları{{/link}} ve {{link=privacy}}Gizlilik Politikası{{/link}}'nı kabul etmiş olursunuz.",
    ...
    you_have_been_referred_to_puter_by_a_friend:
      "Bir arkadaşınız tarafından Puter'a yönlendirildiniz!",
    zip: 'Sıkıştır',
    ...
    'billing.subscription_cancelled_description':
      'Bu fatura döneminin sonuna kadar aboneliğinizi kullanmaya devam edebilirsiniz.', // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    'billing.subscription_cancellation_confirmation':
      'Aboneliğinizi iptal etmek istediğinize emin misiniz?', // In English: "Are you sure you want to cancel your subscription?"
