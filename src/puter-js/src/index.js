...
export default globalThis.puter = (function () {
  ...
  class Puter {
    ...
    constructor(options) {
      ...
      const context = new putility.libs.context.Context().follow(this, [
        'env',
        'util',
        'authToken',
        'APIOrigin',
