...
class Hosting {
  ...
  create = async (...args) => {
    ...
    return await utils
      .make_driver_method(['object'], 'puter-subdomains', undefined, 'create')
      .call(this, options);
  };
  ...
  update = async (...args) => {
    ...
    // Call the original chat.complete method
    return await utils
      .make_driver_method(['object'], 'puter-subdomains', undefined, 'update')
      .call(this, options);
  };
  ...
  get = async (...args) => {
    ...
    return utils
      .make_driver_method(['uid'], 'puter-subdomains', undefined, 'read')
      .call(this, options);
  };
  ...
  delete = async (...args) => {
    ...
    return utils
      .make_driver_method(['uid'], 'puter-subdomains', undefined, 'delete')
      .call(this, options);
  };
}
