 ...
 * (the default) picks a kind from the basename (a dot beyond one leading one
 * means a file); `'dir'`/`'file'` force it; `false` leaves a missing path alone.
 *
 ...
 *   missing path, create it after approval. Defaults to `true`. See
 *   `puter.perms.request`.
 */
