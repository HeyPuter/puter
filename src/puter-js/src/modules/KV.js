...
class KV {
  ...
  incr = async (...args) => {
    ...
    return utils
      .make_driver_method(['key'], 'puter-kvstore', undefined, 'incr')
      .call(this, options);
  };
  ...
  decr = async (...args) => {
    ...
    return utils
      .make_driver_method(['key'], 'puter-kvstore', undefined, 'decr')
      .call(this, options);
  };
  ...
  expire = async (...args) => {
    ...
    return utils
      .make_driver_method(['key'], 'puter-kvstore', undefined, 'expire')
      .call(this, options);
  };
  ...
  list = async (...args) => {
    ...
    if (
      (args && args.length === 1 && args[0] === true) ||
      (args && args.length === 2 && args[1] === true)
    ) {
      options = {};
      returnValues = true;
    }
    ...
    if (
      ...
      (args && args.length === 2 && typeof args[0] === 'string' && args[1] === true)
    ) {
      pattern = args[0];
    }

    return utils
      .make_driver_method([], 'puter-kvstore', undefined, 'list', {
        transform: (res) => {
