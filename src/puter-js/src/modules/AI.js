...
class AI {
  ...
  chat = async (...args) => {
    ...
    if (
      ...
      options.model === "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo" ||
      options.model === "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo" ||
      options.model === "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo" ||
      options.model === `google/gemma-2-27b-it`
    ) {
      driver = "together-ai";
    } else if (
      options.model === "mistral-large-latest" ||
