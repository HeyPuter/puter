...
window.kvTests = [
  ...
  },
  {
    ...
    description:
      'Test updating a value and then retrieving it to verify it matches the updated value',
    test: async function () {
      try {
        await puter.kv.set('updateKey', 'initialValue');
  ...
  },
  {
    ...
    description:
      'Test setting a key with special characters and then retrieving it to verify it matches',
    test: async function () {
      try {
  ...
  },
  {
    ...
    description:
      'Test incrementing a key by a specified amount and verify it returns the correct value',
    test: async function () {
      try {
        await puter.kv.set('incrKey', 1);
  ...
  },
  {
    ...
    description:
      'Test decrementing a key by a specified amount and verify it returns the correct value',
    test: async function () {
      try {
  ...
  },
  {
    ...
    description:
      'Test incrementing an existing key by a specified amount and verify it returns the correct value',
    test: async function () {
      try {
        await puter.kv.set('incrKey', 1);
        const result = await puter.kv.incr('incrKey', 5);
  ...
  },
  {
    ...
    description:
      'Test decrementing an existing key by a specified amount and verify it returns the correct value',
    test: async function () {
      try {
        await puter.kv.set('decrKey', 10);
        const result = await puter.kv.decr('decrKey', 5);
  ...
  },
  {
    ...
    description:
      'Test incrementing a key by a negative amount and verify it returns the correct value',
    test: async function () {
      try {
        await puter.kv.set('incrKey', 1);
        const result = await puter.kv.incr('incrKey', -5);
  ...
  },
  {
    ...
    description:
      'Test decrementing a key by a negative amount and verify it returns the correct value',
    test: async function () {
      try {
        await puter.kv.set('decrKey', 10);
        const result = await puter.kv.decr('decrKey', -5);
