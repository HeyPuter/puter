...
const testChatBasicPromptCore = async function (model) {
  ...
  assert(
    typeof result.via_ai_chat_service === 'boolean',
    'result should have via_ai_chat_service boolean'
  );
  ...
  assert(
    typeof result.message.content === 'string' || Array.isArray(result.message.content),
    'message should have content string or an array'
  );
...
const testChatWithParametersCore = async function (model) {
  ...
  assert(
    typeof result.message.content === 'string' || Array.isArray(result.message.content),
    'result.message should have content string or an array'
  );
  ...
  assert(
    validFinishReasons.includes(result.finish_reason),
