...
const tr = {
    ...
    dictionary: {
        ...
        color: "Renk",
        confirm_2fa_setup: "Kodunuzu doğrulayıcı uygulamama ekledim",
        ...
        confirm_code_generic_title: "Onay Kodunu Girin",
        confirm_code_2fa_instruction: "Doğrulayıcı uygulamanızdan 6 haneli kodu girin.",
        ...
        confirm_your_email_address: "E-posta Adresinizi Doğrulayın",
        contact_us: "Bize Ulaşın",
        contact_us_verification_required: "Bunu kullanmak için doğrulanmış bir e-posta adresine sahip olmalısınız.",
        contain: "İçerir",
        continue: "Devam",
        copy: "Kopyala",
        copy_link: "Bağlantıyı Kopyala",
        copying: "Kopyalanıyor",
        copying_file: "Dosya Kopyalanıyor %",
        cover: "Kapak",
        ...
        password_recovery_rate_limit: "Hız sınırımıza ulaştınız; lütfen birkaç dakika bekleyin. Gelecekte bunu önlemek için, sayfayı çok sık yenilemekten kaçının.",
        password_recovery_token_invalid: "Bu şifre kurtarma belirteci artık geçerli değil.",
        ...
        password_strength_error: "Şifre en az 8 karakter uzunluğunda olmalı ve en az bir büyük harf, bir küçük harf, bir sayı ve bir özel karakter içermelidir.",
        ...
        reading_file: "Dosya Okunuyor %strong%",
        recent: "Son",
        ...
        scan_qr_2fa: "Doğrulayıcı uygulamanızla QR kodunu tarayın",
        scan_qr_generic: "Telefonunuz veya başka bir cihaz ile bu QR kodunu tarayın",
        search: "Ara",
        seconds: "saniye",
        security: "Güvenlik",
        select: "Seç",
        ...
        zip: "Sıkıştır",
        zipping_file: "Dosya Arşivleniyor %strong%",

        // === 2FA Setup ===
        setup2fa_1_step_heading: "Doğrulayıcı Uygulamanızı Açın",
        setup2fa_1_instructions: `
            Zaman Tabanlı Tek Kullanımlık Parola (TOTP) protokolünü destekleyen herhangi bir doğrulayıcı uygulamayı kullanabilirsiniz.
            Birçok seçenek mevcut, ancak emin değilseniz
        ...
        setup2fa_5_button: '2FA Etkinleştir',

        // === 2FA Login ===
        login2fa_otp_title: '2FA Kodunu Girin',
        login2fa_otp_instructions: 'Kimlik doğrulama uygulamanızdan 6 haneli kodu girin.',
        login2fa_recovery_title: 'Kurtarma kodu girin',
        login2fa_recovery_instructions: 'Hesabınıza erişmek için kurtarma kodlarından birini girin.',
