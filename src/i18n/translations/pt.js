...
const pt = {
    ...
    dictionary: {
        ...
        color: 'Cor',
        confirm_account_for_free_referral_storage_c2a: 'Cries uma conta e confirmes o endereço do email para receber 1 GB de armazenamento gratuito. Vosso amigo receberá 1 GB de armazenamento gratuito também.',
        ...
        confirm_open_apps_log_out: 'Possui aplicações abertas. Queres mesmo fechar sua sessão?',
        confirm_new_password: "Confirme sua Nova Palavra Passe",
        confirm_delete_user: "Queres excluir sua conta? Todos os ficheiros e informações serão destruídas permanentemente. Esta operação não pode ser desfeita.",
        ...
        enter_password_to_confirm_delete_user: "Entre sua palavra passe para confirmar a exclusão da conta",
        feedback: "Feedback",
