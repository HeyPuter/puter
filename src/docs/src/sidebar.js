let sidebar = [
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                page_title: '<code>puter.perms.check()</code>',
                title_tag: 'puter.perms.check()',
                icon: '/assets/img/function.svg',
                source: '/Perms/check.md',
                path: '/Perms/check',
            },
            {
                title: "Using another app's data",
                page_title: "Using another app's data",
                title_tag: "Using another app's data",
                source: '/Perms/appData.md',
                path: '/Perms/appData',
            },
        ],
    },
    {
        title: 'Payments',
        title_tag: 'Payments',
        icon: '/assets/img/payments.svg',
        source: '/Payments.md',
        path: '/Payments',
        children: [
            {
                title: '<code>checkout()</code>',
                page_title: '<code>puter.payments.checkout()</code>',
                title_tag: 'puter.payments.checkout()',
                icon: '/assets/img/function.svg',
                source: '/Payments/checkout.md',
                path: '/Payments/checkout',
            },
            {
                title: '<code>createCharge()</code>',
                page_title: '<code>puter.payments.createCharge()</code>',
                title_tag: 'puter.payments.createCharge()',
                icon: '/assets/img/function.svg',
                source: '/Payments/createCharge.md',
                path: '/Payments/createCharge',
            },
            {
                title: '<code>getCharge()</code>',
                page_title: '<code>puter.payments.getCharge()</code>',
                title_tag: 'puter.payments.getCharge()',
                icon: '/assets/img/function.svg',
                source: '/Payments/getCharge.md',
                path: '/Payments/getCharge',
            },
            {
                title: '<code>waitForPayment()</code>',
                page_title: '<code>puter.payments.waitForPayment()</code>',
                title_tag: 'puter.payments.waitForPayment()',
                icon: '/assets/img/function.svg',
                source: '/Payments/waitForPayment.md',
                path: '/Payments/waitForPayment',
            },
            {
                title: '<code>listCharges()</code>',
                page_title: '<code>puter.payments.listCharges()</code>',
                title_tag: 'puter.payments.listCharges()',
                icon: '/assets/img/function.svg',
                source: '/Payments/listCharges.md',
                path: '/Payments/listCharges',
            },
            {
                title: '<code>getSettings()</code>',
                page_title: '<code>puter.payments.getSettings()</code>',
                title_tag: 'puter.payments.getSettings()',
                icon: '/assets/img/function.svg',
                source: '/Payments/getSettings.md',
                path: '/Payments/getSettings',
            },
            {
                title: '<code>updateSettings()</code>',
                page_title: '<code>puter.payments.updateSettings()</code>',
                title_tag: 'puter.payments.updateSettings()',
                icon: '/assets/img/function.svg',
                source: '/Payments/updateSettings.md',
                path: '/Payments/updateSettings',
            },
        ],
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                icon: '/assets/img/function.svg',
                source: '/Teams/listDirectory.md',
                path: '/Teams/listDirectory',
            },
        ],
    },
    {
