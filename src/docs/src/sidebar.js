let sidebar = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                title: '<code>requestFolder()</code>',
                page_title: '<code>puter.perms.requestFolder()</code>',
                title_tag: 'puter.perms.requestFolder()',
                icon: '/assets/img/function.svg',
                source: '/Perms/requestFolder.md',
                path: '/Perms/requestFolder',
            },
            {
                title: '<code>requestApps()</code>',
                page_title: '<code>puter.perms.requestApps()</code>',
                title_tag: 'puter.perms.requestApps()',
                icon: '/assets/img/function.svg',
                source: '/Perms/requestApps.md',
                path: '/Perms/requestApps',
            },
            {
                title: '<code>requestSubdomains()</code>',
                page_title: '<code>puter.perms.requestSubdomains()</code>',
                title_tag: 'puter.perms.requestSubdomains()',
                icon: '/assets/img/function.svg',
                source: '/Perms/requestSubdomains.md',
                path: '/Perms/requestSubdomains',
            },
            {
