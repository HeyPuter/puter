let sidebar = [
    ...
    },
    {
        ...
        children: [
            {
                title: '<code>sendTransactional()</code>',
                page_title: '<code>puter.email.sendTransactional()</code>',
                title_tag: 'puter.email.sendTransactional()',
                icon: '/assets/img/function.svg',
                source: '/Email/sendTransactional.md',
                path: '/Email/sendTransactional',
            },
            {
                title: '<code>list()</code>',
                page_title: '<code>puter.email.list()</code>',
                title_tag: 'puter.email.list()',
                icon: '/assets/img/function.svg',
                source: '/Email/list.md',
                path: '/Email/list',
            },
            {
                title: '<code>get()</code>',
                page_title: '<code>puter.email.get()</code>',
                title_tag: 'puter.email.get()',
                icon: '/assets/img/function.svg',
                source: '/Email/get.md',
                path: '/Email/get',
            },
    ...
    },
    {
        ...
        children: [
            ...
            {
                title: '<code>EmailListPage</code>',
                title_tag: 'EmailListPage',
                icon: '/assets/img/object.svg',
                source: '/Objects/emaillistpage.md',
                path: '/Objects/emaillistpage',
            },
            {
                title: '<code>EmailMessage</code>',
                title_tag: 'EmailMessage',
                icon: '/assets/img/object.svg',
                source: '/Objects/emailmessage.md',
                path: '/Objects/emailmessage',
            },
            {
                title: '<code>EmailMessageAttachment</code>',
                title_tag: 'EmailMessageAttachment',
                icon: '/assets/img/object.svg',
                source: '/Objects/emailmessageattachment.md',
                path: '/Objects/emailmessageattachment',
            },
            {
                title: '<code>EmailSummary</code>',
                title_tag: 'EmailSummary',
                icon: '/assets/img/object.svg',
                source: '/Objects/emailsummary.md',
                path: '/Objects/emailsummary',
            },
            {
