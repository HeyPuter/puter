...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Puter is a privacy-first personal cloud to keep all your files, apps, and games in one private and secure place, accessible from anywhere at any time."
    />
    ...
    <link
      ...
      type="image/png"
      sizes="192x192"
      href="./dist/favicons/android-icon-192x192.png"
    />
