...
const generate_sidebar = (documents) => {
  ...
  documents.sort((a, b) => {
    ...
    const isReadmeA =
      a.outputName.toLowerCase().includes('readme') || a.outputName.toLowerCase().includes('home');
    const isReadmeB =
      b.outputName.toLowerCase().includes('readme') || b.outputName.toLowerCase().includes('home');
