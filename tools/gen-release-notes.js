...
const retro_prefixes_0 = {
  ...
  feat: ['8e7306c23be01ee6c31cdb4c99f2fb1f71a2247f'],
  meta: ['b3c1b128e2d8519bc816cdcd3220c8f40e05bb01', '452b7495b1736df90bc748dbf818407488875754'],
};
...
for (const commit of commits) {
  ...
  if (retro_prefixes.hasOwnProperty(commit.hash)) {
    commit.message = retro_prefixes[commit.hash] + ': ' + commit.message;
  }
